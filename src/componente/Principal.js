    ...
    <div className='container-general'>
      ...
      <div className='conta'>
        ...
        <div className='Escritos'>
          ...
          <p>
            Si quieres conseguir la titulacion para ser piloto de ultraligera, Aqui tenemos el mayor banco de preguntas en español.
            Todas las preguntas las hemos ido incorporando a lo largo de los años a base de los exmanenes que han ido realizando en
            AESA nuestros alumnos. Al mejor precio
          </p>
      ...
      <footer className='pie-pagina'>
        <div className='grupo-1'>
          ...
          <div className='box'>
            ...
            <div className='red-social'>
              <a
                href='https://api.whatsapp.com/send/?phone=34697417495&text&type=phone_number&app_absent=0'
        ...
        <div className='grupo-2'>
          <small>
            &copy; 2023 <b>ESCUELA DE AVIADORES</b> - Todos los Derechos Reservados.
          </small>
        </div>
      </footer>
    </div>
