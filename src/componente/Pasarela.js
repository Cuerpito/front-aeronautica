...
const MyCheckoutComponent = () => {
  ...
  return (
    <div className='general-suscripcion'>
      ...
      <br></br>
        <h1 className="titulo-Pago" style={{textAlign: "center"}}>PAGO EXAMEN ULM</h1>
        <br></br>
        <h2 className='letraArriba' style={{textAlign: "center"}}>BANCO DE PREGUNTAS ULM</h2>
        <h3 className='letraAbajo' style={{textAlign: "center"}}>PRECIO DEL PRODUCTO: {product.price} EUROS</h3>
        <br></br>
        <div className='formL'>
          <StripeCheckout
            className="center"
            token={handleToken}
            stripeKey="pk_test_51Ns7BdFxlOv4gV2Cr4mU5j5ALd479RPRjBS1MJOc4ixxcoj9VolIlL4Y06N1nUFh1kf09bRpkBXGHM5ZfMvpGtqs00r3YryaYs"
