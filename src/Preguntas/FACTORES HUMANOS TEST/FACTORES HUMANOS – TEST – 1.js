const preguntas = [
    ...
    {
        titulo: "6. La hiperventilación es una respuesta fisiológica frente a la hipoxia, pero aparte de esta causa ¿cuál es el motivo más frecuente de hiperventilación en aeronáutica?.",
        opciones: [
            {
    ...
    {
        titulo: "13. ¿Qué parte del oído podría verse afectada por los cambios en la presión del aire que se producen durante el ascenso / descenso?",
        opciones: [
            {
    ...
    {
        titulo: "23. Un piloto que está acostumbrado a aterrizar solamente en pistas anchas, al efectuar aproximaciones a pistas más cortas y/o estrechas, podrá tener la sensación de que se encuentra:",
        opciones: [
            {
    ...
    {
        titulo: "29. Internacionalmente se considera que el límite máximo admisible de tiempo de exposición a un ruido de una intensidad de 80 db es de:",
        opciones: [
            {
    ...
    {
        titulo: "35. Si tras mantener una velocidad constante durante un cierto tiempo en vuelo nivelado aceleramos bruscamente (“metemos gases”) tendremos la impresión de:",
        opciones: [
            {
    ...
    {
        titulo: "38. El alcohol es un tóxico importante con gran acción sobre el sistema nervioso central. Según recomienda OACI, ¿Cuál es el tiempo mínimo que hay que dejar pasar desde la última copa antes de volar?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "El que disponemos para actuar con claridad de juicio y tomar decisiones correctas desde que nos desconectamos del equipo de oxígeno",
                isCorrect: true
            }
        ]
    },
    ...
    {
        titulo: "64. El alcohol es un tóxico importante, con gran acción sobre el Sistema Nervioso Central. Naturalmente, está contraindicado volar bajo la influencia del alcohol. Según recomienda OACI ¿cuál es el tiempo mínimo que hay que dejar pasar desde la última copa antes de volar?",
        opciones: [
            {
                textoRespuesta: "6 horas",
                isCorrect: false
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "La disminución de la cantidad de oxígeno en los órganos y tejidos corporales, que dificulta o impide su funcionamiento normal",
                isCorrect: true
            }
        ]
    },
    ...
    {
        titulo: "81. Un cuadro de tos seca, dolor torácico opresivo y dificultad respiratoria, tras un vuelo a alta cota, nos hace pensar en:",
        opciones: [
            {
    ...
    {
        titulo: "84. Los investigadores de accidentes aéreos han puesto últimamente un especial énfasis en los factores humanos como responsables de gran parte de los accidentes aéreos. ¿En qué tanto por ciento aproximadamente?",
        opciones: [
            {
                textoRespuesta: "15%",
                isCorrect: false
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Están completamente contraindicados si se va a volar. Han sido los fármacos que han ocasionado mayor número de incidentes aéreos",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "d) Es una expresión genérica que puede significar, según el caso, cualquiera de las fases mencionadas en \"a\", \"b\" y \"c\"",
                isCorrect: true
            }
        ]
    },
