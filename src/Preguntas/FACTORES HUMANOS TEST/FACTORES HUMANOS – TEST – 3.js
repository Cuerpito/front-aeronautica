const preguntas = [
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Aumenta la capacidad normal de resistencia a la hipoxia, lo cual no quiere decir que esté permitido para el vuelo",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "17. ¿Qué actitud de comportamiento presenta una persona que mantiene disconformidad o desatención ante las indicaciones de lo que tiene que hacer?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Al disminuir la presión del aire, el oxígeno también disminuye su presión y llega menor cantidad de éste a nuestras células",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "40. Cuando las condiciones en vuelo no nos permiten usar la vista (nubes, vuelo de noche, etc.), ¿qué elemento nos proporciona la orientación espacial?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "La que se produce en aproximación de noche, cuando las luces de la pista nos hacen verla más baja de lo que está",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "49. Tras haber pasado por una intervención que requiera una anestesia general, ¿cuánto tiempo tiene que esperar el piloto para volar?",
        opciones: [
            {
                textoRespuesta: "12 horas",
                isCorrect: false
    ...
    {
        titulo: "55. En vuelo recto y nivelado a 3.000 ft empezamos a sentir sensación de hormigueo, aturdimiento, cianosis, etc. ¿Qué podemos estar sufriendo?",
        opciones: [
            {
