const preguntas = [
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Modificamos sólo las agujas, pues la lectura de la ventanilla de Kolsman se modifica sola al cambiar la Presión atmosférica',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '16. Cuando después de un vuelo, notemos que la tela de nuestro aparato está sucia (alguna mancha de aceite o similar), deberemos:',
    opciones: [
      {
  ...
  {
    titulo:
      '30. Al aumentar la altitud sin ajustar la relación de la mezcla, las prestaciones del motor de émbolo se ven afectadas por:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Unas superficies hipersustentadoras móviles cuya finalidad es dar mayor curvatura al ala para aumentar la sustentación',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Para compensar el flujo asimétrico de la hélice sobre el estabilizador vertical, y que no tengamos que hacer mucho esfuerzo en el pedal en vuelo',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '44. Durante el ascenso con valor constante de presión de admisión de aire (MAP) y de indicación de RPM del motor y con un ajuste de mezcla también constante, la potencia desarrollada por un motor alternativo:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          "Aumenta, pero esta situación sólo es posible en ULM's dotados con motores sobrealimentados y con hélice de velocidad constante",
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '45. En el caso de tener un fallo de motor y suponer que es de una perla en la bujía, ¿Qué intento de soltarla se puede hacer?',
    opciones: [
      {
  ...
  {
    titulo:
      "50. El carburador en un motor de 2 tiempos cumple dos funciones principales, una es: 'vaporizar el combustible y mezclarlo con el aire en una determinada proporción'. La otra es:",
    opciones: [
      {
  ...
  {
    titulo:
      '52. Los dispositivos hipersustentadores que facilitan la circulación de la corriente aerodinámica abriendo ranuras en el borde de ataque se denominan:',
    opciones: [
      {
  ...
  {
    titulo:
      '54. El sistema hidráulico se utiliza para mover equipos que requieran la aplicación de una fuerza durante periodos muy largos de tiempo:',
    opciones: [
      {
        textoRespuesta: 'Verdadero ',
        isCorrect: true
  ...
  {
    titulo:
      "57. La capacidad de una bujía para soportar grandes cargas sin sobrecalentamientos, es lo que se denominad 'gama térmica' que puede ser controlada",
    opciones: [
      {
  ...
  {
    titulo:
      '65. La batería se usa casi exclusivamente para la puesta en marcha, permaneciendo el resto del vuelo como fuente eléctrica de reserva',
    opciones: [
      {
        textoRespuesta: 'Falso',
        isCorrect: false
  ...
  {
    titulo:
      '94. Es aconsejable mantener alejado el depósito y conducciones de la gasolina de emisiones de calor (sistema de escape, por ejemplo), porque:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'a) El ángulo formado entre la vertical y el plano de la cuerda alar que proporciona la estabilidad horizontal',
        isCorrect: false
      },
      {
        textoRespuesta:
          'b) El ángulo formado entre la horizontal y el plano de la cuerda alar que proporciona la estabilidad vertical',
        isCorrect: false
      },
      {
