const preguntas = [
  ...
  {
    titulo:
      '3. Si vamos a aterrizar en un campo cuya elevación es de 1500 pies, y queremos hacer un tráfico a 500 pies de altura, una vez obtenido el QNH',
    opciones: [
      {
  ...
  {
    titulo:
      '11. Al aumentar la altitud sin ajustar la relación de la mezcla, las prestaciones del motor de émbolo se ven afectadas por:',
    opciones: [
      {
  ...
  {
    titulo:
      '21. En el hemisferio sur, durante la deceleración posterior a un aterrizaje en dirección este, la brújula magnética indicara:',
    opciones: [
      {
  ...
  {
    titulo:
      '27. Dejar los depósitos con poco combustible por largos periodos de tiempo, puede causar la aparición de agua en los depósitos',
    opciones: [
      {
        textoRespuesta: 'Falso',
        isCorrect: false
  ...
  {
    titulo:
      '29. Los dispositivos hipersustentadores cuya finalidad es la de aumentar el ángulo de ataque y así obtener una sustentación adicional se denominan:',
    opciones: [
      {
  ...
  {
    titulo:
      '37. Las superficies que permiten mantener el avión en una posición determinada, aliviando al piloto de la atención y el esfuerzo continuo sobre los mandos de control primario se denominan:',
    opciones: [
      {
  ...
  {
    titulo:
      '52. La hélice, elemento tractor del avión, está formada por un conjunto infinito de perfiles aerodinámicos. El ángulo de ataque de cada uno de ellos:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Es la superficie de la vista en planta del contorno aparente del ala, incluyendo la parte del ala que pueda estar cubierta por el fuselaje y excluyendo las góndolas de los motores',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Es la superficie de la vista en planta del contorno aparente del ala, excluyendo la parte del ala que pueda estar cubierta por el fuselaje o góndolas de los motores',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Es la superficie de la vista en planta del contorno aparente del ala, incluyendo la parte del ala que este cubierta por el fuselaje o góndolas de los motores',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '66. Si tenemos un medidor de temperatura de culata de cilindros con una sola sonda de temperaturas, toma su información de',
    opciones: [
      {
  ...
  {
    titulo:
      '98. Las bujías con electrodos redondeados producen una chispa menos potente que si tienen los electrodos los cantos vivos',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
