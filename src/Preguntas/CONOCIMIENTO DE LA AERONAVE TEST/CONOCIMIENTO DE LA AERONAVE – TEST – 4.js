const preguntas = [
    ...
    {
        titulo: "4. ¿Qué pérdida aproximada de potencia experimenta un motor atmosférico, sin turbocompresor, por cada mil pies de altitud?",
        opciones: [
            {
                textoRespuesta: "0,03",
                isCorrect: true
    ...
    {
        titulo: "6. Dejar el avión con los depósitos parcialmente llenos durante un largo periodo de tiempo puede ser la causa grave de contaminación, por formación de agua",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Aumentar la cantidad de combustible presente en la mezcla para compensar la reducción de la presión y de la densidad del aire",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "15. En el caso de no disponer de baterías, el motor no podría ponerse en marcha, ya que las magnetos no producirían encendido.",
        opciones: [
            {
                textoRespuesta: "Falso",
                isCorrect: true
    ...
    {
        titulo: "25. El sistema de escape en un motor de 2 tiempos tiene un gran efecto sobre las características de potencia, porque, además de actuar como válvula de escape, lo hace como:",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Existen en la mayoría de los motores y permite a la hélice tener un régimen de rotación inferior al régimen del motor",
                isCorrect: true
            },
            {
    ...
    {
        titulo: "51. El ángulo de ataque de las palas de una hélice de paso fijo, si mantenemos potencia constante, al incrementar la velocidad verdadera:",
        opciones: [
            {
    ...
    {
        titulo: "53. Una buena inspección de bujías puede descubrir, entre otras cosas: condiciones de mezcla, presencia o ausencia de preignición o detonación, calidad del combustible etc.",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    {
        titulo: "57. En caso de fallo de motor en vuelo, las palas de una hélice de velocidad constante que impulsan a un monomotor que carezca de sistema de abanderamiento:",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "b)\tEl centro donde se reúnen ficticiamente la acción de todas las fuerzas que actúan sobre el estradós y el intradós",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "69. Al cambiar de potencia en motores equipados con hélices de velocidad constante, la sobrecarga del motor se evita mediante:",
        opciones: [
            {
    ...
    {
        titulo: "80. Muchas cosas puede alterar el rendimiento de una hélice, reducir el empuje, etc., pero de las que se relacionan a continuación, ¿cuales, además de las señaladas, alteran el equilibrio de la hélice dando lugar a vibraciones?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Con un alto nivel de humedad en el aire puede formarse hielo aun con temperatura exterior superior a los 15°c",
                isCorrect: true
            },
            {
                textoRespuesta: "La humedad del aire no tiene nada que ver con la formación de hielo; solamente depende de la temperatura exterior",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Los refuerzos o costuras situados en las telas de que están construidos tales elementos y que impiden la progresión de las posibles rasgaduras que se originen",
                isCorrect: true
            },
            {
                textoRespuesta: "La curva del borde de ataque que para el impacto de los insectos u otros posibles obstáculos (aves, grava, etc.) que puedan chocar con un ULM",
                isCorrect: false
            }
        ]
    }
