const preguntas = [
    {
        titulo: "1. En un motor atmosférico, ¿en cuál de las siguientes situaciones se puede enriquecer la mezcla de aire y combustible sin que la modifiquemos nosotros?",
        opciones: [
            {
    ...
    {
        titulo: "4. Si estamos en un aeródromo en tierra y nuestro anemómetro marca 0 pies, ¿qué llevamos calado en la ventanilla de Kollsman?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "El número de revoluciones del motor variará en función de factores como la velocidad o la presión de admisión",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "12. Nuestro anemómetro marca las siguientes velocidades: Vs0 55; Vs1 65; Vfe 100; Vno 150; Vne 180. ¿A partir de qué velocidad no debemos usar los flaps?",
        opciones: [
            {
                textoRespuesta: "65",
                isCorrect: false
    ...
    {
        titulo: "16. Si durante el arranque del motor pasan 30 segundos y observamos que no hay indicación de presión del aceite, ¿cómo procederemos?",
        opciones: [
            {
    ...
    {
        titulo: "20. Si ponemos la calefacción en el carburador debido a la formación de hielo, ¿tenemos que ajustar la mezcla de aire y combustible?",
        opciones: [
            {
    ...
    {
        titulo: "23. Si estamos en tierra en un aeródromo y calamos el QNH en la ventanilla de Kollsman, ¿qué debería marcar el altímetro?",
        opciones: [
            {
    ...
    {
        titulo: "30. Con hélice de velocidad constante, el regulador mantiene fijo el número de revoluciones del motor modificando el paso de las palas:",
        opciones: [
            {
                textoRespuesta: "Falso",
                isCorrect: false
    ...
    {
        titulo: "38. Nuestro anemómetro marca las siguientes velocidades: Vs0 55; Vs1 65; Vfe 100; Vno 150; Vne 180. De las siguientes velocidades, ¿a cuál podríamos volar si estamos en zona de turbulencias?",
        opciones: [
            {
                textoRespuesta: "120",
                isCorrect: true
    ...
    {
        titulo: "58. La temperatura de los gases de escape tiene una relación directa con la cantidad idónea de combustible que necesita el motor:",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Frenos aerodinámicos que se suelen encontrar en medio de la superficie del ala y que se utilizan en aterrizajes",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "68. El error que presenta la brújula debido a la diferencia de grados entre el Norte geográfico y el magnético recibe el nombre de:",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Cada magneto proporciona la corriente necesaria a las bujías para que produzcan la chispa que inicia la ignición",
                isCorrect: true
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Dentro de los límites del arco amarillo, pues si vamos más despacio las turbulencias nos pueden hacer entrar en pérdida",
                isCorrect: false
            },
            {
                textoRespuesta: "Dentro de los límites del arco verde, pues así evitaremos los daños estructurales que pueden causar las turbulencias",
                isCorrect: true
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Tendremos que llevar siempre la calefacción porque no podremos saber si tenemos hielo hasta que el motor finalmente se pare",
                isCorrect: false
            },
            {
