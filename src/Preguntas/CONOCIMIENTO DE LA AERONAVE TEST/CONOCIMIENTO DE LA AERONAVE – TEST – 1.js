const preguntas = [
    ...
    {
        titulo: "4. La hélice en un avión no se comporta como un tornillo que se enrosca y avanza en el aire, sino que es un ala y como tal genera sustentación orientada hacia adelante",
        opciones: [
            {
    ...
    {
        titulo: "19. La batería se usa casi exclusivamente para la puesta en marcha, permaneciendo el resto del vuelo como fuente eléctrica de reserva:",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    {
        titulo: "35. Durante el ascenso, si nuestro motor es atmosférico, con ajuste constante de mando de gases y mando de RPM (con mezcla constante)",
        opciones: [
            {
    ...
    {
        titulo: "55. ¿Qué instrumento basa su medición en la diferencia de la presión atmosférica exterior y la presión atmosférica estándar?",
        opciones: [
            {
                textoRespuesta: "Altímetro",
                isCorrect: true
    ...
    {
        titulo: "56. Un ultraligero peso 150 Kg. en vacío y tiene un factor de carga de + 4 Kg., esto significa que la estructura puede soportar:",
        opciones: [
            {
    ...
    {
        titulo: "68. La filosofía de los dispositivos hipersustentadores es la de aumentar el ángulo de ataque y obtener así una sustentación adicional.",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    {
        titulo: "87. Si en vuelo debemos de actualizar el QNH ¿es una buena práctica obtenerlo, por ejemplo, calando en el altímetro la altitud que marque un GPS?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "No. Debo obtener un QNH lo más aproximado posible a la zona en la que estoy volando, pues así llevaré el mismo error de altitud que las demás aeronaves",
                isCorrect: true
            }
        ]
    },
    {
        titulo: "88. ¿Cuál es el número de zonas independientes a efectos de rasgaduras que deberá tener cada semiplano o elemento de control de un ULM?",
        opciones: [
            {
