const preguntas = [
  ...
  {
    titulo:
      '7. El tiempo meteorológico en una línea de turbonada suele le ser muy peligroso y produce chubascos muy intensos pero de duración',
    opciones: [
      {
  ...
  {
    titulo:
      '15. La variación de la temperatura con la altura en la atmósfera estándar es de 6,5º por kilómetro de altura hasta 11 kilómetros:',
    opciones: [
      {
        textoRespuesta: 'Verdadero ',
        isCorrect: true
  ...
  {
    titulo:
      '20. El predominio de corrientes descendentes, la disipación de las nubes y el cese de las precipitaciones en una tormenta, corresponde a la etapa de disipación.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '28. La relación que existe entre la humedad absoluta del aire y la que tendría que haber para que estuviera saturado, se denomina:',
    opciones: [
      {
  ...
  {
    titulo:
      '30. Si una masa de aire caliente estable al ascender uniformemente, se enfría y se condensa en nubes estables y estratificadas, crea:',
    opciones: [
      {
  ...
  {
    titulo:
      '39. El tiempo meteorológico en una línea de turbonada suele ser muy peligroso, y produce chubascos muy intensos, pero de duración:',
    opciones: [
      {
  ...
  {
    titulo:
      '43. Algunos fenómenos atmosféricos es posible preverlos, pero otros se presentan inesperadamente haciendo difícil su predicción.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      "44. La 'gloria' es un o unos anillos de colores de difracción, observado al lado opuesto del sol, sobre una nube de agua líquida o sobre el rocío.",
    opciones: [
      {
        textoRespuesta: 'Verdadero ',
        isCorrect: true
