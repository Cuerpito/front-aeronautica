const preguntas = [
  ...
  {
    titulo:
      '8. El METAR “LEJR 212130Z 10005KT 070V130 CAVOK 10/06 Q1028”, suponiendo que estamos en invierno, ¿a qué hora local se ha realizado?',
    opciones: [
      {
  ...
  {
    titulo:
      '16. En una aeronave con hélice de paso variable, antes del funcionamiento irregular del motor, ¿cuál es la primera indicación de que hay hielo en el carburador?',
    opciones: [
      {
  ...
  {
    titulo:
      '20. La capacidad de un determinado volumen de aire para almacenar vapor de agua se dobla aproximadamente cada 10º C de aumento de la temperatura.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Cuando un frente frío hace desaparecer de la superficie a un frente cálido, cuya masa de aire caliente se sitúa sobre el frente frío',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Tanto a barlovento como a sotavento, en el momento en que la masa de aire que sube por la ladera alcanza el nivel de condensación',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '44. En atmósfera estándar, estamos en un campo a 16º C. Despegamos y ascendemos unos 300 metros. ¿Qué temperatura aproximada hará a ese nivel?',
    opciones: [
      {
  ...
  {
    titulo:
      '80. Estamos en atmósfera estándar en un campo exactamente al nivel del mar. Ascendemos 1.000’. ¿Cuál debería ser la temperatura aproximadamente?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Es un viento que se da debido a que el agua se calienta más rápido que la tierra y produce un gradiente de presión',
        isCorrect: false
      },
      {
