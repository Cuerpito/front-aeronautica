const preguntas = [
    ...
    {
        titulo: "3. La estabilidad atmosférica viene determinada fundamentalmente por dos factores. Uno de ellos es la variación de la temperatura con la altura en el aire que rodea la masa de aire que asciende o desciende. El otro factor es:",
        opciones: [
            {
    ...
    {
        titulo: "18. En el caso de que la temperatura del aire (termómetro seco) y el punto de rocío (termómetro húmedo) estén muy próximos:",
        opciones: [
            {
    ...
    {
        titulo: "61. Los movimientos de la atmósfera, que son en parte regulares y en parte impredecibles, son provocados principalmente por:",
        opciones: [
            {
    ...
    {
        titulo: "67. Si al volar cerca de montañas se ven nubes en forma de coliflor y sobre ellas otras en forma de lenteja, es un signo de que podemos encontrar",
        opciones: [
            {
    ...
    {
        titulo: "88. La barrera tormentosa paralela y por delante de un frente frío, caracterizada por el extraordinario desarrollo de los Cb, con vientos muy fuertes y racheados, fuertes precipitaciones y gran aparato eléctrico, se denomina:",
        opciones: [
            {
    ...
    {
        titulo: "94. La transformación del vapor de agua en cristales de hielo, cuando el punto de roció está por debajo de 0° C, se denomina:",
        opciones: [
            {
