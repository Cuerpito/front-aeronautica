const preguntas = [
    ...
    {
        titulo: "20. Además de la circulación general de la atmósfera hay que tener en cuenta los efectos del viento local. Entre los vientos locales más conocidos, además de las brisas marinas y terrestres, se encuentran:",
        opciones: [
            {
    ...
    {
        titulo: "27. Un piloto puede esperar encontrarse con una cizalladura en condiciones de inversión térmica cuando la velocidad del viento entre 2000 y 4000 pies sobre la superficie:",
        opciones: [
            {
    ...
    {
        titulo: "40. La atmósfera es una capa gaseosa que rodea la tierra y, como en un océano, en ella hay mareas, corrientes y desplazamiento de masas, ¿cómo se llaman esos movimientos?",
        opciones: [
            {
    ...
    {
        titulo: "63. En un frente frío, con situaciones de aire caliente muy inestable, se produce una línea de turbonada por delante, a una distancia de:",
        opciones: [
            {
    ...
    {
        titulo: "69. Nos encontramos el avión con hielo en el borde de ataque. Podemos volar con precaución siempre que el extradós esté libre de hielo.",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: false
    ...
    {
        titulo: "78. La altura a que sobre la tierra o agua se encuentra la base de la capa inferior de nubes y que cubre más de la mitad del cielo, se llama:",
        opciones: [
            {
    ...
    {
        titulo: "91. De la relación que existe entre los gráficos de isobaras y la dirección del viento y fuerza del viento, podemos deducir que:",
        opciones: [
            {
            ...
            {
                textoRespuesta: "Los gráficos de isobaras sólo tienen relación respecto a la dirección del viento, no respecto a la intensidad",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "99. La atmósfera terrestre recibe calor del sol directamente y calor por irradiación de la tierra. ¿Pero en qué proporción aproximadamente?",
        opciones: [
            {
