const preguntas = [
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Condiciones meteorológicas expresadas en términos de visibilidad iguales o mejores que las mínimas especificadas',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Condiciones meteorológicas expresadas en términos de visibilidad, distancia de nubes y techo, inferiores a las mínimas especificadas para condiciones meteorológicas visuales',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'En el sentido contrario a las agujas del reloj y en el mismo sentido que los anticiclones en el hemisferio sur',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '39. Cuando la diferencia de temperatura de dos masa de aire es igual o mayor a 5ºC y la velocidad del frente igual o superior a 30 Kts, se produce:',
    opciones: [
      {
  ...
  {
    titulo:
      '41. Como sabemos, la atmósfera se divide en 5 zonas de distintas dimensiones, la gran mayoría de los vuelos y la casi totalidad de los fenómenos atmosféricos se desarrollan:',
    opciones: [
      {
  ...
  {
    titulo:
      '51. La isoterma es una línea que une puntos de igual temperatura. Aunque los mapas isotérmicos no dan al piloto demasiada información, hay una isoterma cuya altitud sobre todo en invierno, es necesario conocer para la seguridad de nuestro vuelo. ¿Cómo se llama?',
    opciones: [
      {
  ...
  {
    titulo:
      '56. La atmósfera es una capa gaseosa que rodea la tierra y, como en un océano, en ella hay mareas, corrientes y desplazamiento de masas, ¿Cómo se llaman esos movimientos?',
    opciones: [
      {
  ...
  {
    titulo:
      '62. Si al llegar a nuestro campo de vuelo observamos que hay niebla a baja cota pero parece que esta va a disiparse en breve, ¿Podremos despegar?:',
    opciones: [
      {
  ...
  {
    titulo:
      '66. Cuando una masa de aire caliente estable asciende uniformemente, enfriándose y condensándose en nubes estables y estratificadas, el frente es:',
    opciones: [
      {
  ...
  {
    titulo:
      '80. Cuando una masa de aire frío, de mayor actividad, avanza por debajo del aire cálido, penetrando como una cuña y obligándola a elevarse, se produce un frente:',
    opciones: [
      {
  ...
  {
    titulo:
      '89. Cuando una masa de aire caliente, de mayor actividad, arremete contra una masa de aire frío haciéndola retirarse, se produce un frente:',
    opciones: [
      {
        textoRespuesta: 'Cálido',
        isCorrect: true
  ...
  {
    titulo:
      '90. ¿Qué formación nubosa es más probable que se desarrolle a baja cota cuando una masa de aire cálido se superpone a una masa de aire frío?',
    opciones: [
      {
        textoRespuesta: 'Estratos',
        isCorrect: true
  ...
  {
    titulo:
      '92. Existe riesgo de encontrar onda de montaña o al menos turbulencia fuerte cuando el viento es perpendicular a la cadena montañosa y su intensidad es como mínimo de:',
    opciones: [
      {
