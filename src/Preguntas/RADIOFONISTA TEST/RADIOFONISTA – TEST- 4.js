const preguntas = [
  {
    titulo:
      '1. Al establecer contacto con nuestro transmisor/receptor de comunicaciones en una frecuencia determinada, notamos que tenemos ruidos parásitos. ¿Qué dispositivo usaremos para eliminarlos?',
    opciones: [
      {
  ...
  {
    titulo:
      '21. Estamos volando en un terreno llano a FL050 a aproximadamente 100 millas náuticas de una emisora de VHF. ¿Recibiremos la señal?',
    opciones: [
      {
  ...
  {
    titulo:
      '27. En el circuito de vuelo, ya sólo nos queda girar 90º una vez para entrar en el tramo final antes del aterrizaje. ¿Dónde tenemos que comunicar que estamos?',
    opciones: [
      {
  ...
  {
    titulo:
      '30. La regla general de la transmisión de la hora, siempre que no haya posibilidad de confusión, es la de la utilización exclusiva de los minutos.',
    opciones: [
      {
  ...
  {
    titulo:
      '47. En vuelo hemos recibido una señal luminosa del control del aeropuerto. ¿Cómo indicaremos el acuse de recibo de dicha señal?',
    opciones: [
      {
  ...
  {
    titulo:
      '54. ¿Cómo llamamos a la zona en la que no recibimos las ondas VHF debido a que hay un obstáculo entre la torre y la aeronave?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'No debería hacerlo, ya que podría causar interferencias con otras estaciones que operen en la misma frecuencia',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'La información meteorológica se le facilitará a la aeronave cuando se ponga en contacto con la dependencia ATS',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '66. En el momento en que detectamos un posible fallo de comunicaciones debemos tratarlo como una situación de emergencia:',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: false
  ...
  {
    titulo:
      '73. En vuelo detectamos que tenemos problemas para establecer comunicación. Indique cuál de las siguientes acciones debemos llevar a cabo antes:',
    opciones: [
      {
  ...
  {
    titulo:
      '75. ¿Cómo comunicaremos que estamos en la trayectoria de vuelo en la dirección del aterrizaje a lo largo de la prolongación del eje de pista?',
    opciones: [
      {
        textoRespuesta: 'Tramo base',
        isCorrect: false
  ...
  {
    titulo:
      '82. Una aeronave envía un mensaje de socorro a una estación aeronáutica. Estamos en vuelo y lo recibimos. ¿Podemos acusarle recibo?',
    opciones: [
      {
  ...
  {
    titulo:
      '83. Nuestra hora prevista de llegada es a las 18:37 UTC. ¿Cómo la comunicaremos si puede haber confusión con la hora actual?',
    opciones: [
      {
  ...
  {
    titulo:
      '88. Estamos en un aeródromo que tiene las pistas 12/30. Nos comunican que la pista en uso es la tres cero y tenemos exactamente viento en cara. El viento viene de:',
    opciones: [
      {
        textoRespuesta: '030º',
        isCorrect: false
  ...
  {
    titulo:
      '91. Si durante el vuelo tenemos una emergencia mientras estamos manteniendo contacto con tierra en una frecuencia determinada, ¿cómo procederemos?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Pondremos el código 7700 en el transpondedor, por lo que no será necesario comunicar la emergencia en ninguna frecuencia',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '94. Con nuestra aeronave en tierra recibimos una serie de destellos verdes desde el control del aeródromo. ¿Qué significa?',
    opciones: [
      {
        textoRespuesta: 'Regrese para aterrizar',
        isCorrect: false
  ...
  {
    titulo:
      '98. ¿De qué forma podemos evitar hacer llamadas innecesarias y saturar las frecuencias de los Servicios de Tránsito Aéreo (ATS) durante el vuelo?',
    opciones: [
      {
