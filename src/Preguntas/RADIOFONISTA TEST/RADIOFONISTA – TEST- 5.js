const preguntas = [
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'El rumbo magnético que ha de seguir para aproximarse a la estación, con las correcciones de viento incluidas.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'El rumbo verdadero que ha de seguir para aproximarse a la estación, con las correcciones de viento incluidas.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'El rumbo magnético que ha de seguir para aproximarse a la estación, al que el piloto tendrá que aplicarle las correspondientes correcciones debido al viento.',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '3. Si todos los intentos de establecer comunicación con estaciones aeronáuticas u otras aeronaves fracasan, ¿qué se debe hacer?',
    opciones: [
      {
        textoRespuesta:
          'Transmitir el mensaje dos veces en la frecuencia apropiada, comenzando con la frase “Transmitiendo a ciegas”.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Transmitir el mensaje dos veces en la frecuencia apropiada y terminar la emisión con la frase “Transmitiendo a ciegas”.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Repetir dos veces la frase “Transmitiendo a ciegas” en la frecuencia apropiada y esperar a recibir respuesta.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Transmitir el mensaje tres veces en la frecuencia apropiada y terminar la emisión con la frase “Transmitiendo a ciegas”.',
        isCorrect: false
      }
    ]
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'La frecuencia (VHF) asignada a una determinada señal de respuesta de impulsos múltiples transmitida por un transpondedor.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'El número asignado a una determinada señal de respuesta de impulsos múltiples transmitida por un transpondedor.',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Una transmisión en directo que se emite constantemente con información meteorológica y de otro tipo que pueda ser de interés para el piloto.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una transmisión grabada que se emite constantemente con información meteorológica y de otro tipo que pueda ser de interés para el piloto.',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '8. Para conseguir la máxima inteligibilidad posible en las comunicaciones por radio, es importante que quien esté transmitiendo:',
    opciones: [
      {
        textoRespuesta:
          'Mantenga un volumen creciente de voz y una velocidad de enunciación que no exceda las 60 palabras por minuto.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Mantenga el volumen de voz a un nivel constante de conversación y una velocidad de enunciación que no exceda de 100 palabras por minuto.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Mantenga el volumen de voz a un nivel constante de conversación y una velocidad de enunciación que exceda de 100 palabras por minuto.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'No mantenga el volumen de voz a un nivel constante de conversación y sí una velocidad de enunciación que no exceda de 100 palabras por minuto.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '9. El procedimiento por el que la estación receptora repite un mensaje recibido o una parte apropiada del mismo a la estación transmisora, con el fin de obtener confirmación de que la recepción ha sido correcta es:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          '“Anule” quiere decir haga caso omiso de esta transmisión y “Cancele”, anular la autorización transmitida anteriormente.',
        isCorrect: true
      },
      {
      ...
      {
        textoRespuesta:
          '“Cancele” quiere decir haga caso omiso de esta transmisión y “Anule”, anular la autorización transmitida anteriormente.',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Una trayectoria en la que no haya obstáculos y que las dos antenas se encuentren fuera del horizonte de radio de la otra.',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Un aviso que contiene información relativa al establecimiento, condición o modificación de cualquier instalación aeronáutica, servicio, procedimiento o peligro.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Un informe que prepara el comandante de la aeronave durante el vuelo, relativo a datos de posición, operación o meteorológicos.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'La información referente al vuelo previsto o a parte del mismo que debe presentarse en una oficina de notificación de los servicios de tránsito aéreo.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una notificación que se realiza a los centros coordinadores de salvamento cuando se considera que una aeronave está en estado de emergencia.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '16. Si nos encontramos con nuestra aeronave en tierra y como señal de luces recibimos una serie de destellos verdes quiere decir que:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'ALERFA. Expresión genérica que significa, según el caso, fase de incertidumbre, fase de emergencia o fase de peligro.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'ALERFA. Situación en la cual existen motivos justificados para creer que una aeronave y sus ocupantes están amenazados por un peligro grave e inminente y necesitan auxilio inmediato.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '18. Tanto una estación aeronáutica como una aeronave que quieran transmitir mensajes a otra que esté en situación de peligro, deberán:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Limitarse a escuchar lo que el piloto al mando de la aeronave les esté comunicando y enviar la ayuda necesaria.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '20. Estando en el circuito de fallo de radio nos han indicado que regresemos para aterrizar y posteriormente nos envían una señal con luz pirotécnica roja. ¿Qué debemos hacer?',
    opciones: [
      {
  ...
  {
    titulo:
      '21. ¿Cuáles son las señales visuales que se utilizan para advertir a una aeronave no autorizada que se encuentra volando en una zona restringida, prohibida o peligrosa?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Una serie de proyectiles, lanzados con un intervalo de 10 segundos que al explotar produzcan luces o estrellas rojas y verdes.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Una serie de proyectiles, lanzados con un intervalo de 30 segundos que al explotar produzcan luces o estrellas rojas.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '22. En vuelo, ¿dónde es posible obtener información meteorológica que pueda afectar a las condiciones adecuadas para los vuelos VFR?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Siempre será necesario hacer una llamada al servicio de información en vuelo para obtener datos de este tipo.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '23. Entre las fases de emergencia está la fase de peligro. ¿Cuál es la palabra clave que se utiliza en su caso y qué significa?',
    opciones: [
      {
        textoRespuesta:
          'ALERFA. Situación en la cual existen motivos justificados para creer que una aeronave y sus ocupantes están amenazados por un peligro grave e inminente y necesitan auxilio inmediato.',
      ...
      {
        textoRespuesta:
          'INCERFA. Situación en la cual existen motivos justificados para creer que una aeronave y sus ocupantes están amenazados por un peligro grave e inminente y necesitan auxilio inmediato.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'DETRESFA. Situación en la cual existen motivos justificados para creer que una aeronave y sus ocupantes están amenazados por un peligro grave e inminente y necesitan auxilio inmediato.',
        isCorrect: true
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Aumenta con la altura, se corta si existen obstáculos entre la estación emisora y la receptora y se puede ver afectada por algunos fenómenos meteorológicos.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Aumenta con la altura, se corta si existen obstáculos entre la estación emisora y la receptora pero no se ve afectada por ningún fenómeno meteorológico.',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Debe ser porque exista una condición que afecte a la seguridad de la aeronave u otro vehículo, de una persona a bordo o a la vista, pero que no exige ayuda inmediata.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Debe ser por la condición de estar amenazado por un riesgo serio o inminente aunque no tenga por qué requerirse ayuda inmediata.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Debe ser porque exista una condición que afecte a la seguridad de la aeronave u otro vehículo, de una persona a bordo o a la vista y que exige ayuda inmediata.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '29. Hay una serie de fases en las que no se debe comunicar nada a una aeronave por motivos de seguridad, entre las que se encuentran:',
    opciones: [
      {
        textoRespuesta:
          'La carrera de despegue, el recorrido de aterrizaje, la última parte de la aproximación final o al inicio de un procedimiento de frustrada.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'La carrera de despegue, el ascenso antes de superar el nivel de transición, la última parte de la aproximación final o al inicio de un procedimiento de frustrada.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Justo después del despegue, la última parte de la aproximación final, la última parte de una aproximación final o si la aeronave ha declarado una situación de emergencia o urgencia.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'La carrera de despegue, el recorrido de aterrizaje, la última parte de aproximación final o si la aeronave ha declarado una situación de emergencia o urgencia.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '31. La forma de avisar a una aeronave no autorizada de que se encuentra en una zona restringida, prohibida o peligrosa, o que está a punto de entrar en ella, es:',
    opciones: [
      {
        textoRespuesta:
          'Con una serie de proyectiles que lanzados con un intervalo de 10 segundos si es de noche, o con una serie luces de destellos rojos  si es de día.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Con una serie de luces de destellos rojos si es de noche o con una serie de intervalos lanzados con un intervalo de 10 segundos cada uno su es de día.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Con una serie de luces de destellos rojos que parpadean con un intervalo de 10 segundos tanto de día como de noche.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '32. Cuando una aeronave envía un mensaje de socorro a una estación y ésta no acusa recibo, otras estaciones o aeronaves que estén escuchando deberán:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Salirse de esa frecuencia de trabajo para facilitar la comunicación entre la aeronave y la estación receptora.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Mantener la escucha sin intentar ayudar a la aeronave, pues podría entorpecer la ayuda prestada por parte de la estación receptora.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '33. El aviso que contiene información relativa al establecimiento, condición o modificación de cualquier instalación aeronáutica, servicio, procedimiento o peligro, cuyo conocimiento oportuno es esencial para el personal encargado de las operaciones de vuelo es:',
    opciones: [
      {
        textoRespuesta: 'El AIP.',
        isCorrect: false
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Porque exista una condición que afecte a la seguridad de la aeronave u otro vehículo, de una persona a bordo o a la vista y que exija ayuda inmediata.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Porque exista una condición que afecte a la seguridad de la aeronave u otro vehículo, de una persona a bordo o a la vista, pero que no exige ayuda inmediata.',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '40. Si nos comunican que tenemos que llamar a Torre en la frecuencia 119,75 y nuestro indicativo de llamada es EC-LK2, ¿cómo realizaríamos la colación de este mensaje?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Una estación de radio del servicio móvil aeronáutico ubicada en una aeronave que permite la comunicación bilateral aire/tierra y entre aeronaves.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una estación de radio del servicio fijo aeronáutico ubicada en tierra que permite la comunicación bilateral aire/tierra.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una estación de radio del servicio móvil aeronáutico ubicada en tierra que permite la comunicación bilateral aire/tierra.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Una estación de radio del servicio fijo aeronáutico ubicada en una aeronave que permite la comunicación bilateral aire/tierra y entre aeronaves.',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Cantidad y tipo de nubes, dirección e intensidad del viento, temperaturas máxima y mínima para un periodo de 24 horas y presión atmosférica.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Tormenta activa, línea de turbonada, cantidad y tipo de nubes, turbulencia fuerte o dirección e intensidad del viento.',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Emitiendo nuestro mensaje una vez, precedido por las palabras “fallo de comunicaciones”, cuando no puede establecerse comunicación en ambas direcciones pero creemos que la estación puede recibirnos.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Emitiendo nuestro mensaje una vez, precedido por las palabras “transmitiendo a ciegas”, cuando no puede establecerse comunicación en ambas direcciones pero creemos que la estación puede recibirnos.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Repitiendo nuestro mensaje dos veces, precedido por las palabras “transmitiendo a ciegas”, cuando no puede establecerse comunicación en ambas direcciones pero creemos que la estación puede recibirnos.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Repitiendo nuestro mensaje dos veces, precedido por las palabras “fallo de comunicaciones”, cuando no puede establecerse comunicación en ambas direcciones pero creemos que la estación puede recibirnos.',
        isCorrect: false
      }
    ]
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Información de carácter permanente y de los cambios temporales de larga duración, dividida en tres secciones.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Información de carácter permanente dividida en tres secciones e información meteorológica que incluye el pronóstico TAFOR.',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'La pista en uso, la información meteorológica, el altímetro, el código SSR, el rumbo y el nivel de transición.',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Debe existir una distancia inferior a las 1.000 millas náuticas entre las antenas de las estaciones emisora y receptora.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Debe existir una distancia inferior a las 300 millas náuticas entre las antenas de las estaciones emisora y receptora.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Es necesaria una altura suficiente de la antena de la estación receptora pero no tiene por qué existir una línea de visión entre ésta y la estación emisora.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '51. Durante el día, con luz suficiente, una aeronave en tierra con fallo de comunicaciones acusará recibo de la siguiente forma:',
    opciones: [
      {
  ...
  {
    titulo:
      '52. Indique cuál sería la forma correcta de que una aeronave con el indicativo EC-EF2 acuse recibo de un mensaje recibido previamente:',
    opciones: [
      {
  ...
  {
    titulo:
      '53. Para una correcta e inteligible comunicación por radio, es importante estar familiarizado con las técnicas de manejo del micrófono, como por ejemplo:',
    opciones: [
      {
        textoRespuesta:
          'Utilizar siempre un modulador con nivel constante, o será muy difícil mantener el nivel de voz y que la comunicación sea efectiva.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '54. El servicio de información en vuelo proporcionado por las dependencias responsables de un espacio aéreo se puede dividir en:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Preferiblemente en el idioma que la estación terrestre use habitualmente, que no tiene por qué ser la del Estado en el que se efectúan estas comunicaciones.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'En el idioma que esté establecido por ley en ese lugar, que habrá que consultar previamente a la realización del vuelo.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '56. La forma de acusar recibo de una aeronave en vuelo que no puede comunicar por radio debido a un fallo de comunicaciones es la siguiente:',
    opciones: [
      {
        textoRespuesta:
          'Balanceando las alas durante las horas de luz y emitiendo destellos con los faros de aterrizaje o, si no los tuviera, con la luz de navegación, por la noche.',
        isCorrect: true
      },
      {
      ...
      {
        textoRespuesta:
          'Balanceando las alas por la noche y emitiendo destellos con los faros de aterrizaje o, si no los tuviera, con la luz de navegación, durante las horas de luz.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Balanceando las alas a la vez que se emiten destellos dos veces con los faros de aterrizaje o, si no los tuviera, con la luz de navegación.',
        isCorrect: false
      }
    ]
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Deberán llevar un acuse de recibo por parte de la aeronave, que terminará la comunicación con su distintivo de llamada.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Deberán llevar un acuse de recibo por parte de la aeronave, que comenzará la comunicación con su distintivo de llamada.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '58. Estamos en viento en cola del circuito de tránsito de un aeródromo en el que vamos a aterrizar en la pista orientada hacia 270º. Nuestra matrícula es EC-FM3. ¿Cuál es la forma más correcta de comunicarlo?',
    opciones: [
      {
  ...
  {
    titulo:
      '59. En cuanto a los mensajes enviados a través del Servicio Móvil Aeronáutico, indique cuál de las siguientes afirmaciones es correcta:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Los mensajes relativos a la regularidad de los vuelos tienen preferencia sobre todos los demás, excepto sobre los de urgencia y emergencia.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Los mensajes relativos a la seguridad de los vuelos tienen preferencia sobre todos los demás, excepto sobre los de urgencia y emergencia.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '61. Una estación aeronáutica que tenga que acusar recibo en este caso de la aeronave con indicativo EC-TS1, ¿cómo lo hará?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Moviendo los alerones o el timón de profundidad a la vez que realiza dos veces destellos con las luces de aterrizaje o, si no las tuviera, con el timón de profundidad.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '63. Un vuelo VFR, ¿debe mantener escucha continua de los servicios de tránsito aéreo que suministre el servicio de información de vuelo?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Sí, cuando se vuele en una parte del espacio aéreo controlado en la que se exige la presentación de un plan de vuelo.',
        isCorrect: true
      },
      {
      ...
      {
        textoRespuesta:
          'No, la escucha continua en este caso es opcional al tratarse de un vuelo que no sigue las reglas de vuelo instrumental.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '64. En el circuito de fallo de radio, ¿qué señal de luces debemos esperar de la torre que nos indique estamos autorizados para aterrizar?',
    opciones: [
      {
  ...
  {
    titulo:
      '65. En cuanto a la radiogoniometría, el piloto puede solicitar a la estación correspondiente una marcación o un rumbo. ¿Qué información aportará la estación si el piloto solicita el QDM?',
    opciones: [
      {
        textoRespuesta:
          'El rumbo magnético que debería seguir la aeronave, con la corrección de viento ya aplicada, para llegar a la estación.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'El rumbo verdadero que debería seguir la aeronave, con la corrección de viento ya aplicada, para llegar a la estación.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '70. Por la noche, un avión en vuelo tiene un fallo de comunicaciones y tiene que acusar recibo de alguna señal recibida. ¿Cómo lo llevará a cabo?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Balanceando las alas a la vez que se emiten destellos dos veces con los faros de aterrizaje o la luz de navegación.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Emitiendo destellos dos veces con los faros de aterrizaje o, en caso de que no se disponga de ellos, con la luz de navegación.',
        isCorrect: true
      }
    ]
  },
  {
    titulo:
      '71. Los informes de posición que los servicios de tránsito aéreo solicitan a las aeronaves suelen contener la siguiente información:',
    opciones: [
      {
        textoRespuesta:
          'Identificación de la aeronave, posición, hora, nivel de vuelo o altitud y la posición siguiente y la hora a la que se sobrevolará.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Identificación de la aeronave, posición, viento, nivel de vuelo y posición siguiente y la hora a la que se sobrevolará.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Identificación de la aeronave, hora, nivel de vuelo o altitud, la posición siguiente y la hora a la que se sobrevolará e identificación de la estación a la que se llama.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '73. El Servicio Móvil Aeronáutico tiene un orden de prioridad de mensajes. Sin embargo, cuando se recibe más de uno con la misma prioridad, ¿cómo se transmiten?',
    opciones: [
      {
        textoRespuesta:
          'Lo recomendado es que se transmita en primer lugar el que la persona encargada de las comunicaciones decida cuál es más importante.',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Una transmisión desde una estación a otra en circunstancias en que no puede establecerse comunicación en ambos sentidos, pero cuando se cree que la estación llamada no puede recibir la transmisión.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una transmisión desde una estación a otra en circunstancias en que no puede establecerse comunicación en ambos sentidos, pero cuando se cree que la estación llamada puede recibir la transmisión.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Una transmisión desde una estación a otra en circunstancias en que puede establecerse comunicación en ambos sentidos, pero cuando se cree que la estación llamada no puede recibir la transmisión.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una transmisión desde una estación en circunstancias en que no puede establecerse comunicación con otra concreta.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '75. ¿Con cuál de las siguientes abreviaturas se indica el horario de un aeródromo que está operativo desde el ocaso hasta el orto?',
    opciones: [
      {
        textoRespuesta: 'HJ.',
        isCorrect: false
  ...
  {
    titulo:
      '76. ¿Cuál o cuáles de las siguientes señales indican la dirección que ha de seguir una aeronave para aterrizar o despegar?',
    opciones: [
      {
        textoRespuesta:
          'Una T de color blanco o anaranjado y un tetraedro anaranjado o negro por la cara izquierda y blanco o aluminio por la derecha.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Una flecha de color llamativo en el área de señales u horizontalmente en el extremo de una pista o en el de una franja de uso.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Una T horizontal de color blanco o anaranjado o una flecha de color llamativo en el área de señales u horizontalmente en el extremo de una pista o en el de una franja de uso.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '78. En cuanto al orden de prioridad de los mensajes que se emiten a través del Servicio Móvil Aeronáutico, indique cuál de las afirmaciones no es correcta:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Las comunicaciones relativas a la radiogoniometría tienen prioridad sobre los relativos a la seguridad de los vuelos.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Los mensajes relativos a la seguridad de los vuelos tienen prioridad sobre los relativos a la regularidad de éstos.',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Un dispositivo silenciador utilizado para eliminar el ruido causado por las posibles interferencias de la señal.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Un dispositivo que mejora la calidad de la señal recibida en el equipo de radio, fundamental para las comunicaciones aeronáuticas.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '81. La respuesta por parte de una estación aeronáutica a la que hemos llamado para hacer una prueba de radio debe ir en el siguiente orden:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Identificación de la aeronave, identificación de la estación aeronáutica y la indicación de la legibilidad de la transmisión.',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '82. La palabra utilizada en las comunicaciones aeronáuticas cuando el mensaje todavía no  ha terminado pero se quiere realizar una pausa en el mismo es:',
    opciones: [
      {
  ...
  {
    titulo:
      '83. La distancia máxima de recepción de una señal VHF volando sobre un terreno sin obstáculos a FL060 será aproximadamente de:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Usando la palabra “Corrección”, seguida de la última palabra o frase transmitida correctamente, y posteriormente añadiendo la versión correcta.',
        isCorrect: true
      },
      {
      ...
      {
        textoRespuesta:
          'Usando las palabras “Corrección repito”, seguidas de la última palabra o frase transmitida correctamente, y posteriormente añadiendo la versión correcta.',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Señal PAN-PAN, identificativo de la aeronave, naturaleza del peligro, intenciones del piloto al mando y situación actual.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Señal MAYDAY, identificativo de la aeronave, naturaleza del peligro, intenciones del piloto al mando y situación actual.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Señal MAYDAY, identificativo de la aeronave, naturaleza del peligro, intenciones del piloto al mando, información relativa a la meteorología y situación actual.',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'El equipo que forma la red secundaria de navegación y que es capaz de proporcionar dirección y sentido a la estación.',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Siempre hay que cambiar a la frecuencia de emergencia y pronunciar la palabra MAYDAY tres veces al principio de la comunicación.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Siempre hay que cambiar a la frecuencia de emergencia y pronunciar la expresión PAN-PAN tres veces al principio de la comunicación.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '96. Una aeronave que no consigue establecer contacto con la estación aeronáutica en la frecuencia designada, ¿debe cambiar de frecuencia?',
    opciones: [
      {
        textoRespuesta:
          'Sí, la aeronave tratará de establecer comunicación con otros aviones en otras frecuencias apropiadas en la ruta.',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Sí, deberá dejar de intentar comunicarse con esa estación, cambiar la frecuencia e intentar la comunicación con una estación diferente.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '97. La señal visual que se envía a una aeronave no autorizada para advertirle de que está en una zona restringida, prohibida o peligrosa es:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Una serie de proyectiles que solo se pueden lanzar desde tierra con un intervalo de 10 segundos entre cada uno.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una serie de proyectiles que solo se pueden lanzar desde otra aeronave con un intervalo de 10 segundos entre cada uno.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una serie de proyectiles que solo se pueden lanzar desde tierra con un intervalo de un minuto entre cada uno.',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '98. En el circuito de tránsito de aeródromo nos encontramos en el tramo viento en cara de la pista orientada hacia 080º y nuestra matrícula es EC-LZ2. ¿Cómo lo comunicaremos?',
    opciones: [
      {
  ...
  {
    titulo:
      '99. El acuse de recibo de una aeronave en vuelo con fallo de comunicaciones durante las horas del día en las que hay suficiente luz se realiza:',
    opciones: [
      {
        textoRespuesta:
          'Emitiendo destellos dos veces con los faros de aterrizaje o, en caso de que no se disponga de ellos, con la luz de navegación.',
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Se emite información sobre fenómenos meteorológicos en ruta que puedan afectar a la seguridad de las aeronaves.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Se emite información sobre fenómenos meteorológicos alrededor de un aeródromo que puedan afectar a la seguridad de las aeronaves.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Se emite información meteorológica cada vez que hay cambios significativos en los alrededores de un aeródromo.',
        isCorrect: false
      }
    ]
  }
