const preguntas = [
  ...
  {
    titulo:
      '5. Volamos con una indicación de rumbo en la brújula de 200. ¿Cuál es la forma correcta de decir por la radio el rumbo que llevamos?',
    opciones: [
      {
  ...
  {
    titulo:
      '7. En un aeropuerto con las comunicaciones muy congestionadas ¿Qué medida tomaría para no entorpecer las mismas a la hora de recibir una autorización?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Evitar pedir autorización para rodar. Rodaremos directamente y nos pararemos en el punto de espera de la pista en servicio. Preguntas',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '14. Después de hacer una llamada a la estación aeronáutica y antes de hacer una segunda llamada, deberá transcurrir un periodo de por lo menos:',
    opciones: [
      {
  ...
  {
    titulo:
      '18. Después que se haya establecido la comunicación por medio del distintivo de llamada EC­-ABC, ¿Qué distintivo de llamada abreviada usaríamos?',
    opciones: [
      {
        textoRespuesta: 'EBC',
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Mayday, mayday, mayday, EC-CUE parada de motor sobre Almenara, intentaré un aterrizaje de emergencia en La Llosa.',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Cierto, excepto los que se utilicen en la transmisión de información sobre altitud, altura de las nubes, visibilidad y alcance visual en la pista, constituidos únicamente por centenas redondas o millares redondos',
        isCorrect: true
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Cuatro partes: Servicio Fijo Aeronáutico; Servicio Móvil Aeronáutico; Servicio de Radionavegación Aeronáutica; Servicio de Radiodifusión Aeronáutica',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Tres partes: Servicio de Información de Vuelo; Servicio de Control del Tránsito Aéreo; Servicio de Control de Aproximación',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Cuatro partes: Servicio de Tránsito Aéreo; Servicio de Información Aeronáutica Servicio Meteorológico; Servicio de Telecomunicaciones',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Extremaremos las precauciones vigilando la posición de los demás tráficos antes de entrar en circuito y durante el mismo',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '56. ¿Podemos realizar comentarios personales con nuestra radio instalada en la aeronave en banda aérea con otros compañeros?',
    opciones: [
      {
  ...
  {
    titulo:
      "59. Si la torre nos dice 'ELK, Córdoba, rodar a posición pista 03, temperatura 21, punto de rocío 15, QNH 1001, avise listo', contestaremos:",
    opciones: [
      {
  ...
  {
    titulo:
      '70. ¿Cuál de las siguientes palabras o frases de procedimiento significa: "Mi transmisión ha terminado y espero su respuesta"?',
    opciones: [
      {
  ...
  {
    titulo:
      "77. Cuando el término 'CAVOK' se usa en un informe meteorológico de rutina (METAR), los valores de la visibilidad y nubes son:",
    opciones: [
      {
  ...
  {
    titulo:
      '88. Después de hacer una llamada a la estación aeronáutica y antes de hacer una segunda llamada, deberá transcurrir un periodo de por lo menos:',
    opciones: [
      {
        textoRespuesta: '5 segundos',
        isCorrect: false
  ...
  {
    titulo:
      '92. Un mensaje relativo a un avión bajo amenaza de un peligro grave e inminente, que requiera ayuda inmediata, se denomina:',
    opciones: [
      {
  ...
  {
    titulo:
      '95. El controlador dice "EC-LY3 al norte del aeropuerto hay ejercicios de paracaidismo" La contestación "Recibido, EC-LY3" ¿Es correcta?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'a) Si no recibimos ningún tipo de comunicación incluyendo los indicativos morse de las radioayudas, podemos sospechar fallo del altavoz',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '100. Con fallo de radio y una vez agotadas todas las posibilidades de restablecer comunicaciones, ¿qué considera más correcto?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          "Transmitiremos dos veces las frase: 'Transmitiendo a ciegas' seguido del nombre del destinatario de dicho mensaje",
        isCorrect: true
      }
    ]
  }
