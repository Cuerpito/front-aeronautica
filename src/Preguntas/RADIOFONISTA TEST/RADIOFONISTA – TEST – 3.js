const preguntas = [
    ...
    {
        titulo: "4. ¿Cual es el indicativo en radiotelefonía para la estación que presta servicios de control de movimientos en superficie de las aeronaves en la zona de maniobras?",
        opciones: [
            {
    ...
    {
        titulo: "10. Si existe alguna circunstancia añadida al fallo de radio la cual no permite hacer la pasada por la torre para recibir autorización, por ejemplo poco combustible, o cualquier otra situación de emergencia. ¿Qué haría?",
        opciones: [
            {
    ...
    {
        titulo: "13. Después de hacer una llamada a la estación aeronáutica y antes de hacer una segunda llamada, deberá transcurrir un periodo de por lo menos:",
        opciones: [
            {
    ...
    {
        titulo: "17. ¿A qué banda pertenece el entorno de frecuencias comprendido entre 118.000 -­ 136.975 MHz del Servicio Aeronáutico Móvil?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Autorizaciones ATC, instrucciones de velocidad, información del estado de las pistas, QNH, código transponder",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "25. Una aeronave es autorizada a mantener corto de la pista en uso. ¿Cuál es la fraseología correcta para indicar que se cumplirá dicha instrucción?",
        opciones: [
            {
                textoRespuesta: "Recibido",
                isCorrect: false
    ...
    {
        titulo: "28. Al avión X­BC se le ha ordenado contactar con la TORRE de Córdoba en la frecuencia de 118.3 ¿Cual es la respuesta correcta para indicar que cumplirá la orden recibida?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Una transmisión de información relativa a la navegación aérea que no está dirigida a una estación o estaciones específicas",
                isCorrect: false
            },
            {
                textoRespuesta: "Una transmisión de mensajes relativos a información meteorológica en ruta que puede afectar a la seguridad de la operación de aeronaves y no está dirigido a ninguna estación o estaciones específicas",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Una condición que afecta a la seguridad de una aeronave o de una persona a bordo y que no requiere asistencia inmediata",
                isCorrect: true
            },
            {
                textoRespuesta: "Una condición que afecta a la altitud de una aeronave cuando ésta está interceptando el localizador durante una aproximación ILS",
                isCorrect: false
            },
            {
                textoRespuesta: "Una condición que afecta a la seguridad de una persona a bordo o a la vista y que no requiere asistencia inmediata",
                isCorrect: false
            },
            {
                textoRespuesta: "Una condición en la que se está amenazado por un peligro serio e inminente y en la que se requiere asistencia inmediata",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Informe de posición, información operacional e información meteorológica a petición del servicio meteorológico",
                isCorrect: true
            },
            {
    ...
    {
        titulo: "57. En un aeropuerto con control de rodadura, de aeródromo (torre) y de aproximación ¿Quién nos dará información acerca de plataformas y calles de rodaje?",
        opciones: [
            {
    ...
    {
        titulo: "58. Al avión XBC se le ha ordenado contactar con torre de Córdoba en la frecuencia 118.3, ¿cuál es la respuesta correcta para indicar que cumple la orden recibida?",
        opciones: [
            {
