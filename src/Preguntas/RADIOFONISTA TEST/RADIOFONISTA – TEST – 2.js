const preguntas = [
  {
    titulo:
      "1. Cuando un piloto por radio dice 'solicito vector radar para circunnavegar una zona de malas condiciones meteorológicas', en un mensaje de:",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Viento en superficie, visibilidad, temperatura en tierra, pista en servicio, ajustes de altímetro, órdenes sobre rumbo y velocidad',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '11. Un mensaje relativo a un avión bajo amenaza de un peligro grave e inminente, que requiere ayuda inmediata, se denomina:',
    opciones: [
      {
  ...
  {
    titulo:
      '14. Cuando, bien por requerimiento de control, o del servicio meteorológico, o porque así lo estime la tripulación se dedica a reportar información operacional y/o meteorológica, se hará en forma de:',
    opciones: [
      {
  ...
  {
    titulo:
      '18. Si todos los intentos para establecer contacto radio con una estación de tierra fallan, el piloto de una aeronave debería transmitir los mensajes precedidos por la siguiente frase:',
    opciones: [
      {
  ...
  {
    titulo:
      '24. La hora es 09:20 AM. ¿Cuál es la forma correcta de transmitir esta hora si no hay posibilidad de confusión con la hora?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Indicativo de llamada de la aeronave, naturaleza de la emergencia, intenciones del piloto, posición actual, nivel y rumbo',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '29. ¿Cuál de las siguientes palabras o frases de procedimiento significa: "Repitame todo este mensaje, o la parte especificada del mismo, exactamente como la haya recibido"',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'a) Extremaremos las precauciones vigilando la posición de los demás tráficos antes de entrar en circuito y durante el mismo',
        isCorrect: true
      },
      {
      ...
      {
        textoRespuesta:
          'c) Podemos entrar en el aeródromo pero llegando en larga final, no podemos hacer los demás tramos del circuito',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '39. ¿Qué acción se requiere por parte de un piloto si el/ella no puede establecer contacto radio con una estación aeronáutica?',
    opciones: [
      {
  ...
  {
    titulo:
      '40. Un controlador le dice a un avión: EC-LJ6 viento 320 grados 16 nudos, autorizado a despegar en la pista 29. ¿Qué debe responder el piloto exactamente?',
    opciones: [
      {
  ...
  {
    titulo:
      '60. Por una emergencia, necesitamos entrar en el aeropuerto de Córdoba. Sabemos que la frecuencia es 118.3. Es preferible contactar con la torre en esa frecuencia, a hacerlo en la de emergencia.',
    opciones: [
      {
  ...
  {
    titulo:
      '62. ¿Cuál de las siguientes palabras o frases de procedimiento significa: "Este intercambio de transmisiones ha terminado y no se espera respuesta"?',
    opciones: [
      {
  ...
  {
    titulo:
      '63. La responsabilidad de la separación con el terreno, es responsabilidad del piloto. Esta norma tiene una excepción. Cuando el avión está siguiendo vectores radar, la responsabilidad es del controlador',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '69. ¿Cuál es el indicativo de llamada en radiotelefonía para la estación aeronáutica que presta el Servicio de información de vuelos?',
    opciones: [
      {
  ...
  {
    titulo:
      '77. Un avión no consigue establecer contacto por radio con una estación determinada de frecuencia designada. ¿Qué deberá hacer el piloto?',
    opciones: [
      {
  ...
  {
    titulo:
      '82. Al avión E­UE se le ha ordenado contactar con la torre de Córdoba en la frecuencia 118,30; ¿Cuál es la respuesta correcta para indicar que cumplirá la orden recibida?',
    opciones: [
      {
  ...
  {
    titulo:
      '88. En áreas terminales congestionadas y en las que resulte necesario un control sobre las aeronaves hasta que abandonen la zona de tráfico, la torre solicitará a los aviones volando VMC que contacten con:',
    opciones: [
      {
        textoRespuesta: 'Control de aproximación',
        isCorrect: true
  ...
  {
    titulo:
      '90. Cuál es la distancia máxima a la que usted puede esperar contacto solidó en VHF sobre terreno llano, volando a FL 050',
    opciones: [
      {
  ...
  {
    titulo:
      "96. La definición: 'Es el conjunto de fases por el que pasa una onda desde su origen hasta que vuelve a su valor inicial', corresponde a:",
    opciones: [
      {
