const preguntas = [
    ...
    {
        titulo: "2. La relación entre la distancia recorrida horizontalmente y la distancia vertical recorrida al mismo tiempo, se denomina:",
        opciones: [
            {
    ...
    {
        titulo: "8. La variación de la temperatura con la altura en la atmósfera estándar es de 2ºC por cada 1.000 ft. de altura hasta los 11 Km.",
        opciones: [
            {
    ...
    {
        titulo: "17. Cuando la diferencia de temperatura de dos masas de aire es igual o mayor a 5ºC y la velocidad del frente igual o superior a 30 nudos, se produce:",
        opciones: [
            {
    ...
    {
        titulo: "31. ¿Cuál de los ULM siguientes presenta mejores prestaciones en vuelo, siendo Vm= velocidad máxima y Vp= Velocidad de pérdida?",
        opciones: [
            {
    ...
    {
        titulo: "45. La relación que existe entre la humedad absoluta del aire y la que tendría que haber para que estuviera saturado, se denomina:",
        opciones: [
            {
    ...
    {
        titulo: "48. Cuando dos aeronaves se aproximen de frente, o casi de frente, y haya peligro de colisión, ambas aeronaves alterarán su rumbo hacia:",
        opciones: [
            {
    ...
    {
        titulo: "52. Cuando una masa de aire caliente pasa por encima de una masa de aire frío, formando nubes estratificadas, se llaman nubes de:",
        opciones: [
            {
    ...
    {
        titulo: "64. La tendencia de un avión a retornar a su condición original de vuelo, después de haber sufrido una perturbación, se denomina:",
        opciones: [
            {
    ...
    {
        titulo: "72. El elemento encargado de proporcionar la mezcla aire-combustible idónea para cada régimen de funcionamiento del motor es:",
        opciones: [
            {
    ...
    {
        titulo: "86. Si un ULM vuela con viento en cola de 10 Km/h. y su velocidad relativa es de 80 Km/h., ¿cuál será su velocidad con respecto a la Tierra?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Velocidad de pérdida, superficie alar, densidad del aire, resistencia total, peso del avión y ángulo de ataque",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "100. Durante el ascenso de un ULM, la energía cinética de velocidad proporcionada por el motor, se va transformando en energía potencial de altura:",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
