const preguntas = [
    ...
    {
        titulo: "17. De las siguientes características que puede tener una carta aeronáutica, indique cuál es la considerada como una de las más importante:",
        opciones: [
            {
    ...
    {
        titulo: "19. Un día con atmósfera estándar estamos en un campo a 13ºC. Ascendemos 2.000’. ¿Qué temperatura aproximada habrá a esa altitud?",
        opciones: [
            {
                textoRespuesta: "17ºC",
                isCorrect: false
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Cuando se producen varias explosiones a la vez dentro del cilindro que con demasiada frecuencia causa daños en el motor",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "No. Tendría que volver a pasar por todo el proceso mediante el cual consiguió la habilitación de instructor de helicópteros",
                isCorrect: false
            },
            {
                textoRespuesta: "No. Para ello debe tener la habilitación de multieje de ala fija y acreditar un mínimo de 200 horas de vuelo en ese tipo de ultraligero",
                isCorrect: true
            },
            {
    ...
    {
        titulo: "48. La velocidad de pérdida de nuestro ULM viene recogida en su Manual de Vuelo. Pero, ¿puede variar a lo largo del vuelo?",
        opciones: [
            {
    ...
    {
        titulo: "50. El aeropuerto de Barcelona tiene dos pistas 07/25 y una pista 02/20. Con un viento de 040º a 15kt, ¿qué pista debemos utilizar?",
        opciones: [
            {
    ...
    {
        titulo: "53. En un aeródromo en el que hay una humedad relativa alta y la temperatura ambiente es muy cercana a la del punto de rocío, ¿qué falta para que sea muy probable la formación de niebla?",
        opciones: [
            {
    ...
    {
        titulo: "59. “LEZL 230800Z 2309/2409 04005KT CAVOK TX24/2315Z TN07/2407Z”. ¿Cuál de las siguientes afirmaciones sobre este pronóstico es correcta?",
        opciones: [
            {
    ...
    {
        titulo: "62. Además del mínimo de horas, para obtener la licencia el alumno piloto deberá hacer un vuelo de travesía que dure al menos:",
        opciones: [
            {
    ...
    {
        titulo: "68. Si a la hora de diseñar nuestra ruta de vuelo lo hacemos tomando como referencia puntos significativos del terreno que podamos identificar fácilmente desde el aire, estaremos realizando una navegación:",
        opciones: [
            {
    ...
    {
        titulo: "79. Nuestro anemómetro marca las siguientes velocidades: Vs0 55; Vs1 65; Vfe 100; Vno 150; Vne 180. ¿A cuál de las siguientes velocidades sólo podremos volar si usamos flaps?",
        opciones: [
            {
                textoRespuesta: "59",
                isCorrect: true
    ...
    {
        titulo: "85. Si tenemos que atravesar una zona montañosa en la que el viento viene perpendicularmente a ésta, ¿cuál puede ser la mejor opción?",
        opciones: [
            {
    ...
    {
        titulo: "88. ¿Cuál de las siguientes características de un ala sirve para evitar que entre en pérdida de forma repentina en toda su superficie?",
        opciones: [
            {
    ...
    {
        titulo: "94. Si tenemos un rumbo magnético de 220º, con una desviación de 3ºE y una declinación de 5ºE, nuestro rumbo verdadero es de:",
        opciones: [
            {
                textoRespuesta: "222º",
                isCorrect: false
    ...
    {
        titulo: "97. Una capa de viento con una dirección está sobre otra capa con una dirección diferente. En la zona en la que se encuentran, ¿qué puede ocurrir?",
        opciones: [
            {
