const preguntas = [
    ...
    {
        titulo: "3. La fuerza aerodinámica se origina sobre un perfil a consecuencia de las modificaciones en la presión y velocidad de las partículas que la rodean",
        opciones: [
            {
    ...
    {
        titulo: "4. La resistencia es la fuerza generada por un objeto enfrentado al viento relativo. Para su estudio se divide en dos tipos, ¿Cuales son?",
        opciones: [
            {
    ...
    {
        titulo: "7. En el Manual de Vuelo de tu ULM, la velocidad de pérdida en que condiciones de presión, densidad y temperatura están recogidas.",
        opciones: [
            {
    ...
    {
        titulo: "24. En caso de vuelo turbulento, reduciremos nuestra velocidad a la velocidad de turbulencia especificada en el manual de vuelo del avión, la cual estará dentro del arco de color ………………….. del anemómetro.",
        opciones: [
            {
    ...
    {
        titulo: "26. Un aumento del factor de carga (N) puede llegar a romper la estructura del avión pero anteriormente a esa situación límite provoca también:",
        opciones: [
            {
    ...
    {
        titulo: "41. Un avión despega de una pista en 100 metros, a una velocidad indicada de 70 Km/h. La temperatura ambiente es de 15 grados. Con las mismas condiciones de viento, peso, en la misma pista, si la temperatura fuera de 35 grados, la carrera de despegue sería",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Se puede tirar de la palanca todo lo que queramos, siempre que nos aseguremos que volamos a más velocidad que la velocidad de pérdida",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Un dispositivo hipersustentador que rompe la circulación de la corriente aerodinámica en el extradós, mediante ranuras en el borde de ataque",
                isCorrect: false
            },
            {
                textoRespuesta: "Un dispositivo hipersustentador que rompe la circulación de la corriente aerodinámica en el extradós, mediante ranuras en el borde de salida",
                isCorrect: false
            },
            {
                textoRespuesta: "Un dispositivo hipersustentador que facilita la circulación de la corriente aerodinámica en el extradós, mediante ranuras en el borde de salida",
                isCorrect: false
            },
            {
                textoRespuesta: "Un dispositivo hipersustentador que facilita la circulación de la corriente aerodinámica en el extradós, mediante ranuras en el borde de ataque",
                isCorrect: true
            }
        ]
    },
    ...
    {
        titulo: "59. Partiendo de una vuelo recto y nivelado a velocidad constante superior a Vy, para disminuir la velocidad a Vy o superior manteniendo el vuelo recto y nivelado, debemos:",
        opciones: [
            {
    ...
    {
        titulo: "61. El centro de presiones de un avión puede variar dentro de unos límites sin que la estabilidad en profundidad del avión se vean comprometidas.",
        opciones: [
            {
                textoRespuesta: "Falso",
                isCorrect: false
    ...
    {
        titulo: "67. La velocidad de pérdida indicada en un avión que vuela contra el viento. comparada con la del mismo avión que vuela a favor:",
        opciones: [
            {
    ...
    {
        titulo: "74. Despegamos de un campo a nivel del mar, con viento calma, temperatura 10 grados, QNH 1021. Haciendo una rotación correcta, nos vamos al aire a 60 km/h (de anemómetro), después de recorrer 80 metros. Cuál será la velocidad respecto al suelo a la que nos iremos al aire",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "El C.G. es el punto donde se consideran concentradas las fuerzas pesantes del ULM y el C.P. es el punto donde actúa la fuerza aerodinámica",
                isCorrect: true
            }
        ]
    },
    ...
    {
        titulo: "86. Con un régimen de ascenso constante, es decir sin aceleración, la resultante de fuerzas de sustentación, peso, tracción y resistencia:",
        opciones: [
            {
    ...
    {
        titulo: "90. En una aproximación normal, con condiciones meteorológicas favorables, debo tener una velocidad lo suficientemente alta para no entrar en pérdida, y lo suficientemente baja para ajustar el aterrizaje sin utilizar más pista de la necesaria pero que permita hacer la recogida sin desplomarnos.",
        opciones: [
            {
