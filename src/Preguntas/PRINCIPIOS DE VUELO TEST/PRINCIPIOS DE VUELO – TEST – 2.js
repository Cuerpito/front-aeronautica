const preguntas = [
  {
    titulo:
      '1. Partiendo de una velocidad constante igual o superior a Vy en vuelo recto y nivelado, para incrementarla y mantener el vuelo recto y nivelado, debemos:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Porque para un peso dado y una configuración dada, un ángulo de ataque se corresponderá con una velocidad concreta, y viceversa',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '10. La pérdida de sustentación debida a un ángulo de ataque excesivo, se producirá siempre que el perfil sea colocado en esa posición crítica, independientemente de:',
    opciones: [
      {
  ...
  {
    titulo:
      '11. La resistencia se pinta y representa en un perfil aerodinámico en la misma dirección y sentido que el viento relativo. ¿Cuál es la correcta?',
    opciones: [
      {
  ...
  {
    titulo:
      '12. La reacción inmediata del avión al tirar de la palanca de mando al lado contrario del viraje cuando entra en pérdida es:',
    opciones: [
      {
  ...
  {
    titulo:
      '18. A la incapacidad del ala para producir la sustentación necesaria, debido a un ángulo de ataque excesivo se le denomina:',
    opciones: [
      {
  ...
  {
    titulo:
      '20. Observamos que nuestra trayectoria pasará justo pocos metros por debajo de un buitre. Lo mejor es no alterar nuestro rumbo. Así hay más posibilidades de que el animal no se percate de nuestra presencia.',
    opciones: [
      {
        textoRespuesta: 'Falso ',
        isCorrect: true
  ...
  {
    titulo:
      '31. La pérdida se produce siempre que el perfil aerodinámico sea colocado en una posición excesiva de ángulo de ataque, independientemente de la velocidad relativa.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '36. En un viraje de 90 grados de inclinación se produce el fenómeno de inversión de mandos, dirección se convierte en profundidad y profundidad en dirección.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: false
  ...
  {
    titulo:
      '48. La resistencia es la fuerza generada por un objeto paralelo al viento relativo.Para su estudio se divide en dos tipos que son:',
    opciones: [
      {
  ...
  {
    titulo:
      '55. Un avión despega de una pista en 100 metros, a una velocidad indicada de 70 Km/h. La temperatura ambiente es de 15 grados. Con las mismas condiciones de viento, peso, en la misma pista, si la temperatura fuera de 35 grados, la velocidad indicada sería:',
    opciones: [
      {
  ...
  {
    titulo:
      '58. Si, yendo a una velocidad constante con el ULM bien compensado, disminuimos la potencia progresivamente, sin tocar ningún otro mando:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'El resultado de una rotura del flujo de aire sobre las alas de un avión hasta el punto donde las alas ya no soportan el peso del avión',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '70. Estamos en aproximación final a un campo a nivel del mar. Llevamos una velocidad indicada de 80 Km/h. Cuál será la velocidad real TAS del avión',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'La sensación del piloto de que puede volar con menos potencia al tiempo que su planeo parece mejorar cerca del suelo',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '83. Cuando a una aeronave la alejamos de su posición de equilibrio y tiende a alejarse cada vez mas de ella la podemos calificar como',
    opciones: [
      {
  ...
  {
    titulo:
      '92. Si durante una aproximación, en tramo final y a velocidad correcta, notamos que no llegamos porque nos quedamos cortos:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Aplicaremos potencia para ajustarnos a la senda de planeo correcta, vigilando que la velocidad no varíe y manteniéndola con el timón de profundidad',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '98. ¿Para poder mantener un en régimen constante de descenso no acelerado, la sustentación tiene que ser necesariamente menor que el peso?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'No, si no hay aceleración las fuerzas están equilibradas. Sólo al iniciar el descenso es necesario que la sustentación sea menor que el peso. Una vez en régimen de descenso a velocidad constante, las resultantes de sustentación se igualan a las de peso manteniendo un equilibrio de fuerzas',
        isCorrect: true
      },
      {
        textoRespuesta:
          'La sustentación y el peso no están directamente relacionados con el régimen de descenso, sólo la incidencia del ala y el ángulo de ataque',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '100. El factor de carga aumenta excesivamente, para la capacidad de maniobra de los ultraligeros, a partir de ángulos de inclinación en viraje de:',
    opciones: [
      {
        textoRespuesta: '90º',
        isCorrect: false
