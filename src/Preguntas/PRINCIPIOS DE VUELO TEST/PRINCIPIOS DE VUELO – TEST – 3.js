const preguntas = [
    ...
    {
        titulo: "2. Un centro de gravedad muy adelantado, excediendo los límites especificados por el fabricante para la carga y centrado, ¿es muy peligroso?:",
        opciones: [
            {
            ...
            {
                textoRespuesta: "d) No, mientras más adelantado se encuentre más estable será el avión. Sólo perderá prestaciones como velocidad punta por ejemplo, pero eso no hace peligroso volarlo",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "14. El factor de carga se define como la relación que existe entre la fuerza total sobre el avión y la resistencia inducida",
        opciones: [
            {
                textoRespuesta: "Falso",
                isCorrect: true
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Que para incrementar la velocidad de un avión en vuelo recto y nivelado, tenemos que aplicar potencia exclusivamente",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "35. Despegamos de un campo a nivel del mar, con viento calma, temperatura 10 grados, QNH 1021. Haciendo una rotación correcta, nos vamos al aire a 60 km/h (de anemómetro), después de recorrer 80 metros. Cual será la TAS a la que nos vamos al aire",
        opciones: [
            {
    ...
    {
        titulo: "36. Una definición del ángulo de ataque, podrá ser: es el ángulo formado por la trayectoria de vuelo y la cuerda aerodinámica",
        opciones: [
            {
                textoRespuesta: "Falso",
                isCorrect: false
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "La relación es fija mientras no se varíe la configuración del avión con el uso de superficies hipersustentadoras",
                isCorrect: true
            },
            {
    ...
    {
        titulo: "38. ¿Cómo se llama la capacidad del avión para recuperar una posición determinada, cuando ha sufrido una perturbación en cabeceo?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Quitaremos potencia para descender, y ajustaremos una posición en el timón de profundidad para establecer una velocidad concreta",
                isCorrect: true
            },
            {
    ...
    {
        titulo: "41. Las superficies aerodinámicas destinadas a provocar el desplazamiento controlado del avión sobre los tres ejes de referencia, se denominan:",
        opciones: [
            {
    ...
    {
        titulo: "44. ¿Por qué entra en pérdida una avión a mayor velocidad en virajes coordinados y a nivel, que en vuelo recto y nivelado?",
        opciones: [
            {
                textoRespuesta: "Porque al incrementarse el factor de carga, necesitamos más ángulo de ataque para disminuir la sustentación a una misma velocidad",
                isCorrect: true
            },
            {
                textoRespuesta: "Porque al disminuir el factor de carga, necesitamos más ángulo de ataque para mantener la sustentación a una misma velocidad",
                isCorrect: false
            },
            {
                textoRespuesta: "Porque al incrementarse el factor de carga, necesitamos más ángulo de ataque para mantener la sustentación a una misma velocidad",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "65. Cuando accionamos la palanca de mandos hacia atrás, actuamos sobre el timón de profundidad y el avión sube. Pero, ¿en qué posición colocamos dicho timón?",
        opciones: [
            {
    ...
    {
        titulo: "66. El aumento del factor de carga (N) puede llegar a romper la estructura del avión, pero anteriormente a esta situación límite provoca también:",
        opciones: [
            {
    ...
    {
        titulo: "68. ¿Cómo se llaman las resistencias que origina un avión al desplazarse en el aire y que no tiene que ver con la generación de sustentación?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Altitud es la medida que proporciona el instrumento del avión volando y altura la que proporciona el mismo instrumento cuando el avión está en tierra en distintos campos.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "76. La resistencia que producen algunas partes del avión que no están directamente relacionadas con la sustentación, se denomina:",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Es la fuerza que se origina sobre un perfil a consecuencia de la resultante entre la gravedad y la fuerza centripeta",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "81. ¿Qué puede ocurrir si actuamos bruscamente sobre el mando de profundidad del avión durante la recuperación de una pérdida, al tratar de nivelar nuestra posición?",
        opciones: [
            {
    ...
    {
        titulo: "86. Cuando a un perfil alar inmerso en una corriente de aire se le aplica un ángulo de ataque positivo, la presión en el extradós ….. Y el el intradós …….",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "No es posible mantener una velocidad constante con un régimen de ascenso constante, ya que eso sólo se puede conseguir en vuelo recto y nivelado",
                isCorrect: false
            },
            {
                textoRespuesta: "Manteniendo la velocidad con la palanca o volante (timón de profundidad) mientras ajusto una potencia adecuada que mantenga el régimen de ascenso constante",
                isCorrect: false
            },
            {
                textoRespuesta: "Aplicando gases para mantener la velocidad y ajustando el timón de profundidad para obtener un régimen de ascenso constante",
                isCorrect: false
            },
            {
                textoRespuesta: "Manteniendo la velocidad con la palanca o volante (timón de dirección) mientras ajusto una potencia adecuada que mantenga el régimen de ascenso constante",
                isCorrect: true
            }
        ]
    },
    ...
    {
        titulo: "95. Estamos en aproximación final a un campo a nivel del mar. El viento es calma. Llevamos una velocidad indicada de 80 Km/h. Cuál será la velocidad sobre el suelo GS",
        opciones: [
            {
    ...
    {
        titulo: "96. ¿Cuál de los U.L.M. que a continuación se describen mediante sus factores de carga límite, será más resistente estructuralmente?",
        opciones: [
            {
