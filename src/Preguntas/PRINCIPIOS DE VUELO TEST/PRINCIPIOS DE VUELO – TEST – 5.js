const preguntas = [
  ...
  {
    titulo:
      '5. La línea de referencia que se utiliza como punto de partida para las mediciones de peso y centrado de la aeronave se llama:',
    opciones: [
      {
  ...
  {
    titulo:
      '12. Si durante el vuelo notamos que el sonido que produce nuestra aeronave en el aire cambia repentinamente, puede significar que:',
    opciones: [
      {
  ...
  {
    titulo:
      '36. Si aumentamos nuestro ángulo de ataque pero queremos mantener la misma sustentación, ¿sobre qué factor o elemento deberemos actuar?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Una aeronave inestable permanece en la nueva posición después de haber sido separado de su posición de equilibrio',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'El efecto Venturi (las partículas sometidas a un estrechamiento aumentan su velocidad y disminuyen su presión)',
        isCorrect: true
      },
      {
        textoRespuesta:
          'El efecto Bernoulli (las partículas sometidas a un estrechamiento aumentan su velocidad y disminuyen su presión)',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '57. Si para evitar obstáculos, antes del aterrizaje nuestra senda de planeo debe ser más pronunciada, ¿cuál de los siguientes elementos usaríamos?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Mantener el avión en una posición determinada y aliviar al piloto del esfuerzo por el constante control de los mandos',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Una diferencia entre la sustentación de las alas y del estabilizador horizontal de cola, lo que provoca el cabeceo',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Una diferencia en el peso de las alas y el estabilizador horizontal de cola, lo que hace que se produzca el cabeceo',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '68. La estabilidad longitudinal depende de la capacidad del avión de recuperar una posición determinada después de sufrir una perturbación en:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Los resultados de someter a un avión a factores de carga altos son acumulativos, por lo que los fallos pueden aparecer posteriormente',
        isCorrect: true
      },
      {
        textoRespuesta:
          'El factor de carga aumenta considerablemente en virajes a partir de 60º. En grados inferiores es casi inapreciable',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '95. Nuestra aeronave tiene una velocidad de pérdida de 70 millas en situación normal. ¿Cuál será aproximadamente la velocidad de pérdida si lo sometemos a 2G?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Es la orientación de los ejes de la aeronave con respecto al horizonte y se actúa sobre ella sólo con los mandos primarios',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Es la orientación de los ejes de la aeronave con respecto al horizonte y se actúa sobre ella con los controles o mandos de vuelo',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Es la orientación de los ejes de la aeronave con respecto al horizonte y se actúa sobre ella sólo con los mandos secundarios',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '100. Un incremento del factor de carga debido a un viraje, una turbulencia, etc., tendría el mismo efecto que aumentar el peso de la aeronave:',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
