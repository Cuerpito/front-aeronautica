const preguntas = [
  ...
  {
    titulo:
      '2. Estamos en aproximación final a un campo a nivel del mar. El viento es calma. Llevamos una velocidad indicada de 80 Km/h. Cuál será la velocidad sobre el suelo GS',
    opciones: [
      {
  ...
  {
    titulo:
      '11. La pérdida se produce siempre que el perfil aerodinámico sea colocado en una posición excesiva de ángulo de ataque, independiente de la velocidad del avión',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Se curva el perfil alar, aumentando la cuerda aerodinámica, disminuyendo el ángulo de ataque y obteniendo sustentación adicional',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Se curva el perfil alar, disminuyendo la cuerda aerodinámica y el ángulo de ataque, obteniendo sustentación adicional',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Se curva el perfil alar, aumentando la cuerda aerodinámica y el ángulo de ataque, obteniendo un coeficiente de sustentación mayor',
        isCorrect: true
      },
      {
        textoRespuesta: 'Ninguna de las anteriores',
  ...
  {
    titulo:
      '18. Si el centro de gravedad se encuentra por delante del centro de presiones, el avión será ______________ y si se encuentra detrás del C.P. _________________. ELEGIR LA RESPUESTA QUE COMPLETE LOS ESPACIOS EN BLANCO EN EL ORDEN ADECUADO.',
    opciones: [
      {
  ...
  {
    titulo:
      '23. Despegamos de un campo a nivel del mar, con viento calma, temperatura 10 grados, QNH 1021. Haciendo una rotación correcta, nos vamos al aire a 60 km/h (de anemómetro), después de recorrer 80 metros. ¿Cuál será la velocidad respecto al suelo a la que nos iremos al aire?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Centrar mandos, ganar velocidad, tirar de palanca virando para acercar el morro al horizonte y entonces alabear para conseguir posición de vuelo recto y nivelado',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Cortar motor, palanca de mando CENTRADA , ganar velocidad, alabear hasta tener las alas paralelas al horizonte y tirar de palanca y aplicar potencia para conseguir posición de vuelo recto y nivelado',
        isCorrect: true
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Es la fuerza que se origina sobre un perfil a consecuencia de la resultante entre la gravedad y la fuerza centrifuga',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '56. El efecto venturi establece que las partículas de un fluido al pasar por un estrechamiento aumentan de velocidad y disminuye en',
    opciones: [
      {
