const preguntas = [
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "A la incapacidad del ala para producir la sustentación necesaria, debido a un ángulo de ataque excesivo o a una baja velocidad.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Son dispositivos hipersustentadores que modifican los torbellinos generados por la sustentación y reducen la resistencia inducida.",
                isCorrect: false
            },
            {
                textoRespuesta: "Son dispositivos de punta alar que modifican los torbellinos generados por la sustentación y reducen la resistencia inducida.",
                isCorrect: true
            },
            {
                textoRespuesta: "Son dispositivos de punta alar que modifican los torbellinos generados por la sustentación y aumentan la resistencia inducida.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Su capacidad para responder a los mandos primarios de vuelo y la resistencia que presenta a éstos en el desplazamiento.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Su capacidad para corregir las condiciones que alteren su equilibrio y recobrar la posición de vuelo original.",
                isCorrect: true
            },
            {
                textoRespuesta: "Su capacidad para permanecer en vuelo recto y nivelado sin que las perturbaciones que pueda sufrir lo desplacen de su posición original.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Las alas pueden comportarse con diferentes ángulos de ataque y coeficientes de sustentación, por lo que el morro tenderá a caer más de un lado que de otro.",
                isCorrect: false
            },
            {
                textoRespuesta: "Las alas pueden comportarse con mismos ángulos de ataque y coeficientes de sustentación, por lo que se puede producir una barrena.",
                isCorrect: false
            },
            {
                textoRespuesta: "Las alas pueden comportarse con diferentes ángulos de ataque y coeficientes de sustentación, por lo que se puede producir una barrena.",
                isCorrect: true
            },
            {
                textoRespuesta: "Las alas pueden comportarse con el mismo ángulo de ataque pero con diferentes coeficientes de sustentación, por lo que se puede producir una barrena.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "La capa comprendida entre la inmediata superficie del cuerpo en la que la velocidad del fluido es cero, y el lugar externo a la superficie donde el flujo deja de encontrarse frenado y asume la velocidad de la corriente de aire.",
                isCorrect: true
            },
            {
                textoRespuesta: "La capa que se encuentra en la inmediata superficie del cuerpo, adherida a éste, y en la que la velocidad del fluido es cero.",
                isCorrect: false
            },
            {
                textoRespuesta: "La capa comprendida entre la inmediata superficie del cuerpo en la que la velocidad del fluido es cero, y el lugar externo a la superficie donde el flujo comienza a tener cierta velocidad.",
                isCorrect: false
            },
            {
                textoRespuesta: "La capa comprendida entre la superficie del cuerpo, en la que el flujo ya no se encuentra adherido a éste pero su velocidad es cero, y el lugar externo a la superficie donde el flujo deja de encontrarse frenado y asume la velocidad de la corriente de aire.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Es el ángulo que se forma entre el 25% de la cuerda y la perpendicular al eje longitudinal de la aeronave, y se utiliza para proporcionarle estabilidad lateral.",
                isCorrect: false
            },
            {
                textoRespuesta: "El ángulo formado por el plano de las alas con el plano horizontal de la aeronave, y se utiliza para proporcionarle estabilidad longitudinal.",
                isCorrect: false
            },
            {
                textoRespuesta: "El ángulo formado por el plano de las alas con el plano vertical de la aeronave, y se utiliza para proporcionarle estabilidad lateral.",
                isCorrect: false
            },
            {
                textoRespuesta: "El ángulo formado por el plano de las alas con el plano horizontal de la aeronave, y se utiliza para proporcionarle estabilidad lateral.",
                isCorrect: true
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Son dispositivos hipersustentadores que se despliegan sobre las alas, rompen la corriente de aire, generan más resistencia y disminuyen la sustentación.",
                isCorrect: false
            },
            {
                textoRespuesta: "Son frenos aerodinámicos que se despliegan sobre las alas, rompen la corriente de aire, generan más resistencia y disminuyen la sustentación.",
                isCorrect: true
            },
            {
                textoRespuesta: "Son frenos aerodinámicos que se despliegan sobre el fuselaje, rompen la corriente de aire, generan más resistencia y disminuyen la sustentación.",
                isCorrect: false
            },
            {
                textoRespuesta: "Son mandos primarios que se despliegan sobre las alas, rompen la corriente de aire, generan más resistencia y disminuyen la sustentación.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Tenemos un factor de carga negativo que suele ser de 2 a 2’5g, apareciendo pérdidas secundarias si se superan estos valores",
                isCorrect: false
            },
            {
                textoRespuesta: "Tenemos un factor de carga positivo que suele ser de 2 a 2’5g, apareciendo pérdidas secundarias si se superan estos valores.",
                isCorrect: true
            },
            {
                textoRespuesta: "Tenemos un factor de carga positivo que suele ser de 2 a 2’5g, apareciendo daños estructurales en la aeronave si se superan estos valores.",
                isCorrect: false
            },
            {
                textoRespuesta: "Tenemos un factor de carga negativo que suele ser de 2 a 2’5g, apareciendo daños estructurales en la aeronave si se superan estos valores.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Es una fuerza aerodinámica perpendicular a la trayectoria de vuelo y que se da en el mismo sentido que el peso de la aeronave.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Siempre que tengamos un ángulo de ataque excesivo y la velocidad no sea suficiente para mantener la sustentación.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "La masa gaseosa que rodea la Tierra, dividida en capas con temperaturas similares que se distribuyen desde la superficie de ésta hasta el espacio exterior.",
                isCorrect: false
            },
            {
                textoRespuesta: "La masa gaseosa que rodea la Tierra, dividida en capas con diferentes temperaturas que se distribuyen desde la superficie de ésta hasta el espacio exterior.",
                isCorrect: true
            },
            {
                textoRespuesta: "La masa sólida que rodea la Tierra, dividida en capas con diferentes temperaturas que se distribuyen desde la superficie de ésta hasta el espacio exterior.",
                isCorrect: false
            },
            {
                textoRespuesta: "La masa gaseosa que rodea la Tierra, dividida en capas con diferentes temperaturas que se distribuyen desde aproximadamente 11 km por encima de la superficie de ésta hasta el espacio exterior.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "24. La presión, la densidad y la temperatura se ven afectadas mutuamente. ¿Cuál de las siguientes afirmaciones con respecto a su comportamiento es correcta?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Permiten producir mayor sustentación a menor velocidad pero también generan resistencia, por lo que será necesaria mayor potencia de motor.",
                isCorrect: true
            },
            {
                textoRespuesta: "Permiten producir mayor sustentación a mayor velocidad pero también generan resistencia, por lo que será necesaria mayor potencia de motor.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Permiten producir menor sustentación a mayor velocidad pero también generan resistencia, por lo que será necesaria mayor potencia de motor.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Superficies aerodinámicas que permiten mantener el avión en una posición determinada aliviando al piloto del esfuerzo continuo sobre los mandos de control secundarios.",
                isCorrect: false
            },
            {
                textoRespuesta: "Superficies aerodinámicas que permiten mantener el avión en una posición determinada aliviando al piloto del esfuerzo continuo sobre los mandos de control primarios.",
                isCorrect: true
            },
            {
                textoRespuesta: "Superficies aerodinámicas que permiten realizar movimientos sobre los mandos de control primarios aliviando al piloto del esfuerzo que esto requiere.",
                isCorrect: false
            },
            {
                textoRespuesta: "Superficies aerodinámicas que permiten realizar movimientos sobre los mandos de control primarios y secundarios aliviando al piloto del esfuerzo que esto requiere.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Mandos de control primarios que permiten que una aeronave produzca sustentación a unas velocidades menores a las normales.",
                isCorrect: false
            },
            {
                textoRespuesta: "Mandos de control secundarios que permiten que una aeronave produzca sustentación a unas velocidades mayores a las normales.",
                isCorrect: false
            },
            {
                textoRespuesta: "Mandos de control secundarios que permiten que una aeronave produzca mayor sustentación a cualquier velocidad.",
                isCorrect: false
            },
            {
                textoRespuesta: "Mandos de control secundarios que permiten que una aeronave produzca sustentación a unas velocidades menores a las normales.",
                isCorrect: true
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "La relación que existe entre la fuerza de aceleración y la fuerza de gravedad a las que se ve sometida la aeronave.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Para que la densidad disminuya, basta con que disminuya la presión, con temperatura constante, o que aumente la temperatura, con presión constante.",
                isCorrect: true
            },
            {
                textoRespuesta: "Para que la densidad disminuya, basta con que aumente la presión, con temperatura constante, o que disminuya la temperatura, con presión constante.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "En primer lugar se sitúa el avión en la posición deseada mediante los controles secundarios y después se usa los compensadores para aliviar el esfuerzo del piloto sobre ellos.",
                isCorrect: false
            },
            {
                textoRespuesta: "En primer lugar se sitúa el avión en la posición deseada mediante los controles primarios y secundarios y después se usa los compensadores para aliviar el esfuerzo del piloto sobre ellos.",
                isCorrect: false
            },
            {
                textoRespuesta: "En primer lugar se sitúa el avión en la posición deseada mediante los controles primarios y después se usa los compensadores para aliviar el esfuerzo del piloto sobre ellos.",
                isCorrect: true
            },
            {
                textoRespuesta: "A la vez que se va situando el avión en la posición deseada mediante los controles primarios, se van adaptando los compensadores, hasta que alcance la posición que queremos y el piloto se verá aliviado del esfuerzo.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "De que estamos entrando en zona de turbulencias, por lo que el piloto debe reducir su velocidad a la de turbulencia.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "De que estamos cercanos a la pérdida, por lo que el piloto debe disminuir el ángulo de ataque y aumentar la potencia.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "El timón de profundidad para el eje longitudinal; el timón de dirección para el eje lateral; y los alerones para el eje vertical.",
                isCorrect: false
            },
            {
                textoRespuesta: "El timón de profundidad para el eje longitudinal; el timón de dirección para el eje vertical; y los alerones para el eje lateral.",
                isCorrect: false
            },
            {
                textoRespuesta: "El timón de profundidad para el eje lateral; el timón de dirección para el eje vertical; y los alerones para el eje longitudinal.",
                isCorrect: true
            },
            {
                textoRespuesta: "El timón de profundidad para el eje lateral; el timón de dirección para el eje longitudinal; y los alerones para el eje vertical.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "El eje longitudinal, que genera el alabeo; el eje lateral, que genera el cabeceo; y el eje vertical, que genera el picado o el encabritado.",
                isCorrect: false
            },
            {
                textoRespuesta: "El eje transversal, que genera el alabeo; el eje lateral, que genera el cabeceo; y el eje vertical, que genera la guiñada",
                isCorrect: false
            },
            {
                textoRespuesta: "El eje longitudinal, que genera el alabeo; el eje lateral, que genera el cabeceo; y el eje vertical, que genera la guiñada.",
                isCorrect: true
            },
            {
                textoRespuesta: "El eje longitudinal, que genera el cabeceo; el eje lateral, que genera el alabeo; y el eje vertical, que genera la guiñada.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Se produce solo durante los aterrizajes, cuando la resistencia inducida es menor cuanto más cerca está el ala del suelo.",
                isCorrect: false
            },
            {
                textoRespuesta: "Se produce durante los aterrizajes y los despegues, cuando la resistencia inducida es menor cuanto más cerca está el ala del suelo.",
                isCorrect: true
            },
            {
                textoRespuesta: "Se produce durante los aterrizajes y los despegues, cuando la resistencia inducida es mayor cuanto más cerca está el ala del suelo.",
                isCorrect: false
            },
            {
                textoRespuesta: "Se produce solo durante los aterrizajes, cuando la sustentación es menor cuanto más cerca está el ala del suelo.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "La dirección seguida por el perfil aerodinámico durante su desplazamiento por el aire, en el mismo sentido que el viento relativo.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Línea que une los puntos equidistantes entre el extradós y el intradós entre el borde de ataque y el de salida.",
                isCorrect: true
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "El punto imaginario en el que se concentra toda la masa del avión y por el que se cruzan los tres ejes de giro.",
                isCorrect: true
            },
            {
                textoRespuesta: "El punto imaginario en el que se concentra toda la masa del avión y en el que se aplica la fuerza de sustentación.",
                isCorrect: false
            },
            {
                textoRespuesta: "El punto imaginario en el que se concentra toda la masa del avión, por el que se cruzan los tres ejes de giro y que no es posible modificar.",
                isCorrect: false
            },
            {
                textoRespuesta: "El punto imaginario en el que se cruzan los tres ejes de giro y en el que se aplica la fuerza de sustentación.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "La tracción debe ser mayor que la resistencia, y el avión ganará velocidad hasta que estas dos fuerzas opuestas se igualen.",
                isCorrect: true
            },
            {
                textoRespuesta: "La tracción debe ser mayor que la resistencia, y el avión ganará velocidad hasta que reduzcamos la fuerza de tracción.",
                isCorrect: false
            },
            {
                textoRespuesta: "La tracción debe ser mayor que la resistencia, y el avión ganará velocidad hasta que la resistencia sea mayor que la tracción.",
                isCorrect: false
            },
            {
                textoRespuesta: "La tracción debe ser menor que la resistencia, y el avión generará velocidad hasta que estas dos fuerzas opuestas se igualen.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Un aumento de la sustentación y una disminución de la resistencia inducida cuando la aeronave está cerca del suelo, ya sea tierra o agua.",
                isCorrect: true
            },
            {
                textoRespuesta: "Un aumento de la sustentación y una disminución de la resistencia inducida cuando la aeronave está cerca del suelo en tierra, ya que en agua no se produce.",
                isCorrect: false
            },
            {
                textoRespuesta: "Un aumento de la sustentación y de la resistencia inducida cuando la aeronave está cerca del suelo, ya sea en tierra o agua.",
                isCorrect: false
            },
            {
                textoRespuesta: "Un aumento de la sustentación y una disminución de la resistencia parásita cuando la aeronave está cerca del suelo, ya sea en tierra o en agua.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Un efecto Bernoulli por el que las partículas de aire del extradós aumentan su velocidad, por lo que si aplicamos el efecto Venturi, disminuyen su presión",
                isCorrect: false
            },
            {
                textoRespuesta: "Un efecto Venturi por el que las partículas de aire del extradós disminuyen su velocidad, por lo que si aplicamos el efecto Bernoulli, aumentan su presión.",
                isCorrect: false
            },
            {
                textoRespuesta: "Un efecto Venturi por el que las partículas de aire del extradós aumentan su velocidad, por lo que si aplicamos el efecto Bernoulli, disminuyen su presión.",
                isCorrect: true
            },
            {
                textoRespuesta: "Un efecto Venturi por el que las partículas de aire del extradós aumentan su velocidad, por lo que si aplicamos el efecto Bernoulli, también aumentan su presión.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Coincidirán cuando la presión y la temperatura sean las de la atmósfera estándar, es decir, 1.013 milibares y 15ºC a nivel del mar.",
                isCorrect: true
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "El ángulo, que puede ser positivo, negativo o neutro, que forma el plano del ala con el plano horizontal de la aeronave.",
                isCorrect: true
            },
            {
                textoRespuesta: "El ángulo, que puede ser positivo o negativo, que forma el plano del ala con el plano horizontal de la aeronave.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Para un mismo ángulo de ataque aumenta la velocidad y para una misma velocidad disminuye el empuje necesario.",
                isCorrect: false
            },
            {
                textoRespuesta: "Para un mismo ángulo de ataque aumenta la sustentación y para una misma velocidad aumenta el empuje necesario.",
                isCorrect: false
            },
            {
                textoRespuesta: "Para un mismo ángulo de ataque aumenta el empuje necesario y para una misma velocidad aumenta la sustentación.",
                isCorrect: false
            },
            {
                textoRespuesta: "Para un mismo ángulo de ataque aumenta la sustentación y para una misma velocidad disminuye el empuje necesario.",
                isCorrect: true
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Disminuye el espesor de la capa límite, que tras pasar por el punto de transición se convierte en turbulenta.",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "68. El mayor peligro de una pérdida es que se produzca a poca altura, pues es posible que no dé tiempo a recuperarla. Sin embargo, en condiciones normales su recuperación es relativamente sencilla. ¿Cómo se lleva a cabo?",
        opciones: [
            {
                textoRespuesta: "Lo primero que hay que hacer es aplicar motor, luego bajar el morro y una vez que tengamos la velocidad suficiente, recuperamos la altura perdida.",
                isCorrect: false
            },
            {
                textoRespuesta: "Lo primero que hay que hacer es bajar el morro, luego aplicar motor y una vez tengamos la velocidad suficiente, recuperamos la altura perdida.",
                isCorrect: true
            },
            {
                textoRespuesta: "Lo primero que hay que hacer es subir el morro, luego aplicar motor y una vez que tengamos la velocidad suficiente, recuperamos la altura perdida.",
                isCorrect: false
            },
            {
                textoRespuesta: "Lo primero que hay que hacer es bajar el morro, luego disminuir la potencia y una vez que tengamos velocidad suficiente, recuperamos la altura perdida.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Es el ángulo que se forma entre cualquier punto de la cuerda y la perpendicular al eje longitudinal de la aeronave.",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "74. ¿Cuál es el principio de funcionamiento por el que las superficies primarias de control de vuelo provocan movimientos a través de los tres ejes de giro de la aeronave?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Llevar el control de la aeronave durante el vuelo mediante el movimiento de sus dos o tres ejes de giro y controlar los dispositivos hipersustentadores.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Llevar el control de la aeronave durante el vuelo mediante el movimiento de sus dos o tres ejes de giro, controlar los dispositivos hipersustentadores y también los compensadores de vuelo.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "78. Dos aeronaves, una con más peso que otra, que realizan un viraje con el mismo grado de inclinación y de forma coordinada a nivel constante:",
        opciones: [
            {
                textoRespuesta: "La que realice el viraje a mayor velocidad tendrá un factor de carga mayor, independientemente del peso de cada una.",
                isCorrect: false
            },
            {
                textoRespuesta: "La de mayor peso se verá sometida a un factor de carga mayor y viceversa, independientemente de la velocidad.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Normalmente será menor en aterrizajes que en despegues, excepto cuando en despegues tengamos viento cruzado o racheado.",
                isCorrect: false
            },
            {
                textoRespuesta: "Normalmente será mayor en aterrizajes que en despegues, excepto cuando en aterrizajes tengamos viento cruzado o racheado.",
                isCorrect: true
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Densidad y presión del aire, velocidad, temperatura, superficie del coeficiente aerodinámico y ángulo de ataque.",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "85. Para evitar perder la mayor altura posible, es importante reconocer los síntomas de la pérdida cuanto antes. ¿Cuáles pueden ser esos síntomas?",
        opciones: [
            {
                textoRespuesta: "Una posición anormal de la aeronave, una disminución del sonido del flujo de aire sobre la aeronave y una disminución de la resistencia al movimiento de la palanca son algunos de los síntomas.",
                isCorrect: true
            },
            {
                textoRespuesta: "Una posición anormal de la aeronave, un aumento del sonido del flujo de aire sobre la aeronave y un incremento de la resistencia al movimiento de la palanca son algunos de los síntomas.",
                isCorrect: false
            },
            {
                textoRespuesta: "Una posición anormal de la aeronave, un aumento del sonido del flujo de aire sobre la aeronave y una disminución de la resistencia al movimiento de la palanca son algunos de los síntomas.",
                isCorrect: false
            },
            {
                textoRespuesta: "Una posición normal de la aeronave, una disminución del sonido del flujo de aire sobre la aeronave y un incremento de la resistencia al movimiento de la palanca son algunos de los síntomas.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "86. El factor de carga aumenta durante las turbulencias debido a las ráfagas de aire. ¿Sufrirá daños estructurales nuestra aeronave si volamos por una zona de turbulencias?",
        opciones: [
            {
                textoRespuesta: "No, pues el avión está diseñado para que las turbulencias no afecten a su estructura aun cuando vuela a la máxima velocidad estructural.",
                isCorrect: false
            },
            {
                textoRespuesta: "Sí. Las zonas de turbulencias son muy peligrosas para la estructura de la aeronave, por eso hay que intentar evitarlas en todo momento.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "La resistencia parásita, que empieza a generarse en el momento en que la primera rueda del tren de aterrizaje se levanta de la pista.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "La resistencia inducida, que empieza a generarse en el momento en que la primera rueda del tren de aterrizaje se levanta de la pista.",
                isCorrect: true
            }
        ]
    },
    {
        titulo: "91. El factor de carga en un viraje coordinado, a nivel constante, es el resultado de las fuerzas centrífuga y de gravedad. Podemos afirmar que:",
        opciones: [
            {
            ...
            {
                textoRespuesta: "Este factor de carga aumenta significativamente desde el momento en que iniciamos el viraje y se duplica a los 60º.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Este factor de carga aumenta significativamente desde el momento en que iniciamos el viraje y se duplica a los 45º.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "El punto imaginario en el cual se encuentra concentrada toda la masa del avión y que tiene unos límites de desplazamiento.",
                isCorrect: false
            },
            {
                textoRespuesta: "El punto de aplicación de la fuerza de sustentación, que se mide en % de la curvatura media y tiene unos límites de desplazamiento.",
                isCorrect: false
            },
            {
                textoRespuesta: "El punto de aplicación de la fuerza de sustentación, que se mide en grados de la cuerda aerodinámica y es fijo.",
                isCorrect: false
            },
            {
                textoRespuesta: "El punto de aplicación de la fuerza de sustentación, que se mide en % de la cuerda aerodinámica y tiene unos límites de desplazamiento.",
                isCorrect: true
            }
        ]
    },
    ...
    {
        titulo: "94. En vuelo recto y nivelado, las cuatro fuerzas que actúan sobre la aeronave están en equilibrio. ¿Qué ocurre si aumentamos una de ellas, como por ejemplo la tracción?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "La aeronave se acelera hasta que la resistencia compensa el aumento de tracción, y vuelve al vuelo recto y nivelado con la velocidad anterior.",
                isCorrect: false
            },
            {
                textoRespuesta: "La aeronave se acelera hasta que la resistencia compensa el aumento de tracción, y vuelve al vuelo recto y nivelado a una velocidad menor que la anterior.",
                isCorrect: false
            },
            {
                textoRespuesta: "La aeronave se acelera hasta que la resistencia compensa el aumento de tracción, y vuelve al vuelo recto y nivelado a una velocidad mayor que la anterior.",
                isCorrect: true
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Se mantiene prácticamente constante en toda la zona en la que es laminar, aumentando cuando se vuelve turbulenta.",
                isCorrect: false
            },
            {
