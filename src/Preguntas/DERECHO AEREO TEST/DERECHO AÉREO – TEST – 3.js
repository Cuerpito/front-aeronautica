const preguntas = [
  ...
  {
    titulo:
      '9. Un espacio aéreo de dimensiones definidas en el cual pueden desplegarse en determinados momentos actividades peligrosas para el vuelo de las aeronaves',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Comunicar inmediatamente, y por el medio más rápido a la Subdirección General de Seguridad en Vuelo de la Agencia Estatal de Seguridad Aérea',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '20. En vuelo VFR no se despegará, ni se aterrizará en un aeródromo dentro de una zona de tránsito de aeródromo, como norma general si:',
    opciones: [
      {
  ...
  {
    titulo:
      '25. ¿Si llegando en vuelo a un Aeródromo no controlado antes de aterrizar aparece un individuo agitando una bandera roja significa que?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Poseer la licencia de piloto de ultraligero, con al menos una habilitación en vigor, y superar una prueba teórica y otra práctica realizada por AESA',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '43. Estoy volando bajo el Área 1 del TMA de Sevilla, cuyo límite inferior es 300 m. AGL/AMSL, en mi trayectoria tengo un terreno con una elevación de 1500 pies ¿puedo continuar el vuelo sin entrar en el TMA?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Tener en su cartilla de vuelos la certificación expedida por el jefe de vuelos de haber realizado mas de 300 horas de vuelo',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Superar las pruebas teóricas y prácticas del curso de instructor de ultraligero ante un examinador designado por la Agencia Estatal de Seguridad Aérea.',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '50. Ultraligeros motorizados serán aquellas aeronaves aptas para el vuelo tripulado, cuyo peso máximo al despegue sea inferior a:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Espacio aéreo de dimensiones definidas dentro del territorio de un estado, en el cual esta regulado el vuelo de las aeronaves',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Espacio aéreo de dimensiones definidas sobre territorio o aguas jurisdiccionales de un estado, dentro del cual esta restringido el vuelo de las aeronaves de acuerdo con determinadas condiciones especificas',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '55. Nuestro acompañante se empieza a sentir mal. Puede ser algo grave. Ya tenemos controlado el avión. Estamos a 5 min del aeropuerto de Sevilla, y a 20 del campo de vuelo de Aerohispalis. Aun siendo ULM, podemos tomar la decisión de proceder al aeropuerto, si consideramos que lo situación lo requiere.',
    opciones: [
      {
        textoRespuesta: 'Falso ',
        isCorrect: false
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Acreditar un mínimo de 200 horas de vuelo en el tipo de ULM que quiere instruir y poseer dicha habilitación en vigor',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '62. Se consideran alas de vuelo libre aquellas aeronaves ultraligeras aptas para el vuelo tripulado, cuyo peso no exceda de:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Una región de control cuyo límite inferior comienza a una determinada altura sobre el terreno, dejando libre un espacio por debajo',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Una zona de control en torno a un aeropuerto o aeródromo controlado, cuyo límite inferior está en la superficie',
        isCorrect: true
      }
    ]
  },
  {
    titulo:
      '64. Durante el vuelo el piloto al mando de la aeronave tendrá plena autoridad decisiva en todo lo relacionado con ella mientras:',
    opciones: [
      {
  ...
  {
    titulo:
      '74. No se hará ningún lanzamiento ni rociado desde la aeronave en vuelo, salvo en las condiciones prescritas por la Autoridad competente…',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '75. En el caso de accidente de un ULM el jefe de vuelos lo comunicará inmediatamente y por el medio más rápido posible, a:',
    opciones: [
      {
  ...
  {
    titulo:
      '78. El documento expedido por la Agencia Estatal de Seguridad Aérea que faculta a su poseedor para actuar como piloto al mando es:',
    opciones: [
      {
  ...
  {
    titulo:
      '80. Para indicar a una aeronave no autorizada que está volando o esta a punto de entrar en una zona R, P, D. se le indicará mediante:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Proyectiles que al explotar produzcan luces o estrellas verdes y rojas, disparadas a intervalos de 10 segundos',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Proyectiles que al explotar produzcan luces o estrellas verdes y rojas, disparadas a intervalos de 5 segundos',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '84. ¿Cuál es la altura mínima a la que un ULM debe sobrevolar una aglomeración de gente para poder hacer publicidad aérea?',
    opciones: [
      {
        textoRespuesta: '300 metros',
        isCorrect: false
  ...
  {
    titulo:
      '85. Según la orden ministerial de 14 de noviembre de 1988, toda aeronave definida como ULM deberá llevar incorporado el siguiente equipo mínimo:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Anemómetro, altímetro, tacómetro de motor, cuenta horas, cinturón de seguridad y un indicador de cantidad de combustible',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '92. Cuando dos aeronaves converjan a un nivel igual, la que tenga la otra a su derecha (exceptuando las situaciones especiales previstas):',
    opciones: [
      {
