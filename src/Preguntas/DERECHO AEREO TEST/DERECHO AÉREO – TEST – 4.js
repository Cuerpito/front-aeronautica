const preguntas = [
    ...
    {
        titulo: "4. ¿Qué significado tienen una serie de destellos blancos efectuados por el control de aeródromo a una aeronave en vuelo?",
        opciones: [
            {
    ...
    {
        titulo: "9. El equipo de salvamento mínimo en un avión monomotor que vuele sobre el agua, a una distancia superior a la de planeo para poder alcanzar la costa, es:",
        opciones: [
            {
    ...
    {
        titulo: "16. La distancia determinada por la condición atmosférica y expresada en unidades de longitud, a que pueden verse e identificarse, durante el día, objetos prominentes no iluminados, se denomina visibilidad:",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Un documento que divulga el constructor en donde se recogen las modificaciones que considere procedente realizar al ULM para su fiable y segura operación",
                isCorrect: true
            },
            {
            ...
            {
                textoRespuesta: "Un documento que divulga la Aviación Civil de cada país recogiendo las recomendaciones de la OACI (Organización Aeronáutica Civil Internacional)",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Espacio aéreo sobre dimensiones definidas sobre territorio jurisdiccional de un Estado donde se prohíbe todo tipo de vuelos",
                isCorrect: false
            },
            {
                textoRespuesta: "Espacio aéreo de dimensiones definidas sobre el territorio o las aguas Jurisdiccionales de un Estado dentro del cual está prohibido el vuelo de las Aeronaves",
                isCorrect: true
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "b) 1500 metros cuando lo prescriba la autoridad ATS competente, a velocidades que permita observar los tráficos en espacios F y G",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Licencia de piloto de ULM en vigor, certificado de matrícula, certificado de aeronavegabilidad en vigor, seguro de responsabilidad civil y de acompañantes en caso de modelos biplaza",
                isCorrect: true
            },
            {
    ...
    {
        titulo: "37. Nuestro acompañante, se empieza a sentir muy mal. Puede ser grave. Estamos a 20 min. del aeropuerto de Granada, y a 5 del campo de vuelo de Loja. Tenemos que proceder obligatoriamente a Loja, ya que está mas cerca y en Granada no permiten entrar ulm.",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: false
    ...
    {
        titulo: "38. Área LER 71C en las cercanías de Salamanca. Un vuelo VFR, volando a 800 pies AGL, para entrar en ella, tiene que pedir permiso a la torre de Salamanca",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: false
    ...
    {
        titulo: "43. Dentro de las horas de vuelo en ultraligero que como mínimo comprende el curso para la obtención de la licencia de piloto de ultraligero, es necesario realizar un vuelo de travesía con una duración mínima de:",
        opciones: [
            {
    ...
    {
        titulo: "64. Si queremos trazar una ruta entre dos aeródromos, y la ruta directa pasa por esta zona: LER153 FL105/GND ¿qué haremos?",
        opciones: [
            {
    ...
    {
        titulo: "65. El real decreto 2876 por el que se regula el registro y uso de aeronaves de estructura ultraligera y se modifica el registro de aeronaves privadas no mercantiles, es de fecha:",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "La habilitación de radiofonista se considera renovada siempre que se renueve una habilitación asociada a la licencia",
                isCorrect: true
            },
            {
                textoRespuesta: "No",
    ...
    {
        titulo: "78. Si apruebas este examen, ¿cuánto tiempo tienes para examinarte de la parte práctica de piloto ulm, sin necesidad de repetir el presente examen teórico?",
        opciones: [
            {
    ...
    {
        titulo: "85. Un espacio aéreo de dimensiones definidas cuya activación requiere una reserva de espacio aéreo para uso exclusivo de usuarios específicos durante un período de tiempo determinado.",
        opciones: [
            {
    ...
    {
        titulo: "86. Cuando dos aeronaves converjan a un nivel igual, la que venga por la derecha (exceptuando las situaciones especiales previstas):",
        opciones: [
            {
    ...
    {
        titulo: "88. La información aeronáutica, relativa a todo el territorio, se encuentra recogida en un documento, disponible en todos los aeropuertos, que se conoce como:",
        opciones: [
            {
    ...
    {
        titulo: "91. Los límites de tiempo dentro de los cuales el poseedor de una licencia puede ejercer las funciones específicas de la misma, los determinan:",
        opciones: [
            {
    ...
    {
        titulo: "95. Los NOTAM (Notice to Air Men) se crean, entre otras cosas, para alertar a los aviadores de cualquier clase de peligros en una ruta o en algún lugar en especial",
        opciones: [
            {
                textoRespuesta: "Falso",
                isCorrect: false
