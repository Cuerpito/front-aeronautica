const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Altímetro, anemómetro, contador horario, tacómetro, cinturón de seguridad e indicador de cantidad de combustible',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Brújula, anemómetro, altímetro, tacómetro, cinturón de seguridad, paracaídas e indicador de cantidad de combustible',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '7. Una persona con licencia de piloto privado (PPL) que quiera obtener la de ultraligero, además de poseer la licencia de piloto en vigor y disponer de certificado médico, ¿qué más debe acreditar?',
    opciones: [
      {
  ...
  {
    titulo:
      '9. El anemómetro, el altímetro y el variómetro son instrumentos obligatorios que debe llevar toda aeronave definida como ULM:',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: false
  ...
  {
    titulo:
      '12. En aproximación final, un planeador se encuentra por encima de una aeronave propulsada. ¿Cuál de las dos tendrá prioridad para aterrizar?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Un libro diario de vuelos que incluya las hojas de cronometraje donde se anoten los vuelos realizados por pilotos y alumnos',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '19. Comprobamos que nuestra habilitación de helicópteros (H) nos ha caducado. ¿Qué tendremos que hacer para obtenerla de nuevo?',
    opciones: [
      {
  ...
  {
    titulo:
      '34. En una escuela de ultraligeros, ¿quién es la persona encargada de formular el parte mensual de actividades de la escuela?',
    opciones: [
      {
  ...
  {
    titulo:
      '35. De las siguientes funciones del jefe de vuelos de una escuela de ultraligeros, ¿cuál puede delegar en un piloto expresamente autorizado?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Realizar los vuelos de prueba relacionados con el mantenimiento y la seguridad de los ultraligeros de la escuela',
        isCorrect: true
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Le está permitido siempre que ya haya realizado su primer vuelo solo bajo la supervisión de un instructor de vuelo',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Cuando haya demostrado a su instructor el conocimiento de las reglas de vuelo  y situaciones que se puedan dar',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '54. ¿Cuál es el periodo de validez del examen teórico para la obtención de la licencia, antes de que hagamos el práctico?',
    opciones: [
      {
  ...
  {
    titulo:
      '57. “Trayectoria de vuelo paralela a la pista de aterrizaje en la dirección opuesta al aterrizaje”. ¿A qué tramo del circuito de tránsito de aeródromo corresponde esta definición?',
    opciones: [
      {
  ...
  {
    titulo:
      '58. Si en una zona de señales vemos un panel cuadrado rojo horizontal con diagonales amarillas, ¿podremos aterrizar en el aeródromo?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'La obtendremos tras superar un examen teórico y otro práctico, sin necesidad de tener previamente otra habilitación en nuestra licencia',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Multiejes de ala fija (MAF), Instructor (FI), Desplazamiento del centro de gravedad (DCG), Autogiros (AG), Helicópteros (H) e Hidroavión (HD)',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '75. ¿Cuáles son las mínimas condiciones VMC que se tienen que cumplir para que un ultraligero vuele en un espacio aéreo de clase A?',
    opciones: [
      {
  ...
  {
    titulo:
      '78. El encargado de demostrar que una aeronave conserva las condiciones de aeronavegabilidad para las que fue construido será:',
    opciones: [
      {
  ...
  {
    titulo:
      '80. Vemos que nuestra habilitación de multiejes de ala fija (MAF) está a punto de cumplir dos años. ¿Qué tenemos que hacer?',
    opciones: [
      {
        textoRespuesta: 'Revalidarla, acreditando cinco horas de vuelo en los doce meses anteriores a la solicitud',
        isCorrect: true
  ...
  {
    titulo:
      '81. El Servicio de Información Aeronáutica (AIS) proporciona el asesoramiento e información necesarios para la seguridad operacional, regularidad y eficiencia de la navegación aérea:',
    opciones: [
      {
        textoRespuesta: 'Falso',
        isCorrect: false
  ...
  {
    titulo:
      '82. Según la Ley de Navegación Aérea, ¿quién es el encargado de expedir el certificado de aeronavegabilidad de una aeronave?',
    opciones: [
      {
        textoRespuesta: 'Aesa',
        isCorrect: true
  ...
  {
    titulo:
      '86. ¿Quién debe responsabilizarse con su firma de la hoja de cronometraje al finalizar los vuelos realizados en la escuela?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Es el peso de la aeronave terminada con todos sus equipos sin incluir combustible ni líquidos lubricantes o refrigerantes',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '92. Cuando un piloto no pueda acreditar las horas de vuelo necesarias para revalidar su habilitación de instructor, ¿qué ocurre?',
    opciones: [
      {
  ...
  {
    titulo:
      '94. Indique cuál de las siguientes respuestas incluye todas las habilitaciones establecidas para la licencia de ultraligeros:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Multiejes de ala fija, Desplazamiento del centro de gravedad, Autogiros, Helicópteros, Hidroavión, Instructor, Radiofonista y Examinador',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Multiejes de ala fija, Desplazamiento del centro de gravedad, Autogiros, Helicópteros, Hidroavión, Instructor y Radiofonista',
        isCorrect: true
      }
    ]
  },
