const preguntas = [
  {
    titulo:
      '1. Nuestro acompañante se empieza a sentir muy mal. Puede ser algo grave. Podemos declarar emergencia por la radio, siendo un ULM',
    opciones: [
      {
  ...
  {
    titulo:
      '4. Según orden de 14 de Noviembre de 1988, Coda aeronave definida como ULM deberá llevar incorporado el siguiente equipo mínimo:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Anemómetro, altímetro, tacómetro de motor, Cuentahoras, cinturón de seguridad y un indicador de cantidad de combustible',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '7. Un espacio aéreo de dimensiones definidas dentro del cual se facilita Servicio de Control de Tránsito Aéreo se conoce como:',
    opciones: [
      {
  ...
  {
    titulo:
      '11. Cuando una aeronave desciende para aterrizar, al cruzar el nivel de vuelo mas bajo utilizable debe ajustar su altímetro a:',
    opciones: [
      {
  ...
  {
    titulo:
      '18. Para la realización del examen práctico es necesario, además de haber completado la instrucción práctica y haber superado el examen teórico:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Aterrizar y despegar en las pistas, pero las demás maniobras no necesitan limitarse a las pistas ni en las calles de rodaje',
        isCorrect: false
      },
      {
        textoRespuesta: 'Ninguna de las respuestas anteriores es correcta',
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'El peso de la aeronave totalmente terminada y con todo su equipo, sin el combustible, pero incluyendo el combustible no consumible y la máxima cantidad de aceite lubricante y de liquido refrigerante del motor',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '27. Para que un ULM aterrice o despegue de un campo o terreno deberá contar con la autorización de su propietario o poseedor legítimo.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: false
  ...
  {
    titulo:
      '38. Las habilitaciones son anotaciones en una licencia en las que se especifican las atribuciones referentes a la misma y pueden ser:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Que si supero los 300 metros de altura sobre tierra o mar que esté sobrevolando, habré entrado en un área temporalmente segregada',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Que si supero los 300 metros de altura sobre tierra o mar que esté sobrevolando, habré entrado en un espacio aéreo controlado',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '44. Se consideran ultraligeros motorizados terrestres, aquellas aeronaves terrestres biplaza aptas para el vuelo tripulado, cuyo MTOW sea inferior a:',
    opciones: [
      {
  ...
  {
    titulo:
      '45. La señal de la aeronave interceptada, consistente en encender y apagar todas las luces disponibles a intervalos irregulares significa:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Espacio aéreo de dimensiones definidas sobre territorio jurisdiccional de un estado, donde se prohíben todo tipo de vuelos',
        isCorrect: false
      },
      {
        textoRespuesta:
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Consultar en el apartado AD del AIP su horario de activación, ya que sus límites son desde 12500 pies de altitud hasta el suelo',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Consultar si está activada en el apartado ENR del AIP, pues sus límites son de nivel de vuelo 125 hasta el suelo',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '57. El Jefe de Vuelos de la escuela podrá delegar expresamente en un Piloto ULM realizar los vuelos de prueba relacionados con el mantenimiento y la seguridad en vuelo de las aeronaves de la escuela:',
    opciones: [
      {
        textoRespuesta: 'Falso ',
        isCorrect: false
  ...
  {
    titulo:
      '67. Si pretendemos operar en un aeródromo y se nos requiere que enseñemos nuestra licencia de vuelo y certificado médico junto con el DNI. ¿Quién es la persona autorizada según ley para poder hacerlo?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Espacio aéreo especificado, sobre una trayectoria de aproximación, dentro del cual una aeronave efectúa una maniobra de aproximación IFR',
        isCorrect: false
      },
      {
        textoRespuesta:
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Un manual del usuario, un libro de mantenimiento, un diario de a bordo y el manual del equipo de radiotelefonía',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Un manual del usuario, un libro de mantenimiento, un diario de a bordo, un manual del equipo de radiotelefonía y un libro de horas del piloto de ULM',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'La licencia tiene validez indefinida, pero solo podrá reexpedirse cuando al menos una de las habilitaciones Multiejes de ala fija (MAF), Desplazamiento del centro de gravedad (DCG), Helicópteros (H), Autogiros (AG) o Hidroavión (HD) estén en vigor',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '91. La encargada de inspeccionar periódicamente los aeródromos donde operan ULM es la Agencia Estatal de Seguridad Aérea...',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '92. El espacio aéreo de dimensiones definidas sobre el territorio y/o las aguas jurisdiccionales del Estado, dentro del cual está restringido el vuelo de las aeronaves de acuerdo con determinadas condiciones especificadas es:',
    opciones: [
      {
  ...
  {
    titulo:
      '96. Una de las condiciones para el desempeño de las funciones de Jefe de Vuelos en los aeródromos donde operan ultraligeros es tener acreditadas:',
    opciones: [
      {
  ...
  {
    titulo:
      '98. Si volando de noche, seguimos la trayectoria de un avión que nos precede con las luces de navegación encendidas; las veremos de la siguiente manera:',
    opciones: [
      {
