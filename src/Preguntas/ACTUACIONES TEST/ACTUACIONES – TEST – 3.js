const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'c) Basa su medida en la diferencia de la temperatura atmosférica exterior y la temperatura atmosférica estándar',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Iniciaremos la rotación a una velocidad más lenta que la habitual, para evitar daños estructurales en caso de encontrar turbulencias',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'El c.g. es el punto donde actúa todo el peso del avión y el c.a. es el punto donde actúa la fuerza aerodinámica',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '49. Uno de los motivos por los que un avión de motor atmosférico (la mayoría de los ulm) necesita más pista para despegar en una pista elevada, comparado con una a nivel del mar, es que el motor da menos potencia.',
    opciones: [
      {
        textoRespuesta: 'Verdadero ',
        isCorrect: true
  ...
  {
    titulo:
      '58. Los gradientes de viento por obstáculos varían dependiendo del tipo de obstáculos, es decir: volando cerca del suelo, detrás de una zona de arbustos o árboles, podemos esperar:',
    opciones: [
      {
  ...
  {
    titulo:
      '61. Ir calculando la velocidad según referencias exteriores, viendo cómo "pasan" las referencias, en una aproximación para aterrizar:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Es un error sin importancia, ya que la velocidad verdadera se mantiene si mantenemos velocidad con respecto al suelo',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '62. Si durante una aproximación de emergencia por fallo de motor, vemos que vamos un poco altos, una buena actuación para descender con más ángulo, sería:',
    opciones: [
      {
  ...
  {
    titulo:
      '63. Si un ultraligero pesa 180kg de peso máximo al despegue y dispone de una superficie alar de 18m2, ¿Cual es su carga alar?',
    opciones: [
      {
        textoRespuesta: '10 kg/m2',
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Es la zona en la cual el movimiento del aire se realiza en forma de capas de velocidad paralelas y uniformes, con un gradiente de velocidad muy acusado',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '83. En aviones ligeros, los cálculos de despegue se realizan considerando los obstáculos situados en la senda teórica de despegue, y que tengan una altura de:',
    opciones: [
      {
  ...
  {
    titulo:
      '84. El ángulo máximo de inclinación en aviones ligeros en el que se puede equilibrar el factor de carga añadiendo motor es de:',
    opciones: [
      {
        textoRespuesta: '15º',
        isCorrect: false
  ...
  {
    titulo:
      '85. En un aterrizaje, la nivelación y planeo necesario para realizar una toma de contacto en las mejores condiciones se denomina:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Con un cierto ángulo para observar las corrientes de aire y su influencia en nuestro ULM, asegurándose la salida',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      "91. Cuando la velocidad es modificada en cualquier forma, tiene lugar el fenómeno conocido por 'aceleración'. ¿Qué unidad se utiliza para medirla?",
    opciones: [
      {
