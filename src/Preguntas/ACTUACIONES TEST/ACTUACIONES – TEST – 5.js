const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Usaremos la velocidad de mejor ángulo de ascenso hasta superarlos y después usaremos la velocidad de mejor régimen',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '6. El aeródromo A está a 1.800ft de altitud, y el B está a 3.050ft. ¿Cuál de los dos necesitará una pista más larga para despegar?',
    opciones: [
      {
        textoRespuesta: 'El A',
        isCorrect: false
  ...
  {
    titulo:
      '17. Si en la pista que vamos a utilizar para el despegue acaba de aterrizar un avión grande, ¿cuándo debemos despegar con nuestro ULM?',
    opciones: [
      {
  ...
  {
    titulo:
      '20. Las velocidades Vx y Vy no podremos usarlas durante largos periodos de tiempo puesto que se podría calentar el motor.',
    opciones: [
      {
        textoRespuesta: 'Falso',
        isCorrect: false
  ...
  {
    titulo:
      '29. La velocidad normal de ascenso no debe utilizarse durante mucho tiempo porque no proporciona una adecuada refrigeración al motor:',
    opciones: [
      {
        textoRespuesta: 'Falso',
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Falso, debido a que la densidad disminuye con la altura y ésta es el factor determinante para las actuaciones',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '44. Vamos a despegar de una pista que tiene obstáculos cerca y queremos aumentar nuestro ángulo de ascenso. ¿Cómo podemos hacerlo?',
    opciones: [
      {
  ...
  {
    titulo:
      '47. La altitud de densidad es la de presión corregida por el efecto de la temperatura cuando la atmósfera no es estándar:',
    opciones: [
      {
        textoRespuesta: 'Falso',
        isCorrect: false
  ...
  {
    titulo:
      '64. En un aeródromo con las pistas 27 / 09, y un viento de 260º, ¿cuál de las dos debemos usar para que nuestra carrera de despegue sea más corta?',
    opciones: [
      {
  ...
  {
    titulo:
      '70. Si durante la aproximación con viento en calma cruzamos la trayectoria que acaba de seguir un avión grande, ¿qué ocurre?',
    opciones: [
      {
  ...
  {
    titulo:
      '82. Cuando una aeronave se está preparando para aterrizar con el uso de flaps y tren de aterrizaje fuera, su configuración es:',
    opciones: [
      {
        textoRespuesta: 'Sucia',
        isCorrect: true
  ...
  {
    titulo:
      '95. Estamos en un aeródromo con las pistas 27, con pendiente positiva y 09, con pendiente negativa. Con viento en calma, ¿qué pista utilizaremos?',
    opciones: [
      {
