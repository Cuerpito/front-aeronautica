const preguntas = [
  {
    titulo:
      '1. Mientras volamos para llegar a un punto concreto, vemos que nos estamos desplazando hacia la izquierda. ¿Qué significa?',
    opciones: [
      {
  ...
  {
    titulo:
      '5. Si en nuestra ruta queremos llegar a un punto concreto pero vemos que cada vez nos desviamos más hacia la izquierda. ¿Qué debemos hacer?',
    opciones: [
      {
  ...
  {
    titulo:
      '13. Las marcas de nuestro anemómetro son Vs0=50, Vs1=70, Vfe=100, Vno=150, Vne=180. ¿Podremos llevar flaps sin volamos a 65?',
    opciones: [
      {
        textoRespuesta: 'No',
        isCorrect: false
  ...
  {
    titulo:
      '51. Queremos terminar nuestro viraje orientados hacia rumbo 180º y estamos virando hacia la derecha. Debemos parar cuando la brújula indique:',
    opciones: [
      {
        textoRespuesta: '180º',
        isCorrect: false
  ...
  {
    titulo:
      '54. Las marcas de nuestro anemómetro son Vs0=50, Vs1=70, Vfe=100, Vno=150, Vne=180. ¿A cuál de las siguientes velocidades podremos usar flaps?',
    opciones: [
      {
        textoRespuesta: '65',
        isCorrect: false
  ...
  {
    titulo:
      '60. Estamos virando hacia la izquierda y queremos orientarnos al rumbo 180º. Sacaremos el viraje cuando la brújula indique:',
    opciones: [
      {
        textoRespuesta: '170º',
        isCorrect: false
  ...
  {
    titulo:
      '64. Nos estamos aproximando a un aeródromo con obstáculos en las proximidades. ¿Cómo conseguimos un mayor ángulo de descenso?',
    opciones: [
      {
  ...
  {
    titulo:
      '66. Virando hacia la izquierda queremos orientarnos hacia el rumbo 360º. Sacaremos nuestro viraje cuando la brújula indique:',
    opciones: [
      {
        textoRespuesta: '030º',
        isCorrect: true
  ...
  {
    titulo:
      '73. La velocidad máxima a la que un avión puede entrar en pérdida sin sobrepasar los límites de factor de carga soportados por la aeronave es:',
    opciones: [
      {
        textoRespuesta: 'La velocidad de maniobra',
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Según cuáles sean las rutas más utilizadas, para que las aeronaves se tengan que desviar lo menos posible tras el despegue',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '79. En configuración de aterrizaje, nuestra aeronave tiene una velocidad de pérdida de 50 km/h. ¿A qué velocidad mínima volaremos en aproximación final?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Verdadero, pero la responsabilidad última de comprobar que las condiciones sean las adecuadas es del comandante de la aeronave',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '89. Las marcas de nuestro anemómetro son Vs0=50, Vs1=70, Vfe=100, Vno=150, Vne=180. ¿A qué velocidad podríamos ir en caso de turbulencia fuerte?',
    opciones: [
      {
  ...
  {
    titulo:
      '95. Mientras no se supere la velocidad de maniobra, el avión podrá entrar en pérdida antes de experimentar un aumento en el factor de carga que exceda su carga límite.',
    opciones: [
      {
        textoRespuesta: 'Falso',
        isCorrect: false
  ...
  {
    titulo:
      '96. Las marcas de nuestro anemómetro son Vs0=50, Vs1=70, Vfe=100, Vno=150, Vne=180. ¿En cuál de las siguientes velocidades podríamos tanto usar flaps como no hacerlo?',
    opciones: [
      {
        textoRespuesta: '80',
        isCorrect: true
  ...
  {
    titulo:
      '98. Aunque debamos seguir las instrucciones del fabricante, una forma de hacer el chequeo prevuelo para evitar que se nos pase algo es:',
    opciones: [
      {
