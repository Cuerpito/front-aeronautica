const preguntas = [
    ...
    {
        titulo: "16. En nuestro anemómetro, el arco blanco acaba a 110, el amarillo empieza a 160, y tiene una raya roja a 210. ¿Cuál es la velocidad máxima a la que podemos volar en aire turbulento?",
        opciones: [
            {
                textoRespuesta: "110",
                isCorrect: false
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "c) Relajar la palanca de mando para disminuir el ángulo de ataque y aplicar timón contrario al sentido de rotación",
                isCorrect: true
            },
            {
    ...
    {
        titulo: "27. Aterrizando con viento cruzado lateral fuerte, se obtiene mejor control del avión usando un calaje de flap menor del que usamos normalmente para aterrizar",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    {
        titulo: "33. La velocidad de turbulencia está destinada a asegurar que las turbulencias no generen en el avión factores de carga que fuesen excesivos para su estructura:",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    {
        titulo: "40. Hemos calculado que la velocidad de referencia en final de nuestro avión es de 75 km/h. Vamos a aterrizar en un campo en el que hay cierta turbulencia. Podemos aumentar nuestra velocidad a 85 km/h",
        opciones: [
            {
                textoRespuesta: "No",
                isCorrect: false
    ...
    {
        titulo: "41. La velocidad de maniobra es suficientemente superior a la velocidad de pérdida, para protegernos de las fuertes disminuciones de velocidad que la turbulencia produce",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    {
        titulo: "44. Cuando accionamos la palanca de mando hacia atrás, actuamos sobre el timón de profundidad y el avión sube. Pero, ¿En qué posición colocamos dicho timón?",
        opciones: [
            {
    ...
    {
        titulo: "50. ¿Cómo acusara recibo la aeronave, cuando está en tierra, de las señales luminosas que se le hacen desde la torre de control?",
        opciones: [
            {
    ...
    {
        titulo: "52. En una pista con pendiente, al margen de la acción del viento ¿En qué sentido es más favorable realizar la toma de tierra?",
        opciones: [
            {
