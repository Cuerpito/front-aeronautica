const preguntas = [
  {
    titulo:
      '1. En tierra tenemos un QNH de 1022. Si subimos 90 metros, la presión se reducirá en 10 mb. ¿Cuál será el QNH será a esa altitud?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Espacio de dimensiones definidas dentro del cual se facilita servicio de control de tránsito aéreo para los vuelos controlados',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '9. Con viento cruzado, y observando el dibujo que se presenta a continuación, la posición del piloto que hubiera puesto un rumbo menor en la brújula, sería la correspondiente al avión',
    opciones: [
      {
        textoRespuesta: 'A',
        isCorrect: false
  ...
  {
    titulo:
      '13. En nuestro anemómetro, el arco blanco acaba a 110, el amarillo empieza a 160, y tiene una raya roja a 210. ¿Cuál es la velocidad máxima a la que podemos volar con el flap bajado?',
    opciones: [
      {
        textoRespuesta: '160',
        isCorrect: false
  ...
  {
    titulo:
      '14. En el caso de realizar un despegue inmediatamente después del despegue de un avión grande, se deberá iniciar la carrera de despegue con relación a aquel:',
    opciones: [
      {
  ...
  {
    titulo:
      '25. Un avión necesita más pista para aterrizar en una pista elevada, porque la velocidad real de aproximación será siempre mayor que a nivel del mar',
    opciones: [
      {
  ...
  {
    titulo:
      '28. Una buena táctica para asegurarnos de llegar al campo elegido en caso de fallo de motor es quedarnos un poco altos para, con campo asegurado, realizar un resbale y perder así la altura de más',
    opciones: [
      {
  ...
  {
    titulo:
      '30. Hemos calculado que nuestra velocidad de referencia en final es de 75 km/h. Como vamos a aterrizar en una pista corta, podemos volar en aproximación final a una velocidad más reducida',
    opciones: [
      {
  ...
  {
    titulo:
      '31. Se nos para el avión en pleno despegue. Ya hemos bajado el morro y controlado el avión. Podemos volver a tomar en la pista de la que hemos despegado.',
    opciones: [
      {
  ...
  {
    titulo:
      '33. Del procedimiento de arranque del motor, cuales son los pasos que tendremos que realizar para no poner en peligro a nadie',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Mirar el grado de dureza, el diámetro puede variar hasta un máximo de 3 milímetros en el caso de un vuelo forzoso',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '40. Tenemos fuego en el compartimento del motor. Ya tenemos el avión controlado. Ahora hay que combatir la emergencia. Cuáles son los pasos',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Acelerar el motor a fondo - Cerrar todas las llaves de combustible - Preparar la toma a motor parado que se avecina',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Cerrar todas las llaves de combustible - acelerar el motor a fondo - preparar la toma a motor parado que se avecina',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '41. Para minimizar la posibilidad de colisión cuando se efectúen las maniobras en torno al despegue, el piloto de ultraligeros deberá:',
    opciones: [
      {
  ...
  {
    titulo:
      '42. Como norma general y para evitar innecesarios olvidos, ¿En qué forma y sentido hay que realizar la inspección prevuelo?',
    opciones: [
      {
  ...
  {
    titulo:
      '43. Antes de despegar, el procedimiento más seguro para evitar un conflicto con un avión que vaya a aterrizar, es preguntar por la radio si hay alguien.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: false
  ...
  {
    titulo:
      '45. No estamos seguros de que el combustible que llevamos sea suficiente para llegar a nuestro destino o a otro aeródromo. Tomar en un prado que consideremos apto puede ser una buena alternativa de contingencia',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '46. Si inmediatamente después del aterrizaje se retrae el flap, disminuye la sustentación, aumenta el peso sobre las ruedas, y con ello también la eficacia de los frenos',
    opciones: [
      {
        textoRespuesta: 'Verdadero ',
        isCorrect: true
  ...
  {
    titulo:
      '50. Empieza a salir humo por detrás del panel de instrumentos. Después de estar seguros de que tenemos el avión controlado, que paso hay que dar para combatir esta emergencia',
    opciones: [
      {
  ...
  {
    titulo:
      '51. En una pista con pendiente, al margen de la acción del viento, ¿En qué sentido es más favorable realizar el despegue?',
    opciones: [
      {
  ...
  {
    titulo:
      '58. Estamos en Bubión (Granada), que tiene una elevación de 2300 pies. Un avión pasa por la vertical a 1000 pies de altura. ¿A qué altitud está volando?',
    opciones: [
      {
  ...
  {
    titulo:
      '60. El manual de nuestro avión dice que en configuración de aterrizaje tiene una velocidad de pérdida de 55 km/h. Con lo cual en aproximación final, volaremos a una velocidad mínima de',
    opciones: [
      {
  ...
  {
    titulo:
      '65. En nuestro anemómetro, el arco blanco acaba a 110, el amarillo empieza a 160, y tiene una raya roja a 210. ¿Cuál es la velocidad máxima a la que podemos volar en aire calmado?',
    opciones: [
      {
        textoRespuesta: '210',
        isCorrect: true
  ...
  {
    titulo:
      '66. Hemos sobrepasado la velocidad máxima del avión. Tenemos que tirar de la palanca rápidamente y con energía para reducir la velocidad del avión lo antes posible',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: false
  ...
  {
    titulo:
      '67. Estadísticas publicadas en USA demuestran que la mayoría de los casos en que una parada de motor acaba en accidente grave, la causa del accidente no es la parada del motor en sí. Sino que a partir de esa situación, el avión se ha metido en pérdida. ¿Cómo evita esto?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          '"Volando" el avión en todo momento. Es decir, manteniendo los parámetros básicos de vuelo no dejándonos sobrecoger por la situación anormal',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '71. Cuando hay viento fuerte o racheado, es más aconsejable que los aterrizajes se hagan con poco o ningún calado de flap.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '77. La maniobra que consiste en ir levantando el morro a muy poca altura sobre la pista, antes de que haga la toma de contacto, se denomina',
    opciones: [
      {
  ...
  {
    titulo:
      '83. En ultraligeros, el vuelo en zonas montañosas está totalmente desaconsejado por la dificultad de encontrar un lugar donde aterrizar en caso de algún fallo que nos impida continuar el vuelo, además de otros factores como las turbulencias, escasa potencia o rápidas formaciones de nubes.',
    opciones: [
      {
  ...
  {
    titulo:
      '85. Con turbulencia fuerte, volar muy cerca de la velocidad máxima de turbulencia, aun estando todavía en el arco verde, no es recomendable, porque las variaciones de velocidad que implica volar en turbulencia, nos pueden meter muy dentro del arco amarillo',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '95. Si nos viéramos obligados a tomar tierra en una carretera por una emergencia e imposibilidad de tomar en otro sitio, procuraríamos dentro de lo posible',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Aterrizar en el mismo sentido de la marcha del tráfico y saliendonos rápidamente a la cuneta después de la toma de tierra',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '97. La velocidad de maniobra es suficientemente inferior a la velocidad de turbulencia, para protegernos de los fuertes incrementos de velocidad, que la turbulencia produce',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
