const preguntas = [
  ...
  {
    titulo:
      '2. Antes del despegue, el piloto deberá asegurarse de que la temperatura de aceite está dentro de sus valores normales. De no hacerlo así:',
    opciones: [
      {
  ...
  {
    titulo:
      '10. Un piloto se pierde. Le quedan 10 minutos para el ocaso. Decide aterrizar en un prado que le ofrece aterrizar con seguridad.',
    opciones: [
      {
  ...
  {
    titulo:
      '11. Delante de nuestra trayectoria de vuelo observamos una bandada muy grande de pájaros. Si la situación lo permite, es conveniente reducir la potencia del motor a ralentí',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '13. Navegando con un ULM desde un punto de referencia hasta otro, vemos que nos estamos desplazando a la derecha, señal de que hay viento cruzado de la izquierda. Lo correcto será:',
    opciones: [
      {
  ...
  {
    titulo:
      '15. Se nos para el motor. Ya tenemos el avión controlado y altura que consideramos segura para intentar el rearranque. Contesta que pasos de los siguientes son ciertos, antes de intentar arrancar el motor',
    opciones: [
      {
  ...
  {
    titulo:
      '22. Si se desea terminar un viraje orientado a rumbo 360° y el avión estaba virando por la derecha, se deberá sacar cuando la brújula indique:',
    opciones: [
      {
        textoRespuesta: '360º',
        isCorrect: false
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'La toma el Jefe de Vuelo del campo, pero siempre es responsabilidad del piloto como comandante de aeronave asegurarse de las condiciones en el momento del despegue',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Que no calcule bien la maniobra y provoque una toma dura con posible rebote sobre la pista, o tire de palanca más de lo necesario, yéndonos de nuevo al aire peligrosamente',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Falso, se accionará, si el piloto considera que la situación es tan comprometida, que es el procedimiento más seguro',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '35. Elige entre las respuestas, la configuración que presentará un mayor ángulo de ataque, teniendo en cuenta que el peso es el mismo',
    opciones: [
      {
  ...
  {
    titulo:
      '39. Si la temperatura en un campo de vuelo aumenta considerablemente, la carrera de despegue, la carrera de despegue será',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'a) Harán todos los virajes hacia la derecha al aproximarse para aterrizar y después del despegue, salvo orden en contra',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'c) Aterrizarán y despegarán a favor del viento, salvo razones de seguridad, de configuración de la pista o de tránsito aéreo',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '44. Cuando se vaya a realizar una toma de emergencia en cultivos crecidos (trigo, cebada, etc.) debemos tener la precaución de:',
    opciones: [
      {
  ...
  {
    titulo:
      '47. Podemos disminuir ese margen de velocidad de 30% sobre la velocidad de pérdida en aproximación final en alguna circunstancia.',
    opciones: [
      {
  ...
  {
    titulo:
      '49. Hay que esmerarse en mirar fuera muy frecuentemente durante todo el vuelo. Y hay que considerar que estamos en vuelo desde justo antes de arrancar el motor, durante el rodaje de salida, y durante el rodaje de llegada hasta que el motor está parado',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '57. Hemos tenido la emergencia de humo eléctrico en cabina, realizado el procedimiento, y combatido el humo. Podemos encender algún equipo, por ejemplo el GPS',
    opciones: [
      {
  ...
  {
    titulo:
      '60. En nuestro anemómetro, el arco blanco acaba a 110, el amarillo empieza a 160, y tiene una raya roja a 210. Nos vemos sorprendidos por una tormenta, excepcionalmente, en esta ocasión, para alejarnos lo más rápido posible, podemos volar a 230',
    opciones: [
      {
        textoRespuesta: 'Sí',
        isCorrect: false
  ...
  {
    titulo:
      '63. En el caso de que las tomas estáticas quedaran obstruidas, pueden obtenerse indicaciones en los instrumentos de presión',
    opciones: [
      {
  ...
  {
    titulo:
      '64. El arco blanco de nuestro anemómetro acaba a 100 km/h. El arco amarillo empieza a 160 km/h. Entramos en una zona de turbulencia fuerte, y con los nervios no nos acordamos de cuál es la Va. ¿A qué velocidad deberemos volar?',
    opciones: [
      {
  ...
  {
    titulo:
      '65. A mayor temperatura, el avión necesita más longitud de pista porque la densidad del aire disminuye, con lo que el avión "siente" que está a mayor altitud',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '66. Llenar el tanque de combustible después del último vuelo, se considera una buena práctica porque previene de la condensación de la humedad al disminuir la cantidad de aire en el tanque',
    opciones: [
      {
        textoRespuesta: 'Verdadero ',
        isCorrect: true
  ...
  {
    titulo:
      '68. Si en vuelo recto y nivelado a altitud de crucero tuviéramos una parada de motor imprevista, ¿qué es lo primero de todo que debemos hacer?',
    opciones: [
      {
  ...
  {
    titulo:
      '72. Si abres la palanca de gases al máximo y bajas el morro lo suficiente para que el avión no ascienda. ¿Qué conseguirás?',
    opciones: [
      {
  ...
  {
    titulo:
      '73. Si con fuerte viento en altura de tráfico, antes de aterrizar vemos la manga del campo indicando poco viento en el suelo:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Es una indicación de que existe un elevado gradiente, por lo que aproximaremos alerta con un plus de velocidad relativa',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '74. A velocidad del viento es de 40 km/h. Indique que clase ULM está en condiciones de volar sin que le afecte limitación del viento',
    opciones: [
      {
  ...
  {
    titulo:
      '81. En el caso de realizar un despegue inmediatamente después del aterrizaje de un avión grande, se deberá realizar de forma que el punto de irse al aire este situado, con respecto al punto de contacto de la estela del otro avión',
    opciones: [
      {
  ...
  {
    titulo:
      '86. La velocidad de maniobra permite hacer una deflexión total de los mandos para contrarrestar las fuertes oscilaciones en cabeceo y alabeo que la turbulencia produce, sin riesgo para la estructura del avión',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '91. En nuestro anemómetro, el arco blanco acaba a 110, el amarillo empieza a 160, y tiene una raya roja a 210. ¿Cuál es, aproximadamente, la velocidad recomendada para volar con turbulencia fuerte?',
    opciones: [
      {
        textoRespuesta: '210',
        isCorrect: false
