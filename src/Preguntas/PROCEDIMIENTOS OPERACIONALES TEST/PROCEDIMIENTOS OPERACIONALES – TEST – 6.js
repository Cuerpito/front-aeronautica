const preguntas = [
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "El comienzo y el final de la zona utilizable para el despegue de las aeronaves que se sitúa, normalmente, en el extremo de la pista.",
                isCorrect: false
            },
            {
                textoRespuesta: "El comienzo de la zona utilizable para el aterrizaje y despegue de las aeronaves que se sitúa, normalmente, en el extremo de la pista.",
                isCorrect: false
            },
            {
                textoRespuesta: "El comienzo de la zona utilizable para el aterrizaje de las aeronaves que se sitúa, normalmente, en la mitad de la pista.",
                isCorrect: false
            },
            {
                textoRespuesta: "El comienzo de la zona utilizable para el aterrizaje de las aeronaves que se sitúa, normalmente, en el extremo de la pista.",
                isCorrect: true
            }
        ]
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "En maniobras como por ejemplo la nivelación de la aeronave tras una pérdida, y tienden a dejar al piloto “pegado” en su asiento.",
                isCorrect: true
            },
            {
                textoRespuesta: "En maniobras como por ejemplo la nivelación de la aeronave tras una pérdida, y tienden a separar al piloto de su asiento.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "No podrá volver a volar, pues los daños estructurales en la aeronave aparecerán con seguridad si se supera esa velocidad.",
                isCorrect: false
            },
            {
                textoRespuesta: "No podrá volver a volar sin una revisión previa aun cuando no se aprecien daños estructurales evidentes, pues el efecto de la fatiga del material es acumulativo y éstos pueden aparecer más adelante.",
                isCorrect: true
            },
            {
            ...
            {
                textoRespuesta: "Ninguna aeronave puede superar la Vne que marca su anemómetro pues es obligatorio que éstas incorporen un mecanismo regulador que les impida sobrepasarla y evitar así los daños estructurales.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Como no existen unas normas concretas, lo más común es empezar por el morro y dar una vuelta completa por la izquierda, y así evitaremos que se nos olvide inspeccionar algo.",
                isCorrect: false
            },
            {
                textoRespuesta: "En todo momento tenemos que seguir las instrucciones del fabricante y si no las tenemos, lo mejor será cancelar el vuelo.",
                isCorrect: false
            },
            {
                textoRespuesta: "Aunque debamos seguir las instrucciones del fabricante, una forma común es empezar por el morro, continuar con las dos alas y acabar inspeccionando la aeronave por la cola.",
                isCorrect: false
            },
            {
                textoRespuesta: "Aunque debamos seguir las instrucciones del fabricante, una forma común es empezar por el morro y dar una vuelta completa por la derecha, y así evitaremos que se nos olvide inspeccionar algo.",
                isCorrect: true
            }
        ]
    },
    ...
    {
        titulo: "11. Entre una aeronave que se encuentra en base, a un nivel inferior, y otra que se encuentra en final, a un nivel superior, ¿quién deberá ceder el paso?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "La aeronave que se encuentra más alejada de la pista será la que ceda el paso, independientemente de su situación en el circuito de tráfico y del nivel de vuelo.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Iremos disminuyendo el ángulo de ataque para disminuir también la sustentación y mantenernos en la senda de planeo.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Iremos aumentando el ángulo de ataque para aumentar también la sustentación y mantenernos en la senda de planeo.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Deberá drenar los depósitos de combustible completamente y utilizar combustible nuevo para evitar la contaminación con agua.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Deberá drenar los depósitos de combustible para evitar la contaminación con sedimentos, pero no tendrá en cuenta la aparición de agua, pues con el calor ésta se evaporará y eliminará fácilmente.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "14. Los compensadores son los elementos que ayudan al piloto a aliviar su esfuerzo sobre los controles primarios. ¿Dónde se encuentra y cómo funciona el compensador de profundidad?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "Normalmente está unido a la parte delantera del estabilizador horizontal de cola y se mueve en sentido contrario al timón de profundidad.",
                isCorrect: false
            }
        ]
    },
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Tendrá que ceder el paso y mantenerse fuera de la trayectoria de la aeronave a la que alcanza, ya sea ascendiendo, descendiendo o en vuelo horizontal, cambiando su rumbo hacia la derecha.",
                isCorrect: false
            },
            {
                textoRespuesta: "Tendrá que ceder el paso y mantenerse fuera de la trayectoria de la aeronave a la que alcanza, ya sea ascendiendo, descendiendo o en vuelo horizontal, cambiando su rumbo hacia la izquierda.",
                isCorrect: false
            },
            {
                textoRespuesta: "Tendrá derecho de paso mientras que la que alcanza ya sea ascendiendo, descendiendo o en vuelo horizontal, se mantendrá fuera de su trayectoria cambiando de rumbo hacia la izquierda.",
                isCorrect: false
            },
            {
                textoRespuesta: "Tendrá derecho de paso mientras que la que alcanza ya sea ascendiendo, descendiendo o en vuelo horizontal, se mantendrá fuera de su trayectoria cambiando de rumbo hacia la derecha.",
                isCorrect: true
            }
        ]
    },
    {
        titulo: "19. Cuando dos aeronaves convergen a un mismo nivel aproximado, la que tenga la otra a su derecha es la que cede el paso. Sin embargo, hay una serie de excepciones. De las siguientes, indique cuál es la correcta:",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Empujando la palanca o volante, lo cual hace que el timón de profundidad se mueva hacia abajo y el avión realice un movimiento de picado.",
                isCorrect: true
            },
            {
                textoRespuesta: "Empujando la palanca o volante, lo cual hace que el timón de profundidad se mueva hacia arriba y el avión realice un movimiento de picado.",
                isCorrect: false
            },
            {
                textoRespuesta: "Empujando la palanca o volante, lo cual hace que el timón de profundidad se mueva hacia abajo y el avión realice un movimiento de encabritado.",
                isCorrect: false
            },
            {
                textoRespuesta: "Empujando la palanca o volante, lo cual hace que el timón de profundidad se mueva hacia arriba y el avión realice un movimiento de encabritado.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "22. En caso de que tengamos una emergencia por parada de motor con hélice de paso variable, ¿cuál es el paso que debemos usar?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Cortamos motor, empujamos palanca para bajar el morro, volvemos a arrancar el motor y aplicamos potencia a fondo para aumentar la velocidad, y recuperamos la altura perdida sin brusquedad para evitar pérdidas secundarias.",
                isCorrect: false
            },
            {
                textoRespuesta: "Aplicamos motor a fondo para aumentar la velocidad, empujamos palanca para bajar el morro y recuperamos la altura perdida sin brusquedad para evitar pérdidas secundarias.",
                isCorrect: false
            },
            {
                textoRespuesta: "Empujamos palanca para bajar el morro, aplicamos motor a fondo para aumentar la velocidad y cuando haya alcanzado la suficiente, recuperamos la altura perdida sin brusquedad para evitar pérdidas secundarias.",
                isCorrect: true
            },
            {
                textoRespuesta: "Empujamos palanca para subir el morro, aplicamos motor a fondo para aumentar la velocidad y cuando haya alcanzado la suficiente, recuperamos la altura perdida sin brusquedad para evitar pérdidas secundarias.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "25. Teniendo en cuenta que las marcas de nuestro anemómetro, en millas por hora, son las siguientes: Vs0=55, Vs1=65, Vfe=100, Vno=150, Vne=180, ¿cuál de las siguientes afirmaciones es correcta?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "El motor del avión funciona a niveles óptimos de presión y temperatura pero aumenta el consumo de combustible.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Se reduce el consumo de combustible pero el motor se sobrecalienta, por lo que no es recomendable utilizarla durante largos periodos de vuelo.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "29. La mezcla de aire y combustible del carburador es muy importante para el funcionamiento del motor. ¿Qué ocurre con esta mezcla cuando realizamos un ascenso?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Que el anemómetro, el altímetro y el variómetro no podrán medir la presión total del aire y por lo tanto mostrarán marcaciones erróneas.",
                isCorrect: false
            },
            {
                textoRespuesta: "Que el altímetro y el variómetro no podrán medir la presión total del aire y por lo tanto mostrará marcaciones erróneas.",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "34. Vamos a aterrizar en un aeródromo en el que hay una señal en forma de “T” de color blanco o anaranjado. ¿Qué significa?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "Que el aterrizaje hay que realizarlo en dirección paralela al trazo corto de la “T” dejando el trazo largo a la derecha.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Las aeronaves que estén operando en tierra cederán el paso a las otras que estén aterrizando o en las fases finales de aproximación para aterrizar.",
                isCorrect: true
            },
            {
                textoRespuesta: "Las aeronaves que estén en las fases finales de aproximación para aterrizar cederán el paso a las otras que estén operando en tierra.",
                isCorrect: false
            },
            {
                textoRespuesta: "Las aeronaves que estén operando en tierra no cederán el paso a las otras que estén aterrizando o en las fases finales de aproximación para aterrizar.",
                isCorrect: false
            },
            {
                textoRespuesta: "Las aeronaves que estén en las fases finales de aproximación para aterrizar cederán el paso a las otras que estén en vuelo.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "37. Estamos virando hacia la derecha y queremos orientarnos hacia el norte exactamente. Tendremos que sacar el viraje cuando la brújula indique:",
        opciones: [
            {
                textoRespuesta: "330º.",
                isCorrect: true
    ...
    {
        titulo: "39. Según el manual de vuelo de nuestra aeronave, su velocidad de pérdida en configuración de aterrizaje es de 50 km/h. Por lo tanto, ¿cuál es la velocidad mínima a la que podemos volar en aproximación final?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Obtiene la presión dinámica midiendo la estática a través de las tomas estáticas y la total a través del tubo pitot, para transformarla en velocidad.",
                isCorrect: true
            },
            {
            ...
            {
                textoRespuesta: "Obtiene la presión total midiendo la estática a través de las tomas estáticas y la dinámica a través del tubo pitot para transformarla en velocidad.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "44. Entre las razones que hacen importante conocer el factor de carga, hay dos que son especialmente de interés para el piloto. ¿Cuáles pueden ser?",
        opciones: [
            {
                textoRespuesta: "El peligro de someter a la aeronave a límites estructurales que pueden llegar a romperlo, y el hecho de que un aumento del factor de carga disminuye la velocidad de pérdida.",
                isCorrect: false
            },
            {
                textoRespuesta: "El peligro de someter a la aeronave a factores de carga positivos y el hecho de que un aumento del factor de carga aumenta la velocidad de pérdida.",
                isCorrect: false
            },
            {
                textoRespuesta: "El peligro de someter a la aeronave a límites estructurales que pueden llegar a romperlo, y el hecho de que un aumento del factor de carga aumenta la velocidad de pérdida.",
                isCorrect: true
            },
            {
                textoRespuesta: "El peligro de someter a la aeronave a factores de carga negativos y el hecho de que un aumento del factor de carga disminuye la velocidad de pérdida.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Que se enriquece debido a la disminución de presión el atura, pero se regula automáticamente en todo tipo de aeronaves.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "47. Cuando ya estamos preparados para volar con nuestra aeronave, debemos realizar un chequeo pre vuelo cuyo objetivo es:",
        opciones: [
            {
                textoRespuesta: "Que el piloto, tras realizar una inspección rigurosa en el exterior de la aeronave, compruebe las condiciones de operación de ésta para realizar un vuelo seguro.",
                isCorrect: false
            },
            {
                textoRespuesta: "Que el jefe de vuelos, tras realizar una inspección rigurosa en el exterior e interior de la aeronave, compruebe las condiciones de operación de ésta para realizar un vuelo seguro.",
                isCorrect: false
            },
            {
                textoRespuesta: "Que el piloto, tras realizar una inspección rigurosa en el exterior e interior de la aeronave, compruebe las condiciones de operación de ésta para realizar un vuelo seguro.",
                isCorrect: true
            },
            {
                textoRespuesta: "Que el piloto, tras realizar una inspección rigurosa en el interior de la aeronave, compruebe las condiciones de operación de ésta para realizar un vuelo seguro.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Una luz verde a la izquierda, una roja a la derecha y una blanca en la cola, y pueden llevarse como luces fijas o como luces de destellos.",
                isCorrect: true
            },
            {
                textoRespuesta: "Una luz verde a la izquierda, una roja a la derecha y una blanca en la cola, y deben llevarse como luces fijas.",
                isCorrect: false
            },
            {
                textoRespuesta: "Una luz verde a la izquierda, una roja a la derecha y una blanca en la cola, y deben llevarse como luces de destellos.",
                isCorrect: false
            },
            {
                textoRespuesta: "Una luz roja a la izquierda, una verde a la derecha y una blanca en la cola, y deben llevarse como luces de destellos.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "El estrés causado por la situación hace que normalmente el piloto intente recuperar la altura perdida cuando aún no tiene la velocidad suficiente.",
                isCorrect: false
            },
            {
                textoRespuesta: "Si tiramos bruscamente de la palanca, el factor de carga positivo se incrementa considerablemente, aumentando también la velocidad de pérdida.",
                isCorrect: true
            },
            {
                textoRespuesta: "Si tiramos bruscamente de la palanca, el factor de carga negativo se incrementa considerablemente, aumentando también la velocidad de pérdida.",
                isCorrect: false
            },
            {
                textoRespuesta: "Si tiramos bruscamente de la palanca, el factor de carga aumenta de forma considerable, disminuyendo la velocidad de pérdida.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "50. Cuando tenemos una emergencia, lo más seguro es seguir un orden de prioridad en las tareas básicas de pilotaje. ¿Cuál puede ser este orden?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "El orden en este dependerá de la situación concreta y del criterio personal del piloto al mando de la aeronave.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Depende de la presión atmosférica, que disminuye en altura, por lo que la mezcla se empobrece cuando subimos.",
                isCorrect: false
            },
            {
                textoRespuesta: "Depende de la presión atmosférica, que disminuye en altura, por lo que la mezcla se enriquece cuando subimos.",
                isCorrect: true
            },
            {
            ...
            {
                textoRespuesta: "Depende de la presión atmosférica, que disminuye en altura, por lo que todas las aeronaves van equipadas para que la mezcla se regule automáticamente en ascensos y descensos.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "54. El centro de gravedad de una aeronave puede oscilar dentro de unos márgenes sin que las actuaciones de una aeronave se vean comprometidas. Sin embargo, ¿qué puede ocurrir con un centro de gravedad muy adelantado?",
        opciones: [
            {
                textoRespuesta: "El avión necesitará menos pista para despegar pero en vuelo se hará inestable y de difícil control, además de hacer crítica la maniobra de recuperación de una pérdida.",
                isCorrect: false
            },
            {
                textoRespuesta: "El avión necesitará más pista para despegar y puede comprometer seriamente la maniobra en caso de tener que recuperar una pérdida.",
                isCorrect: false
            },
            {
                textoRespuesta: "El avión necesitará más longitud de pista para despegar y puede comprometer seriamente la maniobra en caso de tener que realizar un “motor y al aire”.",
                isCorrect: true
            },
            {
                textoRespuesta: "El avión se hace inestable y de difícil control, y puede hacer crítica la maniobra de recuperación de una pérdida.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "55. Las marcas de nuestro anemómetro, en millas por hora, son las siguientes: Vs0=55, Vs1=65, Vfe=100, Vno=150, Vne=180. ¿Cuál es la velocidad máxima a la que puedo usar los flaps?",
        opciones: [
            {
    ...
    {
        titulo: "56. Estamos en tierra en un aeródromo y recibimos una serie de luces en forma de destellos verdes. ¿Qué quiere decir ese mensaje?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "En poca altitud de densidad, en una pista con pendiente positiva, un día con altas temperaturas y una aeronave de gran peso.",
                isCorrect: false
            },
            {
                textoRespuesta: "En gran altitud de densidad, en una pista con pendiente negativa, un día con altas temperaturas y una aeronave de gran peso.",
                isCorrect: false
            },
            {
                textoRespuesta: "En gran altitud de densidad, en una pista con pendiente negativa, en un día con bajas temperaturas y una aeronave de gran peso.",
                isCorrect: false
            },
            {
                textoRespuesta: "En gran altitud de densidad, en una pista con pendiente positiva, un día con altas temperaturas y una aeronave de gran peso.",
                isCorrect: true
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Puede ser positivo, cuando la fuerza ejercida es hacia arriba, y negativo cuando la fuerza se ejerce hacia abajo.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Puede ser positivo, cuando la fuerza ejercida es hacia abajo, y negativo cuando la fuerza se ejerce hacia arriba.",
                isCorrect: true
            },
            {
                textoRespuesta: "Puede ser positivo, cuando el piloto tiende a despegarse de su asiento, y negativo cuando se queda “pegado” a él.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Cuando el bastón esté en la llamada “caseta de perro” y la bola esté en el lado hacia el que realizamos el viraje.",
                isCorrect: false
            },
            {
                textoRespuesta: "Cuando el horizonte artificial marque exactamente los grados de inclinación con los que se está realizando el viraje.",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "60. Un avión que tenga el alerón izquierdo hacia abajo y el derecho hacia arriba, ¿sobre qué eje de giro se moverá y en qué dirección?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Es aquella a la que puede volar una aeronave durante el vuelo de crucero sin peligro de sufrir daños estructurales.",
                isCorrect: false
            },
            {
                textoRespuesta: "Es aquella a la que puede volar una aeronave en cualquier maniobra que realice sin peligro de sufrir daños estructurales.",
                isCorrect: false
            },
            {
                textoRespuesta: "Es aquella a la que puede volar una aeronave que esté realizando un viraje sin peligro de sufrir daños estructurales.",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "62. En la pista de un mismo aeródromo, vamos a aterrizar un día con viento en cara y otro con viento en calma. ¿Hay alguna diferencia considerable que debamos tener en cuenta en uno y otro caso?",
        opciones: [
            {
                textoRespuesta: "Tendremos que tener en cuenta que el día con viento en calma, la senda de planeo en aproximación tendrá que ser más baja que el día con viento en cara.",
                isCorrect: true
            },
            {
            ...
            {
                textoRespuesta: "Tendremos que tener en cuenta que el día con viento en calma, la senda de planeo en aproximación tendrá que ser más alta que el día con viento en cara.",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "64. Nos encontramos en el hemisferio norte, estamos virando hacia la izquierda y queremos orientarnos hacia el rumbo 180º. Debido al error de la brújula, ¿cuándo tenemos que sacar el viraje?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "La que esté siendo alcanzada, mientras que la otra se mantendrá fuera de su trayectoria, cambiando su rumbo hacia la izquierda.",
                isCorrect: false
            },
            {
                textoRespuesta: "La que esté siendo alcanzada, mientras que la otra se mantendrá fuera de su trayectoria, cambiando su rumbo hacia la derecha.",
                isCorrect: true
            },
            {
                textoRespuesta: "La que está alcanzando, mientras que la otra se mantendrá fuera de su trayectoria, cambiando su rumbo hacia la izquierda.",
                isCorrect: false
            },
            {
                textoRespuesta: "La que está alcanzando, mientras que la otra se mantendrá fuera de su trayectoria, cambiando su rumbo hacia la derecha.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "66. Entre una aeronave propulsada mecánicamente, un planeador, un globo o un dirigible, ¿quién tiene prioridad en caso de que converjan al mismo nivel aproximadamente?",
        opciones: [
            {
    ...
    {
        titulo: "68. En caso de que sepamos que podemos encontrar cizalladura en las aproximaciones de un aeródromo, ¿cómo debemos actuar?",
        opciones: [
            {
                textoRespuesta: "Disminuyendo la velocidad lo suficiente, tanto en aterrizaje como en despegue, para evitar una fuerte descendencia.",
                isCorrect: false
            },
            {
                textoRespuesta: "Aumentando la velocidad lo suficiente, tanto en aterrizaje como en despegue, para evitar una fuerte descendencia.",
                isCorrect: true
            },
            {
                textoRespuesta: "Disminuyendo la velocidad lo suficiente, tanto en aterrizaje como en despegue, para evitar una fuerte ascendencia.",
                isCorrect: false
            },
            {
                textoRespuesta: "Aumentando la velocidad lo suficiente, tanto en aterrizaje como en despegue, para evitar una fuerte ascendencia.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Con virajes hacia la izquierda al aproximarse para aterrizar y hacia la derecha después del despegue, a menos que se ordene lo contrario.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Con virajes hacia la derecha al aproximarse para aterrizar y hacia la izquierda después del despegue, a menos que se ordene lo contrario.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "71. Cuando aplicamos calor al carburador para evitar la formación de hielo, el aire de la mezcla también se calienta. ¿Qué ocurre entonces en un motor atmosférico?",
        opciones: [
            {
    ...
    {
        titulo: "72. Si iniciamos un descenso y no realizamos ningún ajuste a la mezcla de aire y combustible de un motor atmosférico, ¿qué ocurre con ésta?",
        opciones: [
            {
    ...
    {
        titulo: "73. Normalmente, las zonas más sensibles de una aeronave a los daños estructurales causados por altos factores de carga son:",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Realizar un resbale llevando la palanca al viento y pisando con el pie contrario, y llevar el máximo calado de flaps.",
                isCorrect: false
            },
            {
                textoRespuesta: "Realizar un derrape llevando la palanca al viento y pisando con el pie contrario, y llevar el mínimo calado de flaps.",
                isCorrect: false
            },
            {
                textoRespuesta: "Realizar un resbale llevando la palanca al lado contrario del viento y pisando con el mismo pie, y llevar el mínimo calado de flaps.",
                isCorrect: false
            },
            {
                textoRespuesta: "Realizar un resbale llevando la palanca al viento y pisando con el pie contrario, y llevar el mínimo calado de flaps.",
                isCorrect: true
            }
        ]
    },
    {
        titulo: "77. Tras una parada de motor en despegue cuando todavía estamos a poca altura ¿cuál es el procedimiento más seguro que podemos seguir?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "Una vez controlado el avión, intentar divisar un campo donde podamos aterrizar de emergencia y dirigirnos hacia el lugar.",
                isCorrect: false
            },
            {
                textoRespuesta: "Lo primero que hay que hacer es comunicar la emergencia e intentar volver al campo del que hemos salido para aterrizar allí.",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "79. La maniobra de recuperación de una pérdida, si tenemos altura suficiente, no debe suponer grandes problemas para el piloto. ¿Cuál es el primer paso que debe seguir?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Son aquellos que encuadran todas las acciones y comprobaciones que preparan al avión para las diferentes fases de una operación.",
                isCorrect: true
            },
            {
                textoRespuesta: "Son aquellos que encuadran todas las acciones y comprobaciones que preparan al avión para las diferentes fases de una operación de emergencia.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Son los comportamientos de la aeronave ante aquellas situaciones de emergencia en las que se pueda ver envuelta.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "En realidad la temperatura no influirá en la lectura del altímetro, por lo que no presentará este tipo de errores.",
                isCorrect: false
            }
        ]
    },
    {
        titulo: "84. Durante la inspección prevuelo hay algunos aspectos esenciales para el vuelo cuya revisión no se nos puede pasar. Por ejemplo, en el exterior:",
        opciones: [
            {
                textoRespuesta: "Tenemos que drenar los depósitos de combustible, comprobar que la cantidad de aceite no es la adecuada, poner la funda del tubo pitot y asegurarnos de que las tomas estáticas no están obstruidas.",
                isCorrect: false
            },
            {
                textoRespuesta: "Tenemos que drenar los depósitos de combustible, comprobar que la cantidad de aceite es la adecuada, poner la funda del tubo pitot y asegurarnos de que las tomas estáticas no están obstruidas.",
                isCorrect: false
            },
            {
                textoRespuesta: "Tenemos que drenar los depósitos de combustible, comprobar que la cantidad de aceite es la adecuada, quitar la funda del tubo pitot y asegurarnos de que las tomas estáticas no están obstruidas.",
                isCorrect: true
            },
            {
                textoRespuesta: "Tenemos que drenar los depósitos de combustible, comprobar que la cantidad de aceite es la adecuada, quitar la funda del tubo pitot y de las tomas estáticas, y comprobar que éstas no están obstruidas.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "87. Cuando un avión se desplaza se ve sometido a unas fuerzas que medimos con el factor de carga o número n. ¿Cuáles son estas fuerzas?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Primero hay que dejar la palanca o volante en el centro y luego pisar con el pie contrario al sentido del giro.",
                isCorrect: false
            },
            {
                textoRespuesta: "Primero hay que cortar motor, luego dejar la palanca o volante en el centro y por último pisar con el pie contrario al sentido del giro.",
                isCorrect: true
            },
            {
                textoRespuesta: "Primero hay que cortar motor, luego dejar la palanca o volante en el centro y por último pisar con el pie en el sentido del giro.",
                isCorrect: false
            },
            {
                textoRespuesta: "Primero hay que cortar motor, después llevar la palanca o volante al lado contrario del sentido del giro y por último pisar también con el pie contrario.",
                isCorrect: false
            }
        ]
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "A la altitud máxima a la que un ULM es capaz de cumplir correctamente todas las funciones para la que ha sido diseñado.",
                isCorrect: false
            },
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "La velocidad máxima a la que un avión puede entrar en pérdida sin sobrepasar los límites de factor de carga soportados por la aeronave.",
                isCorrect: true
            },
            {
            ...
            {
                textoRespuesta: "La velocidad mínima a la que un avión puede entrar en pérdida sin sobrepasar los límites de factor de carga soportados por la aeronave.",
                isCorrect: false
            },
            {
                textoRespuesta: "La velocidad máxima que puede alcanzar una aeronave usando cualquiera de sus dispositivos sustentadores o frenos aerodinámicos.",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "97. Cuando estemos realizando una aproximación para el aterrizaje con tiempo frío, ¿qué debemos hacer con la calefacción del carburador?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "Apagarla porque en ese momento necesitaremos toda la potencia del motor y ya no será peligrosa la formación de hielo puesto que vamos a aterrizar.",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Debemos dejarla puesta hasta completar el aterrizaje, porque la calefacción del carburador debe estar puesta en todo momento.",
                isCorrect: false
            }
        ]
    },
