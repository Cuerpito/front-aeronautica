const preguntas = [
  ...
  {
    titulo:
      '2. La dirección en la que apunta el eje longitudinal de una aeronave. Expresada generalmente en grados respecto al norte, se llama:',
    opciones: [
      {
        textoRespuesta: 'Ruta',
        isCorrect: false
  ...
  {
    titulo:
      '8. Antes de iniciar un vuelo de navegación en ULM, debemos tener en cuenta algunas cuestiones. De las expuestas, señale la correcta:',
    opciones: [
      {
        textoRespuesta:
          'Basaré la navegación en la técnica observada y a estima, aunque lleve otros instrumentos de apoyo, como puede ser un GPS',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Usaré el GPS como instrumento principal, sólo si está alimentado por el sistema eléctrico del ULM, y no si está alimentado por una batería propia',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Usaré el GPS como instrumento principal para la navegación, apoyándome en las cartas VFR y verificando la ruta',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '12. Sabemos que los mapas representan la superficie terrestre de acuerdo a unas relaciones de las medidas, estas son las escalas 1/1.000.000, 1/500.000, etc. En el supuesto de que tengamos un mapa a escala 1/500.000, 2 cm. En el mapa representan en la realidad.',
    opciones: [
      {
        textoRespuesta: '5 Km.',
        isCorrect: false
  ...
  {
    titulo:
      '14. En aeronáutica no se utiliza la hora local (local time) sino otra hora internacional que puede tener diferencias con la local de cada país normalmente o en determinadas épocas del año, a esta hora la conocemos por:',
    opciones: [
      {
  ...
  {
    titulo:
      '30. Antes de iniciar un vuelo de navegación en ULM, debemos tener en cuenta algunas cuestiones. De las expuestas, señale la correcta:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Calcular el tiempo del vuelo y el consumo de combustible, y no iniciar el vuelo si las condiciones no garantizan la llegada al aeródromo de destino',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '37. Un vuelo VFR, para entrar en un CTR sin permiso del controlador, tiene que mantenerse a 1000 pies y en condiciones VMC',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: false
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'La línea que une dos puntos de la superficie de la Tierra en la menor distancia posible, pero sin mantener el rumbo constante',
        isCorrect: true
      },
      {
        textoRespuesta:
          'La línea que une dos puntos de la superficie de la Tierra en la menor distancia posible, manteniendo el rumbo constante',
        isCorrect: false
      },
      {
        textoRespuesta:
          'La línea que une dos puntos de la superficie de la Tierra manteniendo un rumbo constante, pero no en la menor distancia posible',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '41. Cualquier punto de la superficie de la Tierra puede ser situado exactamente por la intersección de un meridiano y un paralelo',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '46. En un sistema ADF, el emisor del suelo NDB es capaz de proporcionar, por sí mismo, dirección y sentido a la señal emitida.',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: false
  ...
  {
    titulo:
      '53. Antes de iniciar un vuelo de navegación en ULM, debemos tener en cuenta algunas cuestiones. De las expuestas, señale la correcta:',
    opciones: [
      {
        textoRespuesta:
          'Identificaremos bien los puntos de entrada a los tráficos en los aeródromos de destino, pues es en ellos donde tenemos que observar la ficha del aeródromo para estudiar el procedimiento a seguir',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Si llevamos radio, comunicaremos siempre, obligatoriamente. Por esta causa es obligatorio saber las frecuencias de radio de los aeródromos y llevarlas activas',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '54. En un vuelo de navegación, observo que la siguiente referencia a alcanzar se me va quedando cada vez más a la izquierda, ¿qué significa?',
    opciones: [
      {
  ...
  {
    titulo:
      '66. En concreto, la zona LED119 tiene unos límites FL 600/FL 245 ¿podemos seguir nuestra ruta dibujada en la carta, si vemos que pasa por esta zona, si la zona está activada?',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'No, pues sus límites son desde 245 pies de altura hasta 6000 pies de altura, y no podremos pasar no por encima ni por debajo',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '69. Unos de los datos fundamentales que tenemos que conocer del aeródromo de destino, es la elevación del mismo ¿para qué sirve este dato, entre otras cosas?',
    opciones: [
      {
  ...
  {
    titulo:
      '70. La navegación que se realiza por cálculo de la posición del avión según la velocidad del mismo y el tiempo transcurrido en una dirección determinada, se denomina:',
    opciones: [
      {
        textoRespuesta: 'Navegación a estima',
        isCorrect: true
  ...
  {
    titulo:
      '72. La proyección sobre la superficie terrestre de la trayectoria de una aeronave, cuya dirección en cualquier punto se expresa generalmente en grados a partir del norte, se llama.',
    opciones: [
      {
  ...
  {
    titulo:
      '79. Respecto a la figura adjunta de un triángulo de viento. La TAS del avión son 160 Km/h; el viento es de 150º y de 25 km/h de intensidad. ¿Qué rumbo debemos poner para compensar el viento cruzado?',
    opciones: [
      {
        textoRespuesta: '21º',
        isCorrect: false
  ...
  {
    titulo:
      '85. Respecto a la figura adjunta, la distancia entre A y B son 320 Km.; la TAS del avión son 160 Km/h; el viento es de 150º y de 25 km/h de intensidad. ¿Cuál es el tiempo que tardará nuestro avión en ir desde A hasta B?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Un área de control terminal, cuyo límite inferior está a cierta altura sobre el terreno y que engloba a varios aeropuertos controlados',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '100. Dos aeronaves salen del aeropuerto A con dirección al aeropuerto B. La aeronave X sale a las 10:00 h y tiene una TAS de 180 Kt. La aeronave Y sale a las 10:20 horas y tiene una TAS de 140 Kt. A las 11:00 horas, la aeronave X pasa por un punto de notificación. ¿A qué hora pasará la aeronave Y por el mismo punto?',
    opciones: [
      {
