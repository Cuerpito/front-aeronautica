const preguntas = [
  {
    titulo:
      '1. En el hemisferio Norte, el error de inclinación de la brújula hace que durante la navegación, mientras viramos, tengamos que:',
    opciones: [
      {
  ...
  {
    titulo:
      '2. Cuando trazamos una línea de ruta en nuestra carta de navegación observamos que ésta cruza una zona calificada como LED, cuyos límites son FL145/1500 ft AGL. ¿Debemos modificar nuestra ruta?',
    opciones: [
      {
        textoRespuesta:
          'No, pues aunque se trata de una zona prohibida, el límite inferior se encuentra por encima de las limitaciones a las que está sometido un ULM',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'No, pues aunque se trata de una zona peligrosa, el límite inferior se encuentra por encima de las limitaciones a las que está sometido un ULM',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '7. Durante la navegación, indique en cuál de los siguientes momentos no recibiremos, o lo haremos con dificultad, las señales del VOR:',
    opciones: [
      {
  ...
  {
    titulo:
      '9. De los siguientes equipos, indique cuál es capaz de proporcionar la distancia entre la aeronave y la estación emisora:',
    opciones: [
      {
        textoRespuesta: 'NDB',
        isCorrect: false
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Nunca debemos doblar la carta que vamos a utilizar durante el vuelo, pues tiene que ser visible en su totalidad',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Se debe establecer un primer punto de situación para comenzar la ruta después de realizar la maniobra de despegue',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Si nos encontramos en el hemisferio Sur y queremos virar al Norte, debemos parar antes de que la brújula indique 360º',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Si nos encontramos en el hemisferio Norte y queremos virar al Norte, debemos parar antes de que la brújula indique 360º',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Si nos encontramos en el hemisferio Norte y queremos virar al Norte, debemos parar después de que la brújula indique 360º',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Si nos encontramos en el hemisferio Sur y queremos virar al Sur, debemos parar después de que la brújula indique 180º',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '19. Para el piloto de ULM es conveniente conocer las condiciones meteorológicas con las que se va a encontrar en ruta. Pero, ¿cómo puede obtener esa información en vuelo?',
    opciones: [
      {
  ...
  {
    titulo:
      '20. Si tenemos un rumbo geográfico de 110º, con una declinación de 10ºE y una desviación de 5ºW, ¿cuál es nuestro rumbo magnético?',
    opciones: [
      {
        textoRespuesta: '115º',
        isCorrect: false
  ...
  {
    titulo:
      '23. Si volamos a una velocidad de 310 km/h, con viento en calma, y queremos recorrer una distancia de 556 mn, ¿cuánto tiempo emplearemos?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Su proyección es acimutal, es decir, la superficie de la Tierra se representa en un plano tangente a la esfera',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Los meridianos y paralelos se cortan perpendicularmente, la escala utilizada es la misma en toda la carta y los accidentes geográficos se representan con su misma forma',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Los meridianos y paralelos no se cruzan, la escala utilizada es la misma en toda la carta y los accidentes geográficos se representan con su misma forma',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '26. El aeropuerto Adolfo Suárez Madrid-Barajas cuenta con dos pistas 18/36 y otras dos 14/32. ¿Cuál de ellas utilizaremos con viento de 200º a 20kt?',
    opciones: [
      {
  ...
  {
    titulo:
      '31. Tenemos una carta OACI con una escala 1:500.000 diseñada para vuelo visual. En ella trazamos una ruta en línea recta que mide 8 cm. ¿Cuánta distancia recorre esa ruta?',
    opciones: [
      {
  ...
  {
    titulo:
      '34. Durante la navegación podemos encontrar zonas del espacio aéreo calificadas como Prohibidas, Peligrosas o Restringidas. ¿Dónde debemos consultar la actividad de estas zonas?',
    opciones: [
      {
  ...
  {
    titulo:
      '36. Si estamos en la pista 21 de un aeródromo y tenemos viento de 250º a 17kt, ¿cuáles son, aproximadamente, las componentes de viento en cara y viento cruzado que tenemos?',
    opciones: [
      {
  ...
  {
    titulo:
      '38. ¿Qué tipo de navegación estaremos llevando a cabo si nos guiamos por cálculos basados en tiempo, velocidad, distancia y dirección?',
    opciones: [
      {
        textoRespuesta: 'Navegación a estima',
        isCorrect: true
  ...
  {
    titulo:
      '39. En aviación ligera basaremos nuestra ruta en la navegación observada y a estima, mientras que el GPS se usará únicamente como apoyo:',
    opciones: [
      {
        textoRespuesta: 'Verdadero',
        isCorrect: true
  ...
  {
    titulo:
      '42. Si durante un vuelo recto y nivelado mantenemos una trayectoria hacia 040º, ¿cuál de los siguientes sería el viento más favorable?',
    opciones: [
      {
  ...
  {
    titulo:
      '53. Estamos volando a FL030, por lo que el alcance de la señal VHF llega aproximadamente hasta las 69 millas náuticas. ¿Cuál será el alcance de recepción si volamos a FL050?',
    opciones: [
      {
        textoRespuesta: '87mn.',
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Espacio aéreo controlado, que son los de clase A, B, C, D y E; y espacio aéreo no controlado, los de clase F y G',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Espacio aéreo controlado, que son los de clase A, B, C y D; y espacio aéreo no controlado, los de clase E, F y G',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '60. Si en nuestro mapa de navegación aeronáutica trazamos una ruta en línea recta de 450 km, estaríamos trazando una línea:',
    opciones: [
      {
  ...
  {
    titulo:
      '63. Si en nuestra ruta en vuelo, para ir de un punto a otro, mantenemos un rumbo constante, ¿cuál es la línea que estamos siguiendo?',
    opciones: [
      {
  ...
  {
    titulo:
      '66. En ningún caso el aeródromo de alternativa especificado en nuestro Plan de Vuelo podrá ser el mismo que el de partida:',
    opciones: [
      {
        textoRespuesta: 'Falso',
        isCorrect: true
  ...
  {
    titulo:
      '69. La distancia que hay entre un punto A y un punto B es de 162 mn. Si vamos a una velocidad de 300 km/h, con viento en calma, ¿cuánto tardaremos en recorrer esa distancia?',
    opciones: [
      {
  ...
  {
    titulo:
      '70. Si el nivel de transición en España está establecido en 6.000’ y estamos en nivel de vuelo FL080, ¿con qué deberemos tener ajustado nuestro altímetro?',
    opciones: [
      {
        textoRespuesta: 'QNE',
        isCorrect: true
  ...
  {
    titulo:
      '73. Al realizar la planificación de nuestro vuelo hemos estimado como hora de llegada las 12:00h local. Si estamos en la Península Ibérica en España, ¿cuál será la hora Z?',
    opciones: [
      {
  ...
  {
    titulo:
      '78. ¿Cuál es el aparato que permite a un controlador conocer la situación exacta del avión en caso de que nos hayamos perdido?',
    opciones: [
      {
  ...
  {
    titulo:
      '80. Tenemos que recorrer una distancia de 500 km con una GS de 200kt. ¿Cuánto tiempo emplearemos en realizar el recorrido?',
    opciones: [
      {
  ...
  {
    titulo:
      '81. Con un rumbo verdadero de 110º, un rumbo magnético de 100º y una desviación de 2ºW, ¿qué deberá marcar nuestro compás?',
    opciones: [
      {
        textoRespuesta: '102º',
        isCorrect: true
  ...
  {
    titulo:
      '82. En el hemisferio Norte, qué declinación tenemos si nuestro rumbo geográfico es de 280º, el magnético es de 295º y la desviación es de 5º W.',
    opciones: [
      {
  ...
  {
    titulo:
      '86. Si en una carta de navegación encontramos un espacio aéreo calificado como LEP, cuyo límite superior está indicado en FL060, ¿podremos volar en esa zona con un ultraligero?',
    opciones: [
      {
        textoRespuesta:
          'No, ya que es una zona prohibida cuyo límite superior es de 6.000’, por lo que no podríamos superarlo con un ULM',
        isCorrect: true
      },
      {
        textoRespuesta:
          'No, ya que es una zona peligrosa cuyo límite superior es de 6.000’, por lo que no podríamos superarlo con un ULM',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '92. Salimos un día de verano a las 06:00h UTC de un punto hacia otro en línea recta con una TAS de 150kt. La distancia entre los puntos es de 300 millas náuticas. ¿A qué hora local llegaremos, teniendo en cuenta que estamos en España?',
    opciones: [
      {
  ...
  {
    titulo:
      '96. Estamos en la pista 14 del aeropuerto Adolfo Suárez Madrid-Barajas. Tenemos viento de 200º a 30kt. ¿Qué componentes de viento tenemos aproximadamente?',
    opciones: [
      {
  ...
  {
    titulo:
      '100. En España, a excepción de Canarias, durante el horario de verano, ¿cómo podemos conocer la hora Z (zulú) a través de nuestra hora local?',
    opciones: [
      {
