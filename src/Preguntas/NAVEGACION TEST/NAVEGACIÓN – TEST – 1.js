const preguntas = [
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "La distancia angular del punto considerado, medida sobre el meridiano y tomando como referencia el Ecuador, y puede ser Norte o Sur",
                isCorrect: false
            },
            {
                textoRespuesta: "La distancia angular del punto considerado, medida sobre el paralelo y tomando como referencia el Meridiano 0, y puede ser Este u Oeste",
                isCorrect: true
            },
            {
                textoRespuesta: "La distancia angular del punto considerado, medida sobre el meridiano y tomando como referencia el Ecuador, y puede ser Este u Oeste",
                isCorrect: false
            },
            {
                textoRespuesta: "La distancia angular del punto considerado, medida sobre el paralelo y tomando como referencia el Meridiano 0, y puede ser Norte o Sur",
                isCorrect: false
            }
        ]
    },
    ...
    {
        titulo: "6. Hemos calculado un vuelo en línea recta dividido en 5 tramos de 20 minutos de duración cada uno. Al ejecutar el vuelo nos damos cuenta que el primer tramo hemos tardado en realizarlo 25 minutos. Habiendo mantenido una velocidad constante ¿qué puedo esperar?",
        opciones: [
            {
    ...
    {
        titulo: "7. Como el norte geográfico y el magnético no están en el mismo punto. Para calcular la situación magnética habrá que introducir una corrección llamada",
        opciones: [
            {
    ...
    {
        titulo: "9. Antes de iniciar un vuelo de navegación en ULM, debemos tener en cuenta algunas cuestiones. De las expuestas, señale la correcta:",
        opciones: [
            {
                textoRespuesta: "Volar en los sotaventos de las montañas podría ser peligroso por las turbulencias existentes en caso de existir viento",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "Es conveniente preparar la ruta con campos de vuelo y/o aeródromos alternativos donde aterrizar en caso de necesidad",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "11. En el cálculo de la gasolina necesaria para la realización de un vuelo de navegación, ¿Cuál de los siguientes factores se ha de tener en cuenta?",
        opciones: [
            {
    ...
    {
        titulo: "19. Conociendo TAS = 140 Kt, ruta verdadera = 120 grados y viento = 90 grados/30 Kt, declinación 0º, calcular el rumbo Verdadero. y la velocidad sobre el suelo GS.",
        opciones: [
            {
    ...
    {
        titulo: "28. La distancia entre dos puntos es de 42 milímetros en una carta escala 1:1.600.000. La distancia real entre ambos es de:",
        opciones: [
            {
    ...
    {
        titulo: "38. Para ir a un destino con rumbo geográfico 90º ¿Qué rumbo habrá que poner en la brújula estando en el hemisferio Norte y con declinación 4ºW?",
        opciones: [
            {
                textoRespuesta: "90º",
                isCorrect: false
    ...
    {
        titulo: "41. En una carta trazamos una ruta y vemos que cruza un espacio aéreo peligroso cuyos límites son FL140/2500AGL, ¿cómo procederemos?",
        opciones: [
            {
            ...
            {
                textoRespuesta: "Seguiremos la ruta dibujada en la carta, ya que cumpliendo las limitaciones para ULM no entraré en ese espacio",
                isCorrect: true
            },
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Indicador de lugar OACI para España peninsular, seguido de la letra D, espacio aéreo peligroso, y su identificación",
                isCorrect: true
            },
            {
                textoRespuesta: "Código OACI para España peninsular, seguido de la letra D, espacio aéreo restringido, y su identificación para consultar el horario en el AIP",
                isCorrect: false
            },
            {
    ...
    {
        titulo: "45. Si durante un vuelo con viento lateral de la izquierda, compruebo que la referencia que tengo debajo no se corresponde con la que debería tener, buscaré la correcta inicialmente:",
        opciones: [
            {
    ...
    {
        titulo: "48. Respecto a la figura adjunta de un triángulo de viento, la TAS del avión son 160 Km/h; el viento es de 150º y de 25 km/h de intensidad. Teniendo en cuenta que el viento es completamente cruzado, ¿cuál es la velocidad respecto al suelo (GS)?",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "a) Los paralelos son siempre iguales; los meridianos van disminuyendo de tamaño a medida que se acercan a los Polos",
                isCorrect: false
            },
            {
            ...
            {
                textoRespuesta: "d) Los meridianos son siempre iguales; los paralelos van disminuyendo de tamaño a medida que se acercan a los Polos",
                isCorrect: true
            }
        ]
    },
    ...
    {
        titulo: "59. En una carta las elevaciones del terreno vienen medidas por un número y un punto negro con la situación exacta. Ese número que indica la elevación esta expresado en:",
        opciones: [
            {
    ...
    {
        titulo: "63. Con los siguientes datos Track­ 050 Rumbo­ 040 Velocidad relativa 75 kts Velocidad sobre el suelo 65 kts Determine dirección y velocidad del viento:",
        opciones: [
            {
    ...
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Un área de control, en torno a un aeropuerto controlado, cuyo límite inferior está a cierta altura sobre el terreno",
                isCorrect: true
            },
            {
    ...
    {
        titulo: "78. La proyección es el método usado para llevar a una superficie plana la curva de una esfera. Sin entrar en grandes detalles, las proyecciones se clasifican en:",
        opciones: [
            {
    ...
    {
        titulo: "84. Estos cuatro ULM siguen la misma trayectoria, con las mismas condiciones de viento cruzado, ¿cuáles de ellos tendrá que cambiar más su rumbo indicado para corregir la deriva?",
        opciones: [
            {
    ...
    {
        titulo: "90. Todos los puntos que están en el meridiano de Greenwich tienen longitud Cero grados, los que están en el antimeridiano de Greenwich tienen longitud 180 grados",
        opciones: [
            {
                textoRespuesta: "Verdadero",
                isCorrect: true
    ...
    {
        titulo: "93. Siempre que efectuemos un vuelo en ultraligero, para hallar el rumbo magnético debemos ……….. La declinación al rumbo geográfico:",
        opciones: [
            {
    ...
    {
        titulo: "95. Durante un vuelo de navegación, observo que la siguiente referencia a alcanzar se va quedando a la derecha a causa del viento ¿cómo actuaré?",
        opciones: [
            {
    ...
    {
        titulo: "99. Antes de iniciar un vuelo de navegación en ULM, debemos tener en cuenta algunas cuestiones. De las expuestas, señale la correcta:",
        opciones: [
            {
