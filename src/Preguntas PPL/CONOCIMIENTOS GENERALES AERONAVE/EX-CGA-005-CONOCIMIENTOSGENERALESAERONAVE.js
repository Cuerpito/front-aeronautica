const preguntas = [
  {
    titulo: "1 - Al aumentar la altitud sin ajustar la relación de la mezcla, las prestaciones del motor de émbolo se ven afectadas por",
    opciones: [
      {
  ...
  {
    titulo: "10 - Cual de las siguientes afirmaciones cualitativas sobre hélices de paso fijo optimizadas para vuelo en crucero, es cierta en cuanto al despegue? El ángulo de ataque",
    opciones: [
      {
