const preguntas = [
  ...
  {
    titulo: "11 - Durante un vuelo con una velocidad normal de crucero, si uno de los magnetos falla por completo, cual será la primera consecuencia",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Disipar la carga estática del avión en vuelo de modo que se eviten las interferencias en la radio a causa de la electricidad estática",
        isCorrect: true
      },
      {
  ...
  {
    titulo: "15 - Durante el ascenso, con valor constante de Presión de Admisión de Aire (MAP) y de indicación de R.P.M del motor y con un ajuste de mezcla también constante, la potencia desarrollada por un motor alternativo",
    opciones: [
      {
  ...
  {
    titulo: "17 - En un diagrama del ciclo ideal de un motor con ciclo Otto, esta limitado por las siguientes líneas de cambio de estado gaseoso",
    opciones: [
      {
  ...
  {
    titulo: "18 - La potencia de un motor de pistón disminuye durante un ascenso con una posición constante de la palanca de gases, debido a la disminución de",
    opciones: [
      {
  ...
  {
    titulo: "22 - Volando por un terreno que está a 1.200 metros de altitud, ¿Cuál es el nivel de vuelo más bajo utilizable para nuestro vuelo?",
    opciones: [
      {
        textoRespuesta: "065",
        isCorrect: true
