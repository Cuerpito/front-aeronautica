const preguntas = [
  {
    titulo: "1 - En caso de fallo de motor en vuelo, las palas de una hélice de velocidad constante que impulsan a un monomotor que carezca de sistema de abanderamiento",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta: "Indicará una lectura inferior en una magnitud equivalente a la lectura indicada en el momento en que el instrumento haya quedado bloqueado",
        isCorrect: false
      },
      {
  ...
  {
    titulo: "16 - El volumen de combustible y el volumen de aire que entra en el carburador. Al aumentar la altitud sin ajustar la relación de mezcla, las prestaciones del motor de embolo se ven afectadas por",
    opciones: [
      {
  ...
  {
    titulo: "22 - En caso de fallo de motor durante un vuelo, las palas de una hélice de velocidad constante en un monomotor que no está equipado para abanderar la hélice",
    opciones: [
      {
