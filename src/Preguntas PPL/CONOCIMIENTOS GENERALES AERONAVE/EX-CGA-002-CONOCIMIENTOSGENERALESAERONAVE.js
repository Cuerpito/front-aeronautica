const preguntas = [
  ...
  {
    titulo: "6 - Durante el ascenso, con valor constante de Presión de Admisión de Aire (MAP) y de indicación de RPM del motor y con un ajuste de mezcla también constante, la potencia desarrollada por un motor alternativo",
    opciones: [
      {
  ...
  {
    titulo: "12 - ¿Cuál de los factores siguientes con la mayor probabilidad aumentaría la posibilidad de detonación que ocurre dentro de un motor de pistón?",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Con una relación de mezcla ligeramente rica el motor tiende a calentarse más rápidamente que con una mezcla ligeramente pobre",
        isCorrect: false
      },
      {
