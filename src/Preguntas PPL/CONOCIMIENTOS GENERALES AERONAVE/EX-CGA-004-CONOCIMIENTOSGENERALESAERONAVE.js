const preguntas = [
  ...
  {
    titulo: "4 - Al cambiar de potencia en motores equipados con hélices de velocidad constante, la sobrecarga del motor se evita mediante",
    opciones: [
      {
  ...
  {
    titulo: "5 - Al aumentar la TAS, el ángulo de paso de una hélice de velocidad constante (no se mueven las palancas de RPM ni de MAP)",
    opciones: [
      {
  ...
  {
    titulo: "10 - La potencia desarrollada por un motor de pistón disminuye durante el ascenso con ajuste del mando de gases constante, debido a la disminución de",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "El aceite proporciona la función de amortiguado y el nitrógeno proporciona la función de disipación del calor",
        isCorrect: false
      },
      {
  ...
  {
    titulo: "16 - Durante un vuelo con una velocidad normal de crucero, si uno de los magnetos falla por completo, cual será la primera consecuencia",
    opciones: [
      {
