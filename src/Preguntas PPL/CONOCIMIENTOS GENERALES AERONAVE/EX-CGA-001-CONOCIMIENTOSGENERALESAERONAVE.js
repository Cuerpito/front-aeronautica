const preguntas = [
  ...
  {
    titulo: "5 - La combinación correcta de paso de hélice (1), y posición de la palanca de la hélice (2) en el momento de soltar frenos para el despegue es",
    opciones: [
      {
  ...
  {
    titulo: "12 - Cual de las siguiente afirmaciones cualitativas sobre las hélices de paso fijo optimizadas para el vuelo en crucero es cierta en cuanto al despegue? El ángulo de ataque",
    opciones: [
      {
  ...
  {
    titulo: "19 - Los errores en las lecturas del altímetro originadas por la variación de la presión estática cerca de la sonda de estática se conocen como",
    opciones: [
      {
