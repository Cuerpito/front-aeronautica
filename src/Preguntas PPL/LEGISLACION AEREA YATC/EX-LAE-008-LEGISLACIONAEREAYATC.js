const preguntas = [
  {
    titulo:
      '1 - Justo antes de llegar a la plataforma, al rodar, inadvertidamente sobre la hierba, una rueda se mete en un hoyo causando serios desperfectos al avión y obligando a la tripulación a demorar la salida',
    opciones: [
      {
        textoRespuesta:
          'Se trata de un incidente y el piloto al mando deberá informar debidamente a la autoridad aeroportuaria antes de transcurridas 48 horas tras el mismo',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'No es más que una irregularidad en la operación, la tripulación debe informar al operador acerca del retraso ocasionado por la necesaria reparación a efectuar',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Al no producirse daños personales y dado que el vuelo ya ha concluido, las medidas a adoptar corresponden a la compañía aseguradora, a los talleres de reparación, al operador de la aeronave y al personal encargado de las pistas y las calles de rodadura',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '8 - Cuando se pone en evidencia que un avión tiene dificultades la decisión de iniciar las fases de alerta es una responsabilidad que recae sobre:',
    opciones: [
      {
  ...
  {
    titulo:
      '10 - ¿Que deberá hacer el piloto de un avión en el circuito de tráfico de un aeropuerto para alertar de sus problemas de comunicación por radio si se ve obligado a aterrizar sin requerir ayuda inmediata?:',
    opciones: [
      {
  ...
  {
    titulo:
      '11 - Suponiendo una pista de 2000 metros de longitud, y sin que se hayan establecido las posiciones de espera en rodaje, los aviones no deberán realizar esperas a menos de la siguiente distancia de la pista en servicio:',
    opciones: [
      {
