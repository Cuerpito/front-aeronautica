const preguntas = [
  ...
  {
    titulo:
      '2 - El servicio de información de vuelo deberá prestarse a todos los vuelos a los que presumiblemente afecte dicha información, y que:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Se les presten servicios de control de trafico aéreo y sean de alguna manera conocidos por los centros que prestan servicios de trafico aéreo',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Sean conocidos por los correspondientes servicios de tráfico aéreo, por medio del plan de vuelo cumplimentado',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '4 - ¿En qué sección del AIP se contiene información relativa a áreas y /o rutas para los que se facilitan servicios meteorológicos?',
    opciones: [
      {
        textoRespuesta: 'AD',
        isCorrect: false
  ...
  {
    titulo:
      '5 - La distancia vertical entre un nivel, punto u objeto considerado como punto y una referencia especificada corresponde a:',
    opciones: [
      {
  ...
  {
    titulo:
      '6 - Cuando no se disponga de un radar de vigilancia secundario SSR la identificación radar puede lograrse mediante uno de los siguientes procedimientos',
    opciones: [
      {
  ...
  {
    titulo:
      '13 - Se denomina región de información de vuelo (FIR) a un espacio aéreo entre cuyos limites se prestan los siguientes servicios:',
    opciones: [
      {
  ...
  {
    titulo:
      '14 - Siempre que los mínimos de separación no se apliquen, cuales de los vuelos siguientes se considera trafico esencial respecto a otro.',
    opciones: [
      {
