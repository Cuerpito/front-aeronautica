const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Los centros de control de tráfico aéreo, los centros de información de vuelo o las oficinas de notificación de los servicios de tránsito aéreo.",
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo: "8 - El “Código de Referencia Aeroportuaria” es un código compuesto por dos elementos relacionados con las dimensiones y con las características de las prestaciones del avión. Estos elementos son combinaciones de letra y numero como se refleja en el siguiente:",
    opciones: [
      {
        textoRespuesta: "2B",
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta: "Centro de Control de Área – Centro de Asesoramiento – Centro de Información de Vuelo – Unidad de Control de Aproximaciones y Torre.",
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta: "Centro de Control de Área – Centro de Información de Vuelo – Unidad de Control de Aproximaciones – Torre de Control del Aeródromo y oficina de notificación de los Servicios de Transito Aéreo.",
        isCorrect: true
      },
      {
  ...
  {
    titulo: "15 - Una noticia conteniendo información de normas del Aire, Servicio de Trafico Aéreo y Procedimientos de Navegación Aérea se distribuye antes de la fecha efectiva de entrada en vigor en:",
    opciones: [
      {
