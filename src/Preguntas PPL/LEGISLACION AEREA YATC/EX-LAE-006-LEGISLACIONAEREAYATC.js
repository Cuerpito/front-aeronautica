const preguntas = [
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "No es necesario informar al avión puesto que la identificación radar se supone a no se ser que se informe de lo contrario",
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Los tráficos que se encuentran en la zona de movimientos y aquellos en vuelo en las proximidades del aeropuerto.",
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo: "11 - El avión A, con autorización ATC, vuela en condiciones VMC dentro de los límites de un área controlada. El avión B, sin autorización ATC, se aproxima a la misma altitud y en rumbo de colisión. ¿Quién tiene preferencia?",
    opciones: [
      {
  ...
  {
    titulo: "12 - La información concerniente a las tasas de aeropuertos y servicios de navegación aérea en que sección del AIP se encuentran:",
    opciones: [
      {
        textoRespuesta: "FAL",
        isCorrect: false
  ...
  {
    titulo: "13 - Una luz roja intermitente emitida desde la torre de control durante la aproximación para el aterrizaje de un avión significa que:",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Pista en uso, ajuste de altímetro, códigos transponder, instrucciones de nivel, instrucciones de rumbo y velocidad.",
        isCorrect: true
      },
      {
        textoRespuesta: "Pista en uso, visibilidad, viento en superficie, instrucciones de rumbo, ajuste de altímetro, viento en superficie, visibilidad y temperatura a nivel de aeródromo",
        isCorrect: false
      },
      {
