const preguntas = [
  ...
  {
    titulo: "2 - ¿Cuál de las siguientes medidas deberán adoptarse en caso de que un avión en vuelo controlado se desvié de la derrota autorizada?:",
    opciones: [
      {
  ...
  {
    titulo: "3 - Todo aviso conteniendo información relativa a la seguridad en vuelo, Navegación Aérea o cualquier otro asunto de naturaleza técnica, administrativa o legal, que tenga su origen en el AIS, se denomina:",
    opciones: [
      {
  ...
  {
    titulo: "4 - Salvo que se obtenga autorización por un centro ATC un vuelo VFR no podrá acceder (ni abandonar), una zona de control con unas condiciones inferiores a:",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "A todos los vuelos controlados, a todo avión que se le sepa- o suponga- sujeto a interferencias ilegales, y en la medida de todo lo posible a cualquier avión que haya cumplimentado un plan de vuelo o en caso contrario que sea conocido por el ATS.",
        isCorrect: true
      },
      {
      ...
      {
        textoRespuesta: "En la medida de lo posible a cualquier avión que haya cumplimentado un plan de vuelo o que en caso contrario sea conocido por el ATS.",
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo: "7 - Cuando control da una instrucción a una aeronave y esta no puede cumplirla o la situación no aconseja que lo haga, la aeronave deberá:",
    opciones: [
      {
  ...
  {
    titulo: "12 - En caso de demora de un vuelo no controlado con plan de vuelo presentado, éste deberá corregirse por uno nuevo cuando:",
    opciones: [
      {
  ...
  {
    titulo: "15 - De acuerdo con lo establecido en el Anexo 13 de la Convención de Chicago, ¿sobre quien recae la responsabilidad de iniciar las investigaciones posteriores a un accidente?:",
    opciones: [
      {
