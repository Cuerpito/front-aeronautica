const preguntas = [
  {
    titulo:
      '1 - Una luz roja intermitente emitida desde la torre de control durante la aproximación para el aterrizaje de un avión significa que:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          '5 millas náuticas desde el centro de los aeródromos afectados y en la dirección por la que se pueden efectuar las aproximaciones.',
        isCorrect: true
      },
      {
        textoRespuesta:
          '20 millas desde el centro de los aeródromos afectados y en la dirección por la que se pueden efectuar las aproximaciones.',
        isCorrect: false
      },
      {
        textoRespuesta:
          '10 millas desde el centro de los aeródromos afectados y en la dirección por la que se pueden efectuar las aproximaciones.',
        isCorrect: false
      },
      {
        textoRespuesta:
          '15 millas desde el centro de los aeródromos afectados y en la dirección por la que se pueden efectuar las aproximaciones.',
        isCorrect: false
      }
    ]
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Identificación del avión, posición, hora, Velocidad verdadera, altitud o nivel de vuelo, próxima posición y hora estimada sobre la misma',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Identificación del avión, posición, hora, Velocidad verdadera, altitud o nivel de vuelo, próxima posición y hora estimada sobre la misma y siguiente punto significativo',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Identificación del avión, posición, hora, Velocidad verdadera próxima posición y hora estimada sobre la misma',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '8 - El avión A, con autorización ATC, vuela en condiciones VMC dentro de los límites de un área controlada. El avión B, sin autorización ATC, se aproxima a la misma altitud y en rumbo de colisión. ¿Quién tiene preferencia?',
    opciones: [
      {
  ...
  {
    titulo:
      '10 - Cuando te dirige por vectores hasta una aerovía, que quiere decir el control radar cuando dice que asuma su propia navegación?',
    opciones: [
      {
  ...
  {
    titulo:
      '11 - Todo aviso conteniendo información relativa a la seguridad en vuelo, navegación aérea, o cualquier otro asunto de naturaleza técnica, administrativa o legal, y que tenga por origen el AIS de cualquier estado se denomina:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Un espacio aéreo controlado que se extiende hacia arriba desde la superficie de la tierra hasta un limite especificado.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '16 - Un vuelo controlado debe informar a la Unidad ATC cuando la TAS tenga expectativas de variar con respecto a lo marcado en el plan de vuelo en más o menos:',
    opciones: [
      {
        textoRespuesta: '5%.',
        isCorrect: true
