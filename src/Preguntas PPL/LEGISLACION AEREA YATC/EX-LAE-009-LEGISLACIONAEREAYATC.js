const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta: "La longitud total del avión más largo que suela utilizar el aeropuerto, así como la máxima anchura de su fuselaje",
        isCorrect: true
      },
      {
      ...
      {
        textoRespuesta: "La longitud total del avión más largo que suela utilizar el aeropuerto, así como el máximo peso de su fuselaje",
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Aplicar los criterios de separación entre aviones despachando y manteniendo el flujo ordenado del tráfico aéreo",
        isCorrect: false
      },
      {
        textoRespuesta: "Prevenir colisiones entre aviones, así como entre aviones y obstáculos en el área de maniobras despachando y manteniendo un flujo ordenado de tráfico aéreo",
        isCorrect: true
      },
      {
        textoRespuesta: "Prevenir las colisiones entre tráficos aéreos controlados, despachando y manteniendo un flujo ordenado del tráfico aéreo",
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo: "6 - En las reglas de vuelo visual, salvo que se obtenga autorización por parte de un centro ATC, un vuelo VFR no despegará o aterrizará en un aeródromo dentro de la CTR, o entrada en circuito de tráfico o zona del aeródromo cuando:",
    opciones: [
      {
  ...
  {
    titulo: "7 - ¿Qué quiere decir la orden del control de salidas “vuelva a navegación propia” una vez vectorizado hacia una aerovía?",
    opciones: [
      {
  ...
  {
    titulo: "12 - Todo aviso conteniendo información relativa a seguridad en vuelo, navegación aérea, o a cualquier asunto de naturaleza técnica, administrativa o legal, y que tenga por origen el AIS de cualquier estado se denomina:",
    opciones: [
      {
