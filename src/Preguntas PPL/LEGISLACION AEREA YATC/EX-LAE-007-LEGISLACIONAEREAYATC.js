const preguntas = [
  ...
  {
    titulo:
      '3 - Cuando el transponder no este disponible, la identificación de una aeronave se llevara a cabo de una de las siguientes formas',
    opciones: [
      {
  ...
  {
    titulo:
      '6 - ¿Que deberá hacer el piloto de un avión en el circuito de trafico de un aeropuerto para alertar de sus problemas de comunicación por radio si se ve obligado a aterrizar sin requerir ayuda inmediata?:',
    opciones: [
      {
  ...
  {
    titulo:
      '7 - En caso de demora de un vuelo no controlado con plan de vuelo presentado, éste deberá corregirse por uno nuevo cuando:',
    opciones: [
      {
  ...
  {
    titulo:
      '9 - Todo avión que sea interceptado por otro, si esta equipado con transpondedor SSR, deberá –salvo que el centro ATS correspondiente ordene lo contrario- seleccionar uno de los siguientes codigos en modo “A”?',
    opciones: [
      {
        textoRespuesta: '7500',
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Tras recibir cualquier informe meteorológico oficial, con independencia de las variaciones en el contenido o en los valores recogidos.',
        isCorrect: true
      },
      {
      ...
      {
        textoRespuesta:
          'Solamente cuando las condiciones meteorológicas cambien lo suficiente como para hacer necesario un cambio de la pista en servicio o de la aproximación por instrumentos que se este utilizando.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Cada 30 minutos cuando las condiciones meteorológicas se encuentren por debajo de las correspondientes a los vuelos VFR; en caso contrario, cada 60 minutos.',
        isCorrect: false
      }
    ]
  },
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Levantando los brazos y las manos con los dedos extendidos horizontalmente hacia delante y cerrando los puños a continuación.',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '13 - ¿Quién es responsable de acuerdo al Anexo 13 de la convención de Chicago de iniciar la investigación de un accidente?:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Su avión ha sido identificado en la pantalla de radar, y recibirá instrucciones radar en vuelo hasta que la identificación radar concluya.',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Recibirá avisos sobre tráficos hasta que se le informe de la conclusión del servicio o de la perdida del contacto radar.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'El ATC recibe la señal de su transpondedor y se le facilitaran vectores y avisos sobre tráficos hasta que se le notifique la perdida del contacto radar.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Su avión ha sido identificado y será separado de los demás tráficos mientras permanezca en contacto con este centro de control radar.',
        isCorrect: false
      }
    ]
  },
