const preguntas = [
  {
    titulo: "1 - La zona de parada (“STOP WAY”) es un área de terreno definida y rectangular dispuesta al final de la carrera de despegue disponible y preparada para que:",
    opciones: [
      {
  ...
  {
    titulo: "2 - Si durante la intercepción se establece contacto por radio pero no es posible utilizar un lenguaje común, ¿Qué deberá pronunciar el avión interceptado para comunicar que no puede cumplir las instrucciones recibidas?:",
    opciones: [
      {
  ...
  {
    titulo: "3 - ¿Qué debería hacer un piloto de avión para alertar de sus problemas de comunicación por radio si se ve obligado a aterrizar sin requerir ayuda inmediata?",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Un espacio aéreo controlado que se extiende hacia arriba desde la superficie de la tierra hasta un límite especificado.",
        isCorrect: false
      },
      {
  ...
  {
    titulo: "6 - Rodando por la plataforma, el avión mete la rueda en la hierba causando serios daños estructurales al avión, ¿qué debe hacer el piloto?",
    opciones: [
      {
  ...
  {
    titulo: "11 - Una desviación de la TAS, con respecto a la consignada en el plan de vuelo, deberá ser notificada cuando sea superior al:",
    opciones: [
      {
        textoRespuesta: "3%.",
        isCorrect: false
  ...
  {
    titulo: "13 - ¿Que deberá hacer el piloto de un avión en el circuito de tráfico de un aeropuerto para alertar de sus problemas de comunicación por radio si se ve obligado a aterrizar sin requerir ayuda inmediata?:",
    opciones: [
      {
        textoRespuesta: "Encender y apagar repetidamente las luces de aterrizaje.",
        isCorrect: true
  ...
  {
    titulo: "16 - Referente a un plan de vuelo ATC, en caso de retraso de un vuelo controlado, el plan de vuelo transmitido debe ser enmendado o cancelado y emitido un nuevo plan de vuelo se debe transmitir cuando el retraso es superior a:",
    opciones: [
      {
