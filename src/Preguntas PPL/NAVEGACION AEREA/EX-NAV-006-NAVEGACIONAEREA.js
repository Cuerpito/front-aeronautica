const preguntas = [
  ...
  {
    titulo: "2 - Una aeronave lleva una velocidad respecto al suelo de 105 kts, la distancia entre A y B es de 103 NM. ¿Cuánto tardará en llegar de A a B?",
    opciones: [
      {
  ...
  {
    titulo: "3 - Complete la siguiente afirmación respecto a la declinación magnética: los valores en la carta y referencias a la declinación magnética normalmente varían anualmente debido:",
    opciones: [
      {
      ...
      {
        textoRespuesta: "Al desplazamiento de los polos magnéticos que originan un aumento o disminución de los valores numéricos en todas partes.",
        isCorrect: true
      },
      {
        textoRespuesta: "A una fuerte disminución del campo magnético que originan una disminución de los valores numéricos en todas partes.",
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo: "6 - Se observa una isla 15º a la izquierda.Nuestro rumbo magnético es de 120º, la declinación es de 17º W. Hallar el rumbo verdadero para ir a la isla:",
    opciones: [
      {
        textoRespuesta: "88",
        isCorrect: true
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta: "En que los equipos NDB de tierra se desconectan automáticamente cuando hay tormenta, dejando de oírse el código morse.",
        isCorrect: false
      },
      {
        textoRespuesta: "Cuando el avión se introduce en una zona de precipitación fuerte de lluvia, el ADF produce un error de +/-10º.",
        isCorrect: false
      },
      {
  ...
  {
    titulo: "11 - Un avión vuela siguiendo una derrota verdadera de 048º a una TAS constante de 210 Kt. La velocidad del viento es 350º/30 Kt. La GS y el ángulo  de deriva son:",
    opciones: [
      {
  ...
  {
    titulo: "12 - Suponiendo rumbo verdadero 074, TAS 230, derrota 066, velocidad respecto al suelo 242Kts, calcular la dirección y velocidad del viento:",
    opciones: [
      {
