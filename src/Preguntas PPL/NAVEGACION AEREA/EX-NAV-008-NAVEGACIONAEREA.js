const preguntas = [
  ...
  {
    titulo: "4 - Durante un vuelo a baja cota una aeronave cruza en ángulo recto dos carreteras paralelas. El tiempo que se tarda en cruzarlas se puede usar para calcular:",
    opciones: [
      {
  ...
  {
    titulo: "11 - Suponiendo viento cero. ¿Qué distancia cubrirá una aeronave que descienda 15.000 pies con una TAS de 320 Kt y manteniendo un régimen de descenso de 3.000 pies por minuto?",
    opciones: [
      {
