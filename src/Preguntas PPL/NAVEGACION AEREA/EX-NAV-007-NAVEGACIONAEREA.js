const preguntas = [
  ...
  {
    titulo:
      '2 - Un avión vuela siguiendo una derrota verdadera de 048º a una TAS de 210 kt. La velocidad del viento es 350º/30 kt. La GS y el ángulo de deriva son:',
    opciones: [
      {
  ...
  {
    titulo:
      '4 - Para aterrizar en la pista 23 (227ºM) la referencia W/V del ATIS es 180º/30 kts. La declinación es 13ºE. Indicar cual es el componente transversal de viento.',
    opciones: [
      {
        textoRespuesta: '20',
        isCorrect: false
  ...
  {
    titulo:
      '5 - La distancia medida entre dos puntos de una carta de navegación es de 42 mm. La escala de la carta es de 1:1.600.000. Hallar la distancia sobre el suelo:',
    opciones: [
      {
  ...
  {
    titulo:
      '8 - ¿Qué equipo de radar en tierra necesita un equipo transpondedor a bordo del avión para que los controladores reciban otros tipos de información del tráfico aparte de su eco?',
    opciones: [
      {
  ...
  {
    titulo:
      '10 - Supuesto: Rumbo magnético 311º. Ángulo de deriva 10º a la izquierda.Marcación relativa de NDB 270 º. ¿Cuál es la marcación magnética del NDB medida desde el avión?',
    opciones: [
      {
        textoRespuesta: '180º.',
        isCorrect: false
  ...
  {
    titulo:
      '12 - Un avión vuela siguiendo una derrota verdadera de 048º a una TAS constante de 210 kt. La velocidad del viento es de 350º / 30 kt. La G.S. y el ángulo de deriva son:',
    opciones: [
      {
        textoRespuesta: '200 kt, 3.5º a la derecha.',
        isCorrect: false
