const preguntas = [
  {
    titulo:
      '1 - Supuestos: Rumbo magnético 311º, ángulo de deriva 10º a la izquierda, marcación relativa de NDB 270º. ¿Cuál es la marcación magnética del NDB medida desde el avión?.',
    opciones: [
      {
        textoRespuesta: '211º',
        isCorrect: false
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'La escala corresponde a la razón entre cualquier unidad de la longitud la superficie de la tierra y la distancia que esta longitud representa en la carta.',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Al ángulo formado por el morro del avión y la punta de la aguja del ADF medido en el sentido de las agujas del reloj.',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '9 - Volamos con rumbo 075º y el ADF nos empieza a marcar lentamente 075º, 080º, 085º, 090º. ¿Qué conclusión podemos sacar?',
    opciones: [
      {
