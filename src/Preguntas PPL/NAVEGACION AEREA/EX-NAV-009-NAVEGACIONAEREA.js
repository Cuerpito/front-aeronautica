const preguntas = [
  ...
  {
    titulo: "2 - Suponiendo un rumbo verdadero de 074º y una TAS de 230 kt con una derrota de 066º y una GS de 242 kt. ¿Cuál es la velocidad y dirección del viento?",
    opciones: [
      {
  ...
  {
    titulo: "4 - Se observa una isla 15º a la izquierda.El rumbo del avión s 120º (M), la declinación magnética es de 17ºW, el rumbo (T) del avión a la isla es:",
    opciones: [
      {
        textoRespuesta: "268º",
        isCorrect: false
  ...
  {
    titulo: "8 - Legalmente debemos dejar una reserva de combustible para realizar esperas sobre el aeródromo de destino y alternativo, ¿De cuanto tiempo es esta reserva?",
    opciones: [
      {
  ...
  {
    titulo: "12 - Suponiendo: velocidad respecto al suelo = 120 kt, distancia de A a B = 84 MN. ¿Cuánto tiempo se tarda en volar de A a B?",
    opciones: [
      {
