const preguntas = [
  ...
  {
    titulo: "2 - Supuestos: rumbo indicado en brújula 270º, desviación 2ºW, declinación 30ºE, marcación relativa 316º. Calcular el QDR.",
    opciones: [
      {
        textoRespuesta: "226º",
        isCorrect: false
  ...
  {
    titulo: "7 - Si nos quedan 45 minutos de autonomía, nos quedan 60 NM para llegar a destino y nuestra TAS es de 90 nudos,  suponemos viento cero, ¿Podremos llegar a destino o habrá que buscar alternativo?",
    opciones: [
      {
  ...
  {
    titulo: "8 - El VOR emite radiales que nos permiten acercarnos, alejarnos o simplemente establecer nuestra posición, estos radiales están orientados según:",
    opciones: [
      {
