const preguntas = [
  ...
  {
    titulo:
      '7 - Conociendo TAS = 140, curso verdadero = 120º y viento = 90º/30 Kts calcular el rumbo verdadero y la velocidad sobre el suelo GS:',
    opciones: [
      {
  ...
  {
    titulo:
      '8 - La inclinación del eje de la tierra determina entre otras cosas las estaciones del año, la duración del día en distintas latitudes etc., pero ¿Cuál  es el valor de la inclinación en grados?',
    opciones: [
      {
  ...
  {
    titulo:
      '9 - Si navegamos manteniendo centrado el CDI del VOR con un radial de acercamiento o una ruta de alejamiento, la deriva producida por el viento es compensada.',
    opciones: [
      {
