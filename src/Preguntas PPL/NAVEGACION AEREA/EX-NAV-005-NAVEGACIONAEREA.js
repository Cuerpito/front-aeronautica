const preguntas = [
  {
    titulo: "1 - Supuestos: Rumbo magnético 060º, declinación magnética 8ºW, ángulo de deriva 4º a la derecha.¿Cuál es la derrota verdadera?.",
    opciones: [
      {
        textoRespuesta: "072º.",
        isCorrect: false
  ...
  {
    titulo: "2 - Suponiendo: TAS = 470 kt, rumbo verdadero = 317º, W/V 045º(T)/45 kt. Calcular el ángulo de deriva y la velocidad respecto al suelo.",
    opciones: [
      {
  ...
  {
    titulo: "6 - Volando a baja cota, un avión cruza dos carreteras paralelas con 90º respecto a ellas. El tiempo que tarda en cruzar las carreteras nos servirá para determinar:",
    opciones: [
      {
