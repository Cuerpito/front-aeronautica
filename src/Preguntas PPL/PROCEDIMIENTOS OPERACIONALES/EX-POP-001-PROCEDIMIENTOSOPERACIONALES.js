const preguntas = [
  ...
  {
    titulo:
      '7 - Un suceso en el que la aeronave sufre daños o roturas estructurales que afectan adversamente a su resistencia estructural, su performance os sus características de vuelo, se denomina:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Cuando un avión pesado acaba de realizar un despegue en una pista paralela cercana con un ligero viento cruzado',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Si, simplemente antes de aterrizar un avión mucho más ligero ha aterrizado en la misma pista de aterrizaje con fuerte viento cruzado',
        isCorrect: false
      }
    ]
  },
  {
    titulo:
      '12 - Una noticia conteniendo información concerniente a la seguridad en vuelo, navegación aérea, técnica, administrativa o legislativa y originada en el AIS del Estado, se llama',
    opciones: [
      {
