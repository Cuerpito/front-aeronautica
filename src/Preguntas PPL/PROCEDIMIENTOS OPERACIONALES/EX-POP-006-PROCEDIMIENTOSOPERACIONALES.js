const preguntas = [
  ...
  {
    titulo: "7 - ¿Cuál de los siguientes juegos de condiciones es el que tiene más probabilidades de atraer las aves hacia un aeropuerto?",
    opciones: [
      {
  ...
  {
    titulo: "9 - Tras el aterrizaje, mientras rueda hacía la plataforma su aeronave introduce una de las ruedas del tren de aterrizaje en un agujero. No hay heridos, pero la aeronave sufre daños importantes que obligan a cancelar el vuelo posterior",
    opciones: [
      {
      ...
      {
        textoRespuesta: "Es una irregularidad en la operación la tripulación debe informar al Operador del Aeródromo y realizar un informe",
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta: "Es un incidente y el Piloto al Mando debe notificarlo a la autoridad del aeropuerto en las siguientes 48 horas",
        isCorrect: false
      }
    ]
  },
  {
    titulo: "10 - Todos los miembros de la tripulación mantendrán abrochados sus cinturones de seguridad mientras estén en sus puestos",
    opciones: [
      {
        textoRespuesta: "Si",
        isCorrect: true
