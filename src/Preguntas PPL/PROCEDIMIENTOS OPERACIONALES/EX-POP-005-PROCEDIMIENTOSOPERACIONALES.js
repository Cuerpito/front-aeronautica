const preguntas = [
  ...
  {
    titulo:
      '5 - ¿Cuál de los siguientes juegos de condiciones es el que tiene más probabilidades de atraer las aves hacia un aeropuerto?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Justo antes de aterrizar, una aeronave mas ligera ha aterrizado con un fuerte viento cruzado en una pista larga',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'Una aeronave mas pesada ha aterrizado previamente en la pista, con viento cruzado ligero y utilizo dispositivos hipersustentadores',
        isCorrect: true
      }
    ]
  },
