const preguntas = [
  ...
  {
    titulo: "6 - El ángulo de cobertura de las luces blancas obligatorias de posición, que brillan continuamente en vuelo y que se encuentran en la parte trasera del avión, es:",
    opciones: [
      {
        textoRespuesta: "220º",
        isCorrect: false
  ...
  {
    titulo: "11 - De acuerdo al Documento 4444 de OACI, la separación mínima sin radar por estela turbulenta de 2 minutos se debe aplicar a:",
    opciones: [
      {
  ...
  {
    titulo: "12 - Con temperatura ambiental alta (+30°) y con humedad relativa baja del 40% en aire libre de nubes, niebla o precipitación, el engelamiento fuerte en el carburador:",
    opciones: [
      {
