const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta: "Si estamos listos para entrar en pista y despegar, deberemos ceder el paso a las aeronaves que se encuentren en el tramo de viento cruzado",
        isCorrect: false
      },
      {
        textoRespuesta: "Siempre que otra aeronave no haya abandonado la pista, podremos aterrizar siempre que tengamos la certeza de poder parar nuestro avión sin llegar a colisionar con el que se encuentra en la pista",
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta: "Cuando el tráfico precedente haya aplicado por unos instantes empuje de despegue inmediatamente antes del mismo",
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta: "Si justo antes de aterrizar, un avión mucho más ligero ha aterrizado en la misma pista con fuerte componente lateral",
        isCorrect: false
      },
      {
        textoRespuesta: "Cuando un avión pesado acaba de despegar desde una pista paralela muy próxima con una ligera componente lateral",
        isCorrect: true
      }
    ]
  },
  {
    titulo: "7 - Para extinguir un incendio en la cabina, el piloto utilizará:\n1.\tExtintores de agua\n2.\tExtintores químicos o de polvo\n3.\tExtintores de halón\n4.\tExtintores de CO2\n La combinación correcta es:",
    opciones: [
      {
  ...
  {
    titulo: "9 - ¿Cuál de los siguientes juegos de condiciones es el que tiene menos probabilidades de atraer las aves hacia un aeropuerto?",
    opciones: [
      {
  ...
  {
    titulo: "12 - De acuerdo al Documento 4444 de OACI, la separación mínima sin radar por estela turbulenta de 2 minutos se debe aplicar a:",
    opciones: [
      {
      ...
      {
        textoRespuesta: "Aeronave media despegando detrás de una aeronave pesada desde una parte intermedia de una pista paralela separada por menos de 760m",
        isCorrect: false
      },
      {
