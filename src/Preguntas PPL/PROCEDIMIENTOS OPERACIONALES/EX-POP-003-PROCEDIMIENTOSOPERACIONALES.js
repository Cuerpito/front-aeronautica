const preguntas = [
  {
    titulo:
      '1 - El equipo que difunde señales distintas en frecuencias designadas y que puede ser de activación manual o automática al impacto es',
    opciones: [
      {
  ...
  {
    titulo:
      '5 - Cuando se despega inmediatamente después de una aeronave de fuselaje ancho que acaba de aterrizar, se deberá despegar:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'En el punto en el que las ruedas del avión entrante hayan hecho contacto con la pista, y del lado del viento en pista',
        isCorrect: false
      },
      {
        textoRespuesta:
          'En el punto en el que las ruedas del avión entrante hayan hecho contacto con la pista, y del lado contrario del viento en pista',
        isCorrect: false
      },
      {
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'A aeronaves Medias en salidas tras una aeronave pesada, cuando operen  en una pista con un umbral de aterrizaje desplazado',
        isCorrect: false
      },
      {
        textoRespuesta:
          'A una aeronave Ligera en llegada tras una aeronave media cuando operen en una pista con un umbral de aterrizaje desplazado, si se espera que la trayectoria de vuelo previstas se crucen',
        isCorrect: false
      },
      {
        textoRespuesta:
          'A aeronaves Ligeras despegando tras una aeronave media desde una parte intermedia de una pista paralela separada menos de 760 metros',
        isCorrect: true
      },
      {
        textoRespuesta:
          'Entre una aeronave Ligera y una aeronave Media que realiza una aproximación frustrada y la aeronave ligera utiliza una pista en sentido opuesto para el despegue',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '11 - Con temperatura ambiental alta (+30°) y con humedad relativa baja del 40% en aire libre de nubes, niebla o precipitación, el engelamiento fuerte en el carburador:',
    opciones: [
      {
