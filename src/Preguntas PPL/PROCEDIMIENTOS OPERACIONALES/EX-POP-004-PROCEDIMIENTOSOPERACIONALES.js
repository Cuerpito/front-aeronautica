const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta:
          'Que los pasajeros y miembros conozcan el uso del sistema de oxígeno, cinturones de seguridad y salidas de emergencia',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'De que los demás miembros de la tripulación tengan sus licencias en vigor y conozcan los procedimientos concretos de ese avión',
        isCorrect: false
      },
      {
        textoRespuesta: 'Todas son s',
  ...
  {
    titulo:
      '5 - A temperatura ambiente elevada (+30ºC) y con humedad relativa tan baja como el 40%, en el cielo despejado, sin niebla ni precipitaciones, la formación de hielo en el carburador:',
    opciones: [
      {
  ...
  {
    titulo:
      '12 - Tras un aterrizaje con exceso de peso y velocidad, los neumáticos y los frenos están extremadamente calientes Los bomberos deberían aproximarse a los neumáticos del tren de aterrizaje:',
    opciones: [
      {
