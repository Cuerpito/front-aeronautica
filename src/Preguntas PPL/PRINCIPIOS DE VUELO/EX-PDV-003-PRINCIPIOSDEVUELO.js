const preguntas = [
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Asegurar que los slats se extiendan siempre cuando los sistemas de vuelo/tierra se encuentran en la posición “tierra”',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '13 - Considerando un perfil aerodinámico con una determinada comba y con un ángulo de ataque positivo. ¿En qué lugar se darán las más altas velocidades del flujo?',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'La proporción de los gases que componen la atmósfera se va afectada por la altura dependiendo del estado de la atmósfera.',
        isCorrect: false
      },
      {
