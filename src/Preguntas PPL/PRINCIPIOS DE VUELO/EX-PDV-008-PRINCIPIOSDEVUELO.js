const preguntas = [
  ...
  {
    titulo:
      '13 - En el día de hoy, la presión en el campo de vuelo cuya elevación son 2040 ft es de 950 mb. Diga cuales son los valores de QNH y QNE:',
    opciones: [
      {
  ...
  {
    titulo:
      '15 - El aumento de la densidad del aire tendrá el siguiente efecto sobre la resistencia aerodinámica de un avión (con el ángulo de ataque, OAT y TAS constantes):',
    opciones: [
      {
