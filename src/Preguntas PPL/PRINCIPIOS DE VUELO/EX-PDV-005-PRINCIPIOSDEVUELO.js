const preguntas = [
  ...
  {
    titulo: "4 - En el mismo perfil aerodinámico, el ángulo que forma la línea formada por la unión de los infinitos puntos del 25% de las infinitas cuerdas aerodinámicas del plano, con el eje longitudinal del avión, en el plano horizontal, recibe el nombre de:",
    opciones: [
      {
  ...
  {
    titulo: "6 - Conocemos que la pérdida en una PA28, con flap arriba y un peso al despegue de 845 Kgs. se produce a 58 Kts. En el siguiente vuelo despegamos con un peso de 1100 Kg. Debemos tener en cuenta que:",
    opciones: [
      {
  ...
  {
    titulo: "12 - En comparación con la configuración de flaps recogidos, el máximo ángulo de ataque en configuración de flaps extendidos es:",
    opciones: [
      {
