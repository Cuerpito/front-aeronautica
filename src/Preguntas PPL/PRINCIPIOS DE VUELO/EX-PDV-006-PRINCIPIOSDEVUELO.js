const preguntas = [
  ...
  {
    titulo:
      '7 - El aviso de pérdida se produce a una velocidad determinada antes de la pérdida real. La diferencia entre ambas es del:',
    opciones: [
      {
        textoRespuesta: '5%',
        isCorrect: false
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Aumento de la pendiente de la curva que nos relaciona el coeficiente de sustentación con el ángulo de ataque.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Disminución de la pendiente de la curva que nos relaciona el coeficiente de sustentación con el ángulo de ataque.',
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo:
      '12 - Un avión efectúa un descenso constante con una IAS de 160 kts y régimen de descenso de 1.000 pies/minuto. En estas condiciones:',
    opciones: [
      {
