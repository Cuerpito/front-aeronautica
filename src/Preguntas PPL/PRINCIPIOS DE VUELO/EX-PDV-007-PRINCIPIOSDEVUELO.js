const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Porque en determinadas ocasiones existe una deflexión hacia abajo del viento al impactar contra el perfil aerodinámico.',
        isCorrect: false
      },
      {
  ...
  {
    titulo:
      '7 - Si, aun teniendo indicación del avisador de pérdida, continuamos aumentando el ángulo de ataque, se producirá el bataneo. Estas vibraciones de la columna de mandos y del avión están producidas por:',
    opciones: [
      {
      ...
      {
        textoRespuesta:
          'Lo anterior, señalando especialmente el flujo de aire que impacta sobre el estabilizador de cola, que es muy turbulento y que procede de la capa límite casi desprendida de los planos.',
        isCorrect: true
      },
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'La presión afecta a la densidad en mayor medida que la temperatura, razón por la cual, al ascender, la densidad disminuye.',
        isCorrect: false
      },
      {
        textoRespuesta:
          'La temperatura afecta a la densidad en proporción directa, es decir, al aumentar la temperatura aumenta la densidad.',
        isCorrect: false
      },
      {
