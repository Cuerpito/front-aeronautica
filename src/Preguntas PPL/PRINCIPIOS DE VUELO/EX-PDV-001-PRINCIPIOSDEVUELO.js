const preguntas = [
  ...
  {
    titulo:
      '4 - Siendo el Teorema de Bernoulli (para fluidos elementales) "p+1/2pv2 = constante", podremos afirmar, para un fluido en movimiento que:',
    opciones: [
      {
  ...
  {
    titulo:
      '13 - Si la ecuación de continuidad es aplicable, ¿Cómo se verá afectada la densidad del aire(rho) si el área de la sección transversal de un tubo varía? (flujo de baja velocidad, subsónico e incompresible)',
    opciones: [
      {
  ...
  {
    titulo:
      '14 - ¿Cuál de las siguientes afirmaciones – respecto a la relación sustentación/resistencia en vuelo recto y nivelado- es correcta?',
    opciones: [
      {
