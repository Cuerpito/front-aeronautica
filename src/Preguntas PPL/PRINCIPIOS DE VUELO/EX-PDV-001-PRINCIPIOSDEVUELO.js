const preguntas = [
  {
    titulo: "1 - La presión estática actúa:",
    opciones: [
      {
      ...
      {
        textoRespuesta: "En todas direcciones",
        isCorrect: true
      },
      {
  ...
  {
    titulo: "2 - Cuando se despliegan los flaps con un ángulo de ataque constante, el coeficiente de sustentación:",
    opciones: [
      {
  ...
  {
    titulo: "3 - La cuantía de la disminución de la temperatura, hasta los 36,000 ft. es de:",
    opciones: [
      {
  ...
  {
    titulo: "4 - Siendo el Teorema de Bernoulli (para fluidos elementales) \"p+1/2pv2 = constante\", podremos afirmar, para un fluido en movimiento que:",
    opciones: [
      {
  ...
  {
    titulo: "5 - Podemos decir, en cuanto a la capa límite, que:",
    opciones: [
      {
      ...
      {
        textoRespuesta: "Se define como la masa de aire comprendida entre las moléculas de aire con velocidad 0 y aquellas cuya velocidad es el 99% de la de la corriente de aire libre.",
        isCorrect: false
      },
      {
  ...
  {
    titulo: "6 - ¿Cómo podemos aumentar la sustentación en un avión?",
    opciones: [
      {
  ...
  {
    titulo: "7 - ¿El flap ranurado genera más sustentación adicional que el zap?",
    opciones: [
      {
      ...
      {
        textoRespuesta: "Si, porque el ranurado energiza la capa límite, comunicando el intrados y el extradós, generando menos resistencia, además de aumentar la superficie alar.",
        isCorrect: true
      },
      {
  ...
  {
    titulo: "8 - La sustentación y la densidad del aire son:",
    opciones: [
      {
  ...
  {
    titulo: "9 - El efecto Venturi establece una relación entre la:",
    opciones: [
      {
  ...
  {
    titulo: "10 - ¿Cuándo coincidirán la línea de curvatura media y la cuerda?",
    opciones: [
      {
  ...
  {
    titulo: "11 - El coeficiente del momento de cabeceo depende de:",
    opciones: [
      {
  ...
  {
    titulo: "12 - ¿Qué es lo que sucede ante el efecto suelo?",
    opciones: [
      {
  ...
  {
    titulo: "13 - Si la ecuación de continuidad es aplicable, ¿Cómo se verá afectada la densidad del aire(rho) si el área de la sección transversal de un tubo varía? (flujo de baja velocidad, subsónico e incompresible)",
    opciones: [
      {
  ...
  {
    titulo: "14 - ¿Cuál de las siguientes afirmaciones – respecto a la relación sustentación/resistencia en vuelo recto y nivelado- es correcta?",
    opciones: [
      {
      ...
      {
        textoRespuesta: "El mayor valor de la relación sustentación/resistencia se alcanza cuando la sustentación es igual al peso del avión.",
        isCorrect: false
      }
    ]
  },
  {
    titulo: "15 - La temperatura disminuye con la altura hasta la tropopausa, unos 11 Km de distancia. En ese punto:",
    opciones: [
      {
  ...
  {
    titulo: "16 - El torbellino de punta de plano:",
    opciones: [
      {
