const preguntas = [
  {
    titulo: "1 - El ángulo de ataque (ángulo de incidencia aerodinámica) de una superficie aerodinámica es el ángulo comprendido entre:",
    opciones: [
      {
  ...
  {
    titulo: "5 - La resistencia inducida en el avión viene generada por la llamada ‘estela turbulenta’ o ‘torbellino de punta de plano’. ¿Es evitable?",
    opciones: [
      {
  ...
  {
    titulo: "12 - Para mantener un vuelo recto y nivelado a velocidad verdadera constante, mientras se retraen los flaps, el ángulo de ataque deberá:",
    opciones: [
      {
  ...
  {
    titulo: "15 - Durante la retracción de flaps con un ángulo constante de ataque, el avión empieza a (permaneciendo constantes el resto de factores de importancia)",
    opciones: [
      {
