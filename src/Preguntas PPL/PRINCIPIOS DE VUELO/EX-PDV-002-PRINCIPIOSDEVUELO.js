const preguntas = [
  {
    titulo: "1 - Para mantener un vuelo recto y nivelado a velocidad verdadera constante, mientras se retraen los flaps, el ángulo de ataque deberá:",
    opciones: [
      {
  ...
  {
    titulo: "2 - ¿Cuál de la siguientes afirmaciones respecto a la relación sustentación/resistencia en vuelo recto y nivelado es correcta:",
    opciones: [
      {
  ...
  {
    titulo: "6 - ¿Existe una correspondencia constante entre la velocidad mínima y el ángulo de ataque máximo a los que puede volar un avión?",
    opciones: [
      {
        textoRespuesta: "Si.",
        isCorrect: false
  ...
  {
    titulo: "11 - Definición del alargamiento (A) del ala, siendo S= Superficie alar; Cr= Cuerda del perfil en el encastre; Ct = cuerda del perfil en la punta; b= envergadura.",
    opciones: [
      {
  ...
  {
    titulo: "13 - El aumento de la presión del aire tendrá el siguiente efecto sobre la resistencia aerodinámica de un avión (con el ángulo de ataque, OAT y TAS constantes):",
    opciones: [
      {
  ...
  {
    titulo: "15 - A la aplicación del teorema Bernoulli, por la cual un fluido, al atravesar un estrechamiento de corriente, aumenta su velocidad y disminuye su presión, se llama:",
    opciones: [
      {
