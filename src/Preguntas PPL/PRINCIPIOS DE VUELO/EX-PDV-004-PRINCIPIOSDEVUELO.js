const preguntas = [
  ...
  {
    titulo: "2 - Un avión efectúa un descenso constante con una IAS de 160 Kts y régimen de descenso de 1.000 pies/minuto. En estas condiciones:",
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Viene dado por el ángulo formado entre la cuerda aerodinámica y la corriente de aire libre (viento relativo).",
        isCorrect: true
      },
      {
        textoRespuesta: "Ninguna de las anteriores es .",
  ...
  {
    titulo: "13 - La sustentación y la resistencia aerodinámica sobre un perfil aerodinámico se consideran respectivamente vertical y paralela a",
    opciones: [
      {
