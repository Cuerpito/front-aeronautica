const preguntas = [
  ...
  {
    titulo: "6 - El piloto de un monomotor ha establecido las performances de ascenso. La carga de un pasajero adicional afectara a las performances de ascenso:",
    opciones: [
      {
  ...
  {
    titulo: "7 - En relación con la operación de una aeronave excediendo los limites de peso máximo autorizado, indique cuál de las siguientes frases NO es cierta:",
    opciones: [
      {
  ...
  {
    titulo: "8 - Hallar la posición del centro de gravedad en % de la MAC si la distancia desde el Datum a la LEMAC es de 13 metros, la distancia al TEMAC es de 19 metros y la distancia desde el datum al centro de gravedad es de 15 metros.",
    opciones: [
      {
        textoRespuesta: "33%",
        isCorrect: true
