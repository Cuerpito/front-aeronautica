const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta: "Es aquella velocidad a la que ganamos la mayor altura sobre el terreno por distancia recorrida y es mayor que la velocidad de mejor régimen",
        isCorrect: false
      },
      {
  ...
  {
    titulo: "6 - En relación con la operación de una aeronave excediendo los limites de peso máximo autorizado, indique cuál de las siguientes frases NO es cierta:",
    opciones: [
      {
  ...
  {
    titulo: "7 - Hallar la posición del centro de gravedad en % de la MAC si la distancia desde el Datum a la LEMAC es de 13 metros, la distancia al TEMAC es de 19 metros y la distancia desde el datum al centro de gravedad es de 15 metros.",
    opciones: [
      {
        textoRespuesta: "33%",
        isCorrect: true
  ...
  {
    titulo: "15 - Una pista está contaminada por una capa de 0.5cm de nieve mojada. Sin embargo el despegue esta autorizado por el manual de vuelo de la aeronave. La distancia de despegue en relación a una pista seca se verá:",
    opciones: [
      {
