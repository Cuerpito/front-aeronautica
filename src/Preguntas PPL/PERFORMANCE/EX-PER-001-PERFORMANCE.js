const preguntas = [
  ...
  {
    titulo:
      '7 - Calcular la distancia a la que se encuentra el centro de gravedad de una aeronave de la línea de referencia (DATUM), de acuerdo con los siguientes datos:\n-  Basic empty weight: 1.500 lb, arm: 70.\n-  Fuel weight: 350 lb, arm 60.\n-  Front seat occupants weight: 300 lb, arm 75.\n-  Baggage weight: 40 lb, arm 140.\n-  Oil weight: 20 lb, arm –5.',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'El empuje es igual a la resistencia aerodinámica más la componente descendente del peso bruto en la dirección de la trayectoria de vuelo',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '11 - En un vuelo nivelado y tras la extensión de los flaps, ignorando los momentos de la cola, el momento de cabeceo será:',
    opciones: [
      {
  ...
  {
    titulo:
      '15 - Si el peso del avión es superior al inicialmente previsto, para una velocidad aerodinámica dada, el ángulo de ataque',
    opciones: [
      {
