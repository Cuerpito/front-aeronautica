const preguntas = [
  ...
  {
    titulo:
      '4 - Con el centro de gravedad situado en el límite más adelantado, ¿cuál de las siguientes circunstancias se podrá esperar?:',
    opciones: [
      {
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Elegido en el eje longitudinal del avión, y necesariamente situado entre el borde de ataque y el borde de fuga del ala',
        isCorrect: false
      }
    ]
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Es el punto en el avión designado por el fabricante del avión desde el cual se calculan y miden todos los centros d gravedad',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '8 - Hallar cuanto varia la posición del centro de gravedad si añadimos 400 lbs el la estación 97,8 T.O.W = 2850 C.G =101,67.',
    opciones: [
      {
        textoRespuesta: '+0,96”',
        isCorrect: false
  ...
  {
    titulo:
      '14 - Si tenemos el centro de gravedad situado a 101,2 pulgadas y el limite trasero es de 104, pulgadas, cuanto peso podremos cambiar de la estación 112.5 a la estación 123,45 T.O.W=3140 lbs.',
    opciones: [
      {
