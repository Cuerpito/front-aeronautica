const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      {
        textoRespuesta: "Capacidad del avión para recobrar una posición de equilibrio cuando sufra alguna perturbación según el eje vertical.",
        isCorrect: false
      },
      {
        textoRespuesta: "Capacidad del avión para recobrar una posición de equilibrio cuando sufra alguna perturbación según el eje lateral.",
        isCorrect: true
      },
      {
  ...
  {
    titulo: "8 - La posición del centro de gravedad de un avión está 7 metros de la línea que pasa por el datum, y su peso es de 49.000 N. el momento correspondiente al datum será:",
    opciones: [
      {
  ...
  {
    titulo: "11 - Si el tren de morro se desplaza hacia atrás durante la retracción, ¿cómo afectará este movimiento a la posición del centro de gravedad (cg) del avión?",
    opciones: [
      {
  ...
  {
    titulo: "15 - La posición del centro de gravedad de un avión está a 7 metros de la línea que pasa por el datum, y su peso es de 49000 N El momento correspondiente al datum será",
    opciones: [
      {
