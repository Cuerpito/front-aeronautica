const preguntas = [
  ...
  {
    titulo: "6 - El centro de gravedad está situado al 25 % de la MAC. Significa que el centro de gravedad de la aeronave está situado al 25 % de la longitud de:",
    opciones: [
      {
  ...
  {
    titulo: "7 - El piloto de un monomotor ha establecido las performances de ascenso. La carga de un pasajero adicional afectara a las performances de ascenso:",
    opciones: [
      {
  ...
  {
    titulo: "14 - Si la rueda de morro se mueve hacia atrás durante la retracción del tren, ¿cómo afectará este movimiento a la localización del centro de gravedad del avión?:",
    opciones: [
      {
