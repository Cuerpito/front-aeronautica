const preguntas = [
  {
    titulo:
      '1 - Elija la afirmación que considere correcta en relación a las isobaras y a los patrones de flujo de vientos en las áreas de sistemas de altas y bajas presiones que aparecen en una carta meteorológica de superficie.',
    opciones: [
      {
        textoRespuesta:
          'cuando las isobaras se encuentran muy separadas, los picos de las ondas estacionarias pueden estar marcadas por nubes lenticulares estacionarias',
        isCorrect: false
      },
      {
      ...
      {
        textoRespuesta:
          'cuando las isobaras están muy próximas, la fuerza del gradiente de presión es mayor a las velocidades del viento son mayores',
        isCorrect: true
      }
    ]
  },
  ...
  {
    titulo:
      '4 - Al aproximarse un frente cálido ( en el hemisferio norte) la dirección del viento cambia de la superficie a la tropopausa . El efecto de este cambio supone que el viento:',
    opciones: [
      {
  ...
  {
    titulo:
      '5 - ¿Cómo puede localizarse la intensidad correcta del viento , para un determinado nivel, que se encuentra entre dos niveles de cartas de altura ? ( p. Ej. Viento FL 250 cuando se dispone de las carta 500hPa y 300hPa',
    opciones: [
      {
        textoRespuesta:
          'mediante interpolación de la información disponible sobre vientos en ambas cartas, al tiempo que se considera la información sobre vientos máximos de la carta sobre condiciones meteorológicas significativas',
        isCorrect: true
      },
      {
  ...
  {
    titulo:
      '6 - Remítase al siguiente extracto de TAF: ECMG 1821 2000 BKN004 PROB30 BECMG 2124 0500 FG VV001 ¿Cuál será la visibilidad prevista para la 2400UTC?',
    opciones: [
      {
  ...
  {
    titulo:
      '7 - LEMD 070500 071218 17020G30KT 9999 SCT070 BKN090 TEMPO 1315 5000 SHRA BECMG 1618 27010 8000 TS SCT045CB Si estimamos aterrizar en Barajas a las 17:00 que tiempo encontraremos',
    opciones: [
      {
