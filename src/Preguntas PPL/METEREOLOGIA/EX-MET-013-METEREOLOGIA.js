const preguntas = [
  ...
  {
    titulo: "4 - Según el siguiente mensaje METAR: LETO 171300Z 18002KT 4500 HZ NSC 06/M02 1025 NOSIG ¿Qué hora de emisión tiene el mensaje?",
    opciones: [
      {
  ...
  {
    titulo: "5 - Un avión aterriza en un aeropuerto (elevación 540 FT, QNH 993 hPcon el altímetro ajustado a 1013 hPa ¿Qué indicará el citado altímetro?",
    opciones: [
      {
  ...
  {
    titulo: "7 - Si un avión aterriza en un aeródromo con una elevación de 500 ft y un QNH de 993 Hpa, ¿qué altitud marcaría el altímetro si este altímetro si este está colocado con un QNH de 1013 Hpa?",
    opciones: [
      {
        textoRespuesta: "380 ft",
        isCorrect: false
