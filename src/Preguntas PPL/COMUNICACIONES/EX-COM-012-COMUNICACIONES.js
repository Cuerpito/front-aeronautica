const preguntas = [
  ...
  {
    titulo: "7 - Una aeronave es autorizada a mantener corto de la pista en uso. ¿Cual es la fraseología correcta para indicar que se cumplirá dicha instrucción?",
    opciones: [
      {
