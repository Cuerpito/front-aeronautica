const preguntas = [
  ...
  {
    titulo: "4 - Si todos los intentos para establecer contacto radio con una estación de tierra fallan, el piloto de una aeronave debería transmitir los mensajes precedidos por la siguiente frase",
    opciones: [
      {
