const preguntas = [
  ...
  {
    titulo: "2 - En un aeropuerto con las comunicaciones muy congestionadas ¿Qué medida tomaría para no entorpecer las mismas a la hora de recibir una autorización?",
    opciones: [
      {
      ...
      {
        textoRespuesta: "Evitar pedir autorización para rodar Rodaremos directamente y nos pararemos en el punto de espera de la pista en servicio",
        isCorrect: false
      }
    ]
  },
  ...
  {
    titulo: "6 - ¿A que banda pertenece el entorno de frecuencias comprendido entre 118.000 - 136.975 MHz del Servicio Aeronáutico Móvil?",
    opciones: [
      {
