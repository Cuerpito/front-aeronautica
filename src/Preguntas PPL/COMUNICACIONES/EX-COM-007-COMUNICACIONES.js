const preguntas = [
  ...
  {
    titulo: "3 - Un avión no consigue establecer contacto por radio con una estación determinada de frecuencia designada, ¿Qué deberá hacer el piloto como último recurso?",
    opciones: [
      {
