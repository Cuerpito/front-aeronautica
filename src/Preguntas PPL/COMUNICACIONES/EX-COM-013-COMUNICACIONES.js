const preguntas = [
  ...
  },
  {
    ...
    opciones: [
      ...
      {
        textoRespuesta:
          'Una transmisión de información relativa a la navegación aérea que no esta dirigida a una estación o estaciones especificas',
        isCorrect: false
      },
      {
        textoRespuesta:
          'Una transmisión de mensajes relativos a información meteorológica en ruta que puede afectar a la seguridad de la operación de aeronaves y no esta dirigido a ninguna estación o estaciones especificas',
        isCorrect: false
      },
      {
