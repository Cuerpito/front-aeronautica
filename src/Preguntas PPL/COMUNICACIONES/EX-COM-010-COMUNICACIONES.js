const preguntas = [
  ...
  {
    titulo: '2 - ¿Cuándo podrá la torre abreviar el distintivo de llamada?',
    opciones: [
      {
        textoRespuesta: 'Cuando no exista confusión',
        isCorrect: false
      },
      {
        textoRespuesta: 'Cuando haya contactado satisfactoriamente previamente',
        isCorrect: false
      },
      {
  ...
  {
    titulo: '3 - Qué significa GO AHEAD',
    opciones: [
      {
  ...
  {
    titulo: '4 - Si en vuelo con fallo de radio recibimos de la torre una luz roja fija, significa',
    opciones: [
      {
  ...
  {
    titulo: '5 - Si con fallo de radio vamos a entrar en un aeródromo no controlado, ¿qué acciones tomaría?',
    opciones: [
      {
        textoRespuesta:
  ...
  {
    titulo: '6 - Un megahercio equivale a',
    opciones: [
      {
  ...
  {
    titulo: '7 - La abreviatura “MSA” significa',
    opciones: [
      {
  ...
  {
    titulo:
      '8 - Cuando, bien por requerimiento de control, o del servicio meteorológico, o porque así lo estime la tripulación se dedica a reportar información operacional y/o meteorológica, se hará en forma de',
    opciones: [
      {
